...
|buildTool|the build automation tool used in generated code. Allowed values: maven, gradle|<dl><dt>**maven**</dt><dd>Use maven (default)</dd><dt>**gradle**</dt><dd>Use gradle</dd></dl>|maven|
