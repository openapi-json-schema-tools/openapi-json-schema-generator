...
If you're looking for the configuration files of a particular CI that is not yet supported, please open an [issue](https://github.com/openapijsonschematools/openapi-generator/issues/new) to let us know.
