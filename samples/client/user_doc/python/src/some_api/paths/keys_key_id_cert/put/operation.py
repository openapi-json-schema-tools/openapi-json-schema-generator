...
from some_api.components.schema import pem_cert
from some_api.components.schema import pgp_private_key
from some_api.paths.keys_key_id_cert.put.request_body.content.application_xx509_ca_cert import schema
