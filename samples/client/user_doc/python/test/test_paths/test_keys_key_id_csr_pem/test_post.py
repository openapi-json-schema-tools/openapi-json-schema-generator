...
import some_api
from some_api.paths.keys_key_id_csr_pem.post import operation as post  # noqa: E501
...
class TestPost(ApiTestMixin, unittest.TestCase):
    ...
    response_status = 200
    response_body_schema = post.response_200.ResponseFor200.content["application/x-pem-file"].schema
