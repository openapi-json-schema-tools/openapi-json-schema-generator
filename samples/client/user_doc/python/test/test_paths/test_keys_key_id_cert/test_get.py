...
import some_api
from some_api.paths.keys_key_id_cert.get import operation as get  # noqa: E501
...
class TestGet(ApiTestMixin, unittest.TestCase):
    ...
    response_body_schema = get.response_200.ResponseFor200.content["application/x-x509-ca-cert"].schema
    assert response_body_schema is not None
    response_body_schema = get.response_200.ResponseFor200.content["application/pgp-keys"].schema
    assert response_body_schema is not None
