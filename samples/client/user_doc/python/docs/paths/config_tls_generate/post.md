some_api.paths.config_tls_generate.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| config_tls_generate_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | ConfigTlsGenerate | This api is only for path=/config/tls/generate |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | Successful creation of new public and private key pair for NetHSM&#x27;s https API.
...
### Description
Successful creation of new public and private key pair for NetHSM&#x27;s https API.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    body = tls_key_generate_request_data.TlsKeyGenerateRequestData.validate({
        "type": tls_key_type.TlsKeyType.validate("RSA"),
        "length": 128,
    })
    try:
        api_response = api_instance.config_tls_generate_post(
            body=body,
        )
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->config_tls_generate_post: %s\n" % e)
```
