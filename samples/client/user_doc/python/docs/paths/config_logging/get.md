...
| ----------- | --------- | ----- |
| config_logging_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | ConfigLogging | This api is only for path=/config/logging |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | Successful retrieval of logging configuration.
...
### Description
Successful retrieval of logging configuration.

### ResponseFor200 ApiResponse
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
[body](#responsefor200-body) | [logging_config.LoggingConfigDict](../../components/schema/logging_config.md#loggingconfigdict) |  |
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.config_logging_get()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->config_logging_get: %s\n" % e)
```
