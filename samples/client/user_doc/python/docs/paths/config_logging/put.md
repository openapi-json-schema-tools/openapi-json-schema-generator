some_api.paths.config_logging.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| config_logging_put | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| put | ApiForPut | This api is only for this endpoint |
| put | ConfigLogging | This api is only for path=/config/logging |
...
------------- | ------------- | ------------- | -------------
[body](#requestbody) | typing.Union[[logging_config.LoggingConfigDictInput](../../components/schema/logging_config.md#loggingconfigdictinput), [logging_config.LoggingConfigDict](../../components/schema/logging_config.md#loggingconfigdict)] | required |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | Succesful update of logging configuration.
...
### Description
Succesful update of logging configuration.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    body = logging_config.LoggingConfig.validate({
        "ip_address": "ip_address_example",
        "port": 1,
        "log_level": log_level.LogLevel.validate("debug"),
    })
    try:
        api_response = api_instance.config_logging_put(
            body=body,
        )
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->config_logging_put: %s\n" % e)
```
