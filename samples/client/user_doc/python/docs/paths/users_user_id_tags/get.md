some_api.paths.users_user_id_tags.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| users_user_id_tags_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | UsersUserIDTags | This api is only for path=/users/{UserID}/tags |
...
400 | [ResponseFor400.ApiResponse](#responsefor400-apiresponse) | Invalid character in the UserID.
...
404 | [ResponseFor404.ApiResponse](#responsefor404-apiresponse) | User not found for this user-ID.
...
[body](#responsefor200-body) | [tag_list.TagListTuple](../../components/schema/tag_list.md#taglisttuple) |  |
...
### Description
Invalid character in the UserID.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.users_user_id_tags_get()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->users_user_id_tags_get: %s\n" % e)
```
