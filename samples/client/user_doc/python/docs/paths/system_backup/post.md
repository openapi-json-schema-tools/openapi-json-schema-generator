some_api.paths.system_backup.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| system_backup_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | SystemBackup | This api is only for path=/system/backup |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | Successful retrieval of backup data.
...
412 | [ResponseFor412.ApiResponse](#responsefor412-apiresponse) | Precondition failed (NetHSM was not *Operational* or *Backup Passphrase* was not set). 

## ResponseFor200

### Description
Successful retrieval of backup data.
...
### Description
Precondition failed (NetHSM was not *Operational* or *Backup Passphrase* was not set). 
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.system_backup_post()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->system_backup_post: %s\n" % e)
```
