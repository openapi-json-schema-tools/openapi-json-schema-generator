some_api.paths.config_tls_cert_pem.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| config_tls_cert_pem_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | ConfigTlsCertPem | This api is only for path=/config/tls/cert.pem |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | Successful retrieval of certificate.
...
415 | [ResponseFor415.ApiResponse](#responsefor415-apiresponse) | Content type in Accept header not supported or not present.

## ResponseFor200

### Description
Successful retrieval of certificate.
...
### Description
Content type in Accept header not supported or not present.

### ResponseFor415 ApiResponse
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.config_tls_cert_pem_get()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->config_tls_cert_pem_get: %s\n" % e)
```
