some_api.paths.keys_key_id_encrypt.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| keys_key_id_encrypt_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | KeysKeyIDEncrypt | This api is only for path=/keys/{KeyID}/encrypt |
...
------------- | ------------- | ------------- | -------------
[body](#requestbody) | typing.Union[[encrypt_request_data.EncryptRequestDataDictInput](../../components/schema/encrypt_request_data.md#encryptrequestdatadictinput), [encrypt_request_data.EncryptRequestDataDict](../../components/schema/encrypt_request_data.md#encryptrequestdatadict)] | required |
...
400 | [ResponseFor400.ApiResponse](#responsefor400-apiresponse) | Bad Request, e.g. invalid mechanism.
...
[body](#responsefor200-body) | [encrypt_data.EncryptDataDict](../../components/schema/encrypt_data.md#encryptdatadict) |  |
...
### Description
Bad Request, e.g. invalid mechanism.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    body = encrypt_request_data.EncryptRequestData.validate({
        "mode": encrypt_mode.EncryptMode.validate("AES_CBC"),
        "message": base64.Base64.validate("z"),
        "iv": base64.Base64.validate("z"),
    })
    try:
        api_response = api_instance.keys_key_id_encrypt_post(
            body=body,
        )
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->keys_key_id_encrypt_post: %s\n" % e)
```
