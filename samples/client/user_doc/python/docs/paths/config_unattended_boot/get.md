...
| ----------- | --------- | ----- |
| config_unattended_boot_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | ConfigUnattendedBoot | This api is only for path=/config/unattended-boot |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | Successful read of unattended boot configuration.
...
### Description
Successful read of unattended boot configuration.

### ResponseFor200 ApiResponse
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
[body](#responsefor200-body) | [unattended_boot_config.UnattendedBootConfigDict](../../components/schema/unattended_boot_config.md#unattendedbootconfigdict) |  |
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.config_unattended_boot_get()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->config_unattended_boot_get: %s\n" % e)
```
