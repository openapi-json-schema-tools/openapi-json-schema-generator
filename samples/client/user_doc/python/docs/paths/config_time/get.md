some_api.paths.config_time.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| config_time_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | ConfigTime | This api is only for path=/config/time |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | Successful retrieval of system time.
...
### Description
Successful retrieval of system time.

### ResponseFor200 ApiResponse
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
[body](#responsefor200-body) | [time_config.TimeConfigDict](../../components/schema/time_config.md#timeconfigdict) |  |
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.config_time_get()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->config_time_get: %s\n" % e)
```
