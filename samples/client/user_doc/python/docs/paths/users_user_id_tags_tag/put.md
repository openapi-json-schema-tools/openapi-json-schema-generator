some_api.paths.users_user_id_tags_tag.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| users_user_id_tags_tag_put | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| put | ApiForPut | This api is only for this endpoint |
| put | UsersUserIDTagsTag | This api is only for path=/users/{UserID}/tags/{Tag} |
...
304 | [ResponseFor304.ApiResponse](#responsefor304-apiresponse) | Tag is already present for this UserID.
400 | [ResponseFor400.ApiResponse](#responsefor400-apiresponse) | Bad request, tag format is invalid or user is not an operator.
...
404 | [ResponseFor404.ApiResponse](#responsefor404-apiresponse) | UserID not found.
...
### Description
Tag is already present for this UserID.
...
### Description
Bad request, tag format is invalid or user is not an operator.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.users_user_id_tags_tag_put()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->users_user_id_tags_tag_put: %s\n" % e)
```
