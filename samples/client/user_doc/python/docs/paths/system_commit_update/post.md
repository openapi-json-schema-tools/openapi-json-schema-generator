some_api.paths.system_commit_update.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| system_commit_update_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | SystemCommitUpdate | This api is only for path=/system/commit-update |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | About to update NetHSM.
...
412 | [ResponseFor412.ApiResponse](#responsefor412-apiresponse) | Precondition failed (NetHSM was not *Operational* or update image is not present - call &#x60;/update&#x60; first). 

## ResponseFor204

### Description
About to update NetHSM.
...
### Description
Precondition failed (NetHSM was not *Operational* or update image is not present - call &#x60;/update&#x60; first). 
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.system_commit_update_post()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->system_commit_update_post: %s\n" % e)
```
