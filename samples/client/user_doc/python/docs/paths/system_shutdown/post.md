some_api.paths.system_shutdown.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| system_shutdown_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | SystemShutdown | This api is only for path=/system/shutdown |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | About to shut down NetHSM.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.system_shutdown_post()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->system_shutdown_post: %s\n" % e)
```
