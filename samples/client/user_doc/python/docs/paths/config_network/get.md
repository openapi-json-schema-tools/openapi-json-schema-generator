...
| ----------- | --------- | ----- |
| config_network_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | ConfigNetwork | This api is only for path=/config/network |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | Successful retrieval of network configuration.
...
### Description
Successful retrieval of network configuration.

### ResponseFor200 ApiResponse
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
[body](#responsefor200-body) | [network_config.NetworkConfigDict](../../components/schema/network_config.md#networkconfigdict) |  |
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->config_network_get: %s\n" % e)
```
