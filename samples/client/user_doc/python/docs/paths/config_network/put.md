some_api.paths.config_network.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| config_network_put | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| put | ApiForPut | This api is only for this endpoint |
| put | ConfigNetwork | This api is only for path=/config/network |
...
------------- | ------------- | ------------- | -------------
[body](#requestbody) | typing.Union[[network_config.NetworkConfigDictInput](../../components/schema/network_config.md#networkconfigdictinput), [network_config.NetworkConfigDict](../../components/schema/network_config.md#networkconfigdict)] | required |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | Succesful update of network configuration.
...
### Description
Succesful update of network configuration.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    body = network_config.NetworkConfig.validate({
        "ip_address": "ip_address_example",
        "netmask": "netmask_example",
        "gateway": "gateway_example",
    })
    try:
        api_response = api_instance.config_network_put(
            body=body,
        )
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->config_network_put: %s\n" % e)
```
