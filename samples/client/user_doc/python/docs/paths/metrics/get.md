some_api.paths.metrics.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| metrics_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | Metrics | This api is only for path=/metrics |
...
| Field | Value |
| ----- | ----- |
| Description | Get metrics. Precondition: NetHSM is *Operational* and a **R-Metrics** can be authenticated.  |
| Path | "/metrics" |
| HTTP Method | get |
