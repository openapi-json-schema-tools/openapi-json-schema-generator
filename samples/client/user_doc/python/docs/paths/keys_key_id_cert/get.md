...
| ----------- | --------- | ----- |
| keys_key_id_cert_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | KeysKeyIDCert | This api is only for path=/keys/{KeyID}/cert |
...
------------- | ------------- | ------------- | -------------
accept_content_types | typing.Tuple[str] | default is ("application/x-pem-file", "application/x-x509-ca-cert", "application/pgp-keys", ) | Tells the server the content type(s) that are accepted by the client
...
404 | [ResponseFor404.ApiResponse](#responsefor404-apiresponse) | Certificate for KeyID not found.
...
[body](#responsefor200-body) | typing.Union[str, str, str] |  |
...
"application/x-x509-ca-cert" | [content.application_xx509_ca_cert.Schema](#responsefor200-content-applicationxx509cacert-schema)
"application/pgp-keys" | [content.application_pgp_keys.Schema](#responsefor200-content-applicationpgpkeys-schema)
...
#### ResponseFor200 content ApplicationXX509CaCert Schema
...
------------ | ------------- | -------------
str | str |
#### ResponseFor200 content ApplicationPgpKeys Schema
...
### Description
Certificate for KeyID not found.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.keys_key_id_cert_get()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->keys_key_id_cert_get: %s\n" % e)
```
