some_api.paths.system_update.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| system_update_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | SystemUpdate | This api is only for path=/system/update |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | Successfully verified update image (authenticity, integrity, and version number).
400 | [ResponseFor400.ApiResponse](#responsefor400-apiresponse) | Update malformed.
...
409 | [ResponseFor409.ApiResponse](#responsefor409-apiresponse) | Conflict - Major version downgrade is not allowed.
412 | [ResponseFor412.ApiResponse](#responsefor412-apiresponse) | Precondition failed (NetHSM was not *Operational*).

## ResponseFor200

### Description
Successfully verified update image (authenticity, integrity, and version number).

### ResponseFor200 ApiResponse
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
[body](#responsefor200-body) | [system_update_data.SystemUpdateDataDict](../../components/schema/system_update_data.md#systemupdatedatadict) |  |
...
### Description
Conflict - Major version downgrade is not allowed.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.system_update_post(
            body=body,
        )
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->system_update_post: %s\n" % e)
```
