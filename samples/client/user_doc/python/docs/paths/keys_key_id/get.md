...
| ----------- | --------- | ----- |
| keys_key_id_get | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| get | ApiForGet | This api is only for this endpoint |
| get | KeysKeyID | This api is only for path=/keys/{KeyID} |
...
200 | [ResponseFor200.ApiResponse](#responsefor200-apiresponse) | For response body with content type &#x60;application/json&#x60;: * *RSA* keys include &#x60;modulus&#x60; and &#x60;publicExponent&#x60; properties. * P* keys include the common format (0x04 followed by big-endian \\   encoded affine coordinates x and y). * Curve25519 keys are 32 byte, and follow the RFC8032 5.1.2 encoding \\   (little endian, x over y). 
...
### Description
For response body with content type &#x60;application/json&#x60;: * *RSA* keys include &#x60;modulus&#x60; and &#x60;publicExponent&#x60; properties. * P* keys include the common format (0x04 followed by big-endian \\   encoded affine coordinates x and y). * Curve25519 keys are 32 byte, and follow the RFC8032 5.1.2 encoding \\   (little endian, x over y). 

### ResponseFor200 ApiResponse
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
[body](#responsefor200-body) | [public_key.PublicKeyDict](../../components/schema/public_key.md#publickeydict) |  |
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.keys_key_id_get()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->keys_key_id_get: %s\n" % e)
```
