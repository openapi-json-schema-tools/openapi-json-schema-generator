some_api.paths.system_reboot.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| system_reboot_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | SystemReboot | This api is only for path=/system/reboot |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | About to reboot NetHSM.
