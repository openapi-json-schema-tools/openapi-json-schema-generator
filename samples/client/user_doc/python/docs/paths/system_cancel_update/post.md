some_api.paths.system_cancel_update.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| system_cancel_update_post | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| post | ApiForPost | This api is only for this endpoint |
| post | SystemCancelUpdate | This api is only for path=/system/cancel-update |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | Update successfully cancelled.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.system_cancel_update_post()
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->system_cancel_update_post: %s\n" % e)
```
