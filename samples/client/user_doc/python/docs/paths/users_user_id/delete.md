...
| ----------- | --------- | ----- |
| users_user_id_delete | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| delete | ApiForDelete | This api is only for this endpoint |
| delete | UsersUserID | This api is only for path=/users/{UserID} |
...
204 | [ResponseFor204.ApiResponse](#responsefor204-apiresponse) | Successful deletion of user.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.users_user_id_delete()
        pprint(api_response)
