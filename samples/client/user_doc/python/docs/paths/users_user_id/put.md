some_api.paths.users_user_id.operation
# Operation Method Name

| Method Name | Api Class | Notes |
| ----------- | --------- | ----- |
| users_user_id_put | [DefaultApi](../../apis/tags/default_api.md) | This api is only for tag=default |
| put | ApiForPut | This api is only for this endpoint |
| put | UsersUserID | This api is only for path=/users/{UserID} |
...
201 | [ResponseFor201.ApiResponse](#responsefor201-apiresponse) | Successful creation of user.
...
409 | [ResponseFor409.ApiResponse](#responsefor409-apiresponse) | Conflict - user already exists for this user-ID.
...
### Description
Conflict - user already exists for this user-ID.
...
with some_api.ApiClient(used_configuration) as api_client:
    ...
    try:
        api_response = api_instance.users_user_id_put(
            body=body,
        )
        pprint(api_response)
    except some_api.ApiException as e:
        print("Exception when calling DefaultApi->users_user_id_put: %s\n" % e)
```
