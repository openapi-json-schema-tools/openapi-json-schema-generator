...
def validate_one_of(
    ...
    cls: typing.Type,
    validation_metadata: ValidationMetadata,
    discriminated_cls: typing.Optional[SchemaValidator],
    **kwargs
) -> PathToSchemasType:
    oneof_classes = []
...
def _get_discriminated_class_and_exception(
    ...
    cls: typing.Type,
    validation_metadata: ValidationMetadata
) -> typing.Tuple[typing.Optional[SchemaValidator], typing.Optional[Exception]]:
    if not isinstance(arg, immutabledict):
        return None, None
    cls_schema = cls()
...
def validate_pattern_properties(
    arg: typing.Any,
    pattern_properties: typing.Mapping[schemas.PatternInfo, typing.Type[SchemaValidator]],
    cls: typing.Type,
    validation_metadata: ValidationMetadata,
    **kwargs
) -> typing.Optional[PathToSchemasType]:
