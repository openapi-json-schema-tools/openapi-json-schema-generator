...
from this_package.apis.paths.path_with_o_auth_password_security import PathWithOAuthPasswordSecurity
...
PathToApi = typing.TypedDict(
    ...
    "/pathWithOAuthPasswordSecurity": typing.Type[PathWithOAuthPasswordSecurity],
...
path_to_api = PathToApi(
    ...
    "/pathWithOAuthPasswordSecurity": PathWithOAuthPasswordSecurity,
