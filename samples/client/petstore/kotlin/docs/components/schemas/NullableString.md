...
| --------------------------- |
| NullableString1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
// null validation
Nothing? validatedPayload = NullableString.NullableString1.validate(
    (Nothing?) null,
    configuration
);
...
| [NullableString1BoxedVoid](#nullablestring1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
