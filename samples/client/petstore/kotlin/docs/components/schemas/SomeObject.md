...
| ----------------- | ---------------------- |
| sealed interface | [SomeObject.SomeObject1Boxed](#someobject1boxed)<br> sealed interface for validated payloads |
...
| --------------------------- |
| SomeObject1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [SomeObject1BoxedVoid](#someobject1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
