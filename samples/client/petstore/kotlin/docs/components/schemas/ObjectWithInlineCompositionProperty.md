...
| [ObjectWithInlineCompositionPropertyMapBuilder](#objectwithinlinecompositionpropertymapbuilder) | someProp(Nothing? value) |
...
| [ObjectWithInlineCompositionPropertyMapBuilder](#objectwithinlinecompositionpropertymapbuilder) | additionalProperty(String key, Nothing? value) |
...
| Constructor and Description |
| --------------------------- |
| SomePropBoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [SomePropBoxedVoid](#somepropboxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
