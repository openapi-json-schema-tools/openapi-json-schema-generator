...
| --------------------------- |
| SimpleQuadrilateral1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [SimpleQuadrilateral1BoxedVoid](#simplequadrilateral1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
