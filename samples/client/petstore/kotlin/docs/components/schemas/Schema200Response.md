...
| --------------------------- |
| Schema200Response1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [Schema200Response1BoxedVoid](#schema200response1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
...
| [Schema200ResponseMapBuilder](#schema200responsemapbuilder) | additionalProperty(String key, Nothing? value) |
