...
| --------------------------- |
| EquilateralTriangle1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [EquilateralTriangle1BoxedVoid](#equilateraltriangle1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
