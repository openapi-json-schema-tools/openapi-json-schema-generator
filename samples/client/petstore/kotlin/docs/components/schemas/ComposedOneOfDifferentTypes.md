...
| --------------------------- |
| ComposedOneOfDifferentTypes1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [ComposedOneOfDifferentTypes1BoxedVoid](#composedoneofdifferenttypes1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
...
| Modifier and Type | Method and Description |
| ----------------- | ---------------------- |
| Schema5ListBuilder | add(Nothing? item) |
