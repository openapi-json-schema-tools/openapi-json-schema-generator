...
| --------------------------- |
| Apple1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
// null validation
Nothing? validatedPayload = Apple.Apple1.validate(
    (Nothing?) null,
    configuration
);
...
| [Apple1BoxedVoid](#apple1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
...
| [AppleMap0Builder](#applemap0builder) | additionalProperty(String key, Nothing? value) |
