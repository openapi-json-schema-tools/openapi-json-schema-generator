...
| --------------------------- |
| NullableShape1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [NullableShape1BoxedVoid](#nullableshape1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
