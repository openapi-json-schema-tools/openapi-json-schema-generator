...
| --------------------------- |
| Dog1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [Dog1BoxedVoid](#dog1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
