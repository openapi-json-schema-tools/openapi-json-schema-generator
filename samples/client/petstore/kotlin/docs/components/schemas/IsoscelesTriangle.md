...
| --------------------------- |
| IsoscelesTriangle1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [IsoscelesTriangle1BoxedVoid](#isoscelestriangle1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
