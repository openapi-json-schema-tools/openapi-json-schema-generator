...
| Modifier and Type | Method and Description |
| ----------------- | ---------------------- |
| [JSONPatchRequestAddReplaceTestMap000Builder](#jsonpatchrequestaddreplacetestmap000builder) | value(Nothing? value) |
...
| [JSONPatchRequestAddReplaceTestMap010Builder](#jsonpatchrequestaddreplacetestmap010builder) | value(Nothing? value) |
...
| [JSONPatchRequestAddReplaceTestMap100Builder](#jsonpatchrequestaddreplacetestmap100builder) | value(Nothing? value) |
...
| [JSONPatchRequestAddReplaceTestMap110Builder](#jsonpatchrequestaddreplacetestmap110builder) | value(Nothing? value) |
...
| Constructor and Description |
| --------------------------- |
| ValueBoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
