...
| --------------------------- |
| ChildCat1BoxedVoid(Nothing? data)<br>Creates an instance, private visibility |
...
| [ChildCat1BoxedVoid](#childcat1boxedvoid) | validateAndBox(Nothing? arg, SchemaConfiguration configuration) |
