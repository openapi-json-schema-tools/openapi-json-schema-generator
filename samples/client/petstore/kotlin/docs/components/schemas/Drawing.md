...
| ----------------- | ---------------------- |
| sealed interface | [Drawing.Drawing1Boxed](#drawing1boxed)<br> sealed interface for validated payloads |
...
| sealed interface | [Drawing.ShapesBoxed](#shapesboxed)<br> sealed interface for validated payloads |
...
| [DrawingMapBuilder](#drawingmapbuilder) | mainShape(Nothing? value) |
...
| [DrawingMapBuilder](#drawingmapbuilder) | shapeOrNull(Nothing? value) |
...
| [DrawingMapBuilder](#drawingmapbuilder) | nullableShape(Nothing? value) |
...
| [DrawingMapBuilder](#drawingmapbuilder) | additionalProperty(String key, Nothing? value) |
...
| Modifier and Type | Method and Description |
| ----------------- | ---------------------- |
| ShapesListBuilder | add(Nothing? item) |
