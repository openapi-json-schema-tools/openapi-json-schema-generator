package org.openapijsonschematools.client.paths.fake.patch.responses;
...
public class FakePatchCode200Response {
    ...
    public static class FakePatchCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakePatchCode200Response1() {
            super(
                Map.ofEntries(
