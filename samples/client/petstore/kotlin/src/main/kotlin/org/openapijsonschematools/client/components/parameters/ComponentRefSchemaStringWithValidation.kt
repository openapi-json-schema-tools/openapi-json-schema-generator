...
public class ComponentRefSchemaStringWithValidation {
    ...
    public record ApplicationjsonMediaType(ApplicationjsonSchema.ApplicationjsonSchema1 schema) implements MediaType<ApplicationjsonSchema.ApplicationjsonSchema1, Nothing?> {
