...
public class FakerefsobjectmodelwithrefpropsPostRequestBody {
    ...
    public static class FakerefsobjectmodelwithrefpropsPostRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakerefsobjectmodelwithrefpropsPostRequestBody1() {
            super(
                Map.ofEntries(
