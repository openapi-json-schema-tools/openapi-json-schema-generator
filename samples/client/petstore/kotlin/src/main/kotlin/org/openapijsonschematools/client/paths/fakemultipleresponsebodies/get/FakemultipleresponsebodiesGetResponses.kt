...
public class FakemultipleresponsebodiesGetResponses {
    ...
    public record EndpointFakemultipleresponsebodiesGetCode200Response(
        ...
        Nothing? headers
    ) implements EndpointResponse, ApiResponse<FakemultipleresponsebodiesGetCode200Response.SealedResponseBody, Nothing?>{
    }
    ...
    public record EndpointFakemultipleresponsebodiesGetCode202Response(
        ...
        Nothing? headers
    ) implements EndpointResponse, ApiResponse<FakemultipleresponsebodiesGetCode202Response.SealedResponseBody, Nothing?>{
    }
