package org.openapijsonschematools.client.paths.fakerefsobjectmodelwithrefprops.post.responses;
...
import org.openapijsonschematools.client.paths.fakerefsobjectmodelwithrefprops.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakerefsobjectmodelwithrefpropsPostCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.ObjectModelWithRefProps1Boxed body) implements SealedResponseBody { }

    public static class FakerefsobjectmodelwithrefpropsPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsobjectmodelwithrefpropsPostCode200Response1() {
            super(
                Map.ofEntries(
