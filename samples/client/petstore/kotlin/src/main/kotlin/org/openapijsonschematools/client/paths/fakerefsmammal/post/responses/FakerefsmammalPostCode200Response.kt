package org.openapijsonschematools.client.paths.fakerefsmammal.post.responses;
...
public class FakerefsmammalPostCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.Mammal1Boxed body) implements SealedResponseBody { }

    public static class FakerefsmammalPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsmammalPostCode200Response1() {
            super(
                Map.ofEntries(
