...
public class FakerefsstringPostRequestBody {
    ...
    public static class FakerefsstringPostRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakerefsstringPostRequestBody1() {
            super(
                Map.ofEntries(
