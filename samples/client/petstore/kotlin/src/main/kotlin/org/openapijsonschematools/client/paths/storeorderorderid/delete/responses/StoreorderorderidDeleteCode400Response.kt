...
public class StoreorderorderidDeleteCode400Response {
    ...
    public static class StoreorderorderidDeleteCode400Response1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public StoreorderorderidDeleteCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );
