...
import org.openapijsonschematools.client.paths.fakewildcardresponses.get.responses.code4xxresponse.content.applicationjson.ApplicationjsonSchema;
...
public class FakewildcardresponsesGetCode4XXResponse {
    ...
    public static class FakewildcardresponsesGetCode4XXResponse1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakewildcardresponsesGetCode4XXResponse1() {
            super(
                Map.ofEntries(
