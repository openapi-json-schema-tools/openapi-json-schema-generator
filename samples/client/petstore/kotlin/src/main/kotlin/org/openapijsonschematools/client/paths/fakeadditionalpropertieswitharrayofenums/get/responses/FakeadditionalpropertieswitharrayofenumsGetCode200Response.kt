package org.openapijsonschematools.client.paths.fakeadditionalpropertieswitharrayofenums.get.responses;
...
import org.openapijsonschematools.client.paths.fakeadditionalpropertieswitharrayofenums.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakeadditionalpropertieswitharrayofenumsGetCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.AdditionalPropertiesWithArrayOfEnums1Boxed body) implements SealedResponseBody { }

    public static class FakeadditionalpropertieswitharrayofenumsGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakeadditionalpropertieswitharrayofenumsGetCode200Response1() {
            super(
                Map.ofEntries(
