...
import org.openapijsonschematools.client.paths.fakewildcardresponses.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakewildcardresponsesGetCode200Response {
    ...
    public static class FakewildcardresponsesGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakewildcardresponsesGetCode200Response1() {
            super(
                Map.ofEntries(
