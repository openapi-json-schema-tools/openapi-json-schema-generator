...
import org.openapijsonschematools.client.paths.fakewildcardresponses.get.responses.code5xxresponse.content.applicationjson.ApplicationjsonSchema;
...
public class FakewildcardresponsesGetCode5XXResponse {
    ...
    public static class FakewildcardresponsesGetCode5XXResponse1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakewildcardresponsesGetCode5XXResponse1() {
            super(
                Map.ofEntries(
