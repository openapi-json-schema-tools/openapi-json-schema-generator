package org.openapijsonschematools.client.paths.fakemultiplerequestbodycontenttypes.post.responses;
...
import org.openapijsonschematools.client.paths.fakemultiplerequestbodycontenttypes.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakemultiplerequestbodycontenttypesPostCode200Response {
    ...
    public static class FakemultiplerequestbodycontenttypesPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakemultiplerequestbodycontenttypesPostCode200Response1() {
            super(
                Map.ofEntries(
