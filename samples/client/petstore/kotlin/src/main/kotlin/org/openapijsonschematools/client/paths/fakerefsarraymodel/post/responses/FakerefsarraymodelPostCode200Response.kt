package org.openapijsonschematools.client.paths.fakerefsarraymodel.post.responses;
...
import org.openapijsonschematools.client.paths.fakerefsarraymodel.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakerefsarraymodelPostCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.AnimalFarm1Boxed body) implements SealedResponseBody { }

    public static class FakerefsarraymodelPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsarraymodelPostCode200Response1() {
            super(
                Map.ofEntries(
