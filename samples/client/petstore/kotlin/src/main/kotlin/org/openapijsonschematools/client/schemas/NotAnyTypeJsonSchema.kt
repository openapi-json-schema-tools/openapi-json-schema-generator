...
import org.openapijsonschematools.client.schemas.AnyTypeJsonSchema.AnyTypeJsonSchema1
...
class NotAnyTypeJsonSchema {
    ...
    class NotAnyTypeJsonSchema1 private constructor() : JsonSchema<NotAnyTypeJsonSchema1Boxed?>(
        JsonSchemaInfo()
            .not(AnyTypeJsonSchema1::class.java)
