...
public class StoreorderorderidGetCode400Response {
    ...
    public static class StoreorderorderidGetCode400Response1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public StoreorderorderidGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );
