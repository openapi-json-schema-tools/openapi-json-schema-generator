...
public class FakeinlineadditionalpropertiesPostRequestBody {
    ...
    public static class FakeinlineadditionalpropertiesPostRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakeinlineadditionalpropertiesPostRequestBody1() {
            super(
                Map.ofEntries(
