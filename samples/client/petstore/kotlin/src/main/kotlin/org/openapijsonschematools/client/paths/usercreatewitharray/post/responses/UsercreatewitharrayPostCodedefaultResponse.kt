...
public class UsercreatewitharrayPostCodedefaultResponse {
    ...
    public static class UsercreatewitharrayPostCodedefaultResponse1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public UsercreatewitharrayPostCodedefaultResponse1() {
            super(
                MapUtils.makeMap(
                )
            );
