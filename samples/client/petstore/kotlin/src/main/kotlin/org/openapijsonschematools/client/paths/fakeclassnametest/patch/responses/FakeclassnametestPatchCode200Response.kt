package org.openapijsonschematools.client.paths.fakeclassnametest.patch.responses;
...
import org.openapijsonschematools.client.paths.fakeclassnametest.patch.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakeclassnametestPatchCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.Client1Boxed body) implements SealedResponseBody { }

    public static class FakeclassnametestPatchCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakeclassnametestPatchCode200Response1() {
            super(
                Map.ofEntries(
