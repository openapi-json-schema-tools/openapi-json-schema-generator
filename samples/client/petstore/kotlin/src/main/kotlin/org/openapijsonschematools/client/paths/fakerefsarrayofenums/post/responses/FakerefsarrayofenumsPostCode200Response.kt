package org.openapijsonschematools.client.paths.fakerefsarrayofenums.post.responses;
...
public class FakerefsarrayofenumsPostCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.ArrayOfEnums1Boxed body) implements SealedResponseBody { }

    public static class FakerefsarrayofenumsPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsarrayofenumsPostCode200Response1() {
            super(
                Map.ofEntries(
