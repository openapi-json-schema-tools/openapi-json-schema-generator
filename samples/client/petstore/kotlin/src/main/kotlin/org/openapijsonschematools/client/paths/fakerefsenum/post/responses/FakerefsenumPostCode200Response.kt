package org.openapijsonschematools.client.paths.fakerefsenum.post.responses;
...
import org.openapijsonschematools.client.paths.fakerefsenum.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakerefsenumPostCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.StringEnum1Boxed body) implements SealedResponseBody { }

    public static class FakerefsenumPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsenumPostCode200Response1() {
            super(
                Map.ofEntries(
