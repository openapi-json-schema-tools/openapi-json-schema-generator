package org.openapijsonschematools.client.paths.fakeuploadfile.post.responses;
...
import org.openapijsonschematools.client.paths.fakeuploadfile.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakeuploadfilePostCode200Response {
    ...
    public static class FakeuploadfilePostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakeuploadfilePostCode200Response1() {
            super(
                Map.ofEntries(
