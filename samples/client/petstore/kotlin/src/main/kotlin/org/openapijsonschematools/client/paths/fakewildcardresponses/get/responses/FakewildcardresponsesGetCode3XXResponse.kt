...
import org.openapijsonschematools.client.paths.fakewildcardresponses.get.responses.code3xxresponse.content.applicationjson.ApplicationjsonSchema;
...
public class FakewildcardresponsesGetCode3XXResponse {
    ...
    public static class FakewildcardresponsesGetCode3XXResponse1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakewildcardresponsesGetCode3XXResponse1() {
            super(
                Map.ofEntries(
