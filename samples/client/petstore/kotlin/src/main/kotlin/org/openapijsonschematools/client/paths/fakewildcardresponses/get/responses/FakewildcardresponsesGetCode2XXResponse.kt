...
import org.openapijsonschematools.client.paths.fakewildcardresponses.get.responses.code2xxresponse.content.applicationjson.ApplicationjsonSchema;
...
public class FakewildcardresponsesGetCode2XXResponse {
    ...
    public static class FakewildcardresponsesGetCode2XXResponse1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakewildcardresponsesGetCode2XXResponse1() {
            super(
                Map.ofEntries(
