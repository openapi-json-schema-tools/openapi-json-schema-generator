package org.openapijsonschematools.client.paths.fakedeletecoffeeid.delete.responses;
...
public class FakedeletecoffeeidDeleteCodedefaultResponse {
    ...
    public static class FakedeletecoffeeidDeleteCodedefaultResponse1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public FakedeletecoffeeidDeleteCodedefaultResponse1() {
            super(
                MapUtils.makeMap(
                )
            );
