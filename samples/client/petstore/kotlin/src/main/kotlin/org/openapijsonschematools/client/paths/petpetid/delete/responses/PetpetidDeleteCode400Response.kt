package org.openapijsonschematools.client.paths.petpetid.delete.responses;
...
public class PetpetidDeleteCode400Response {
    ...
    public static class PetpetidDeleteCode400Response1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public PetpetidDeleteCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );
