...
public class StoreorderorderidGetCode404Response {
    ...
    public static class StoreorderorderidGetCode404Response1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public StoreorderorderidGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );
