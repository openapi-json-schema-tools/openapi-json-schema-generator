...
import org.openapijsonschematools.client.paths.fakemultipleresponsebodies.get.responses.code202response.content.applicationjson.ApplicationjsonSchema;
...
public class FakemultipleresponsebodiesGetCode202Response {
    ...
    public static class FakemultipleresponsebodiesGetCode202Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakemultipleresponsebodiesGetCode202Response1() {
            super(
                Map.ofEntries(
