package org.openapijsonschematools.client.paths.fakehealth.get.responses;
...
import org.openapijsonschematools.client.paths.fakehealth.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakehealthGetCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.HealthCheckResult1Boxed body) implements SealedResponseBody { }

    public static class FakehealthGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakehealthGetCode200Response1() {
            super(
                Map.ofEntries(
