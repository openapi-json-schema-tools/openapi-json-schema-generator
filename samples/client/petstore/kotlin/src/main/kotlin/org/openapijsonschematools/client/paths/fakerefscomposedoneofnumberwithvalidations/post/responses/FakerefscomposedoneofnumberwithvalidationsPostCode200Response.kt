package org.openapijsonschematools.client.paths.fakerefscomposedoneofnumberwithvalidations.post.responses;
...
import org.openapijsonschematools.client.paths.fakerefscomposedoneofnumberwithvalidations.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakerefscomposedoneofnumberwithvalidationsPostCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.ComposedOneOfDifferentTypes1Boxed body) implements SealedResponseBody { }

    public static class FakerefscomposedoneofnumberwithvalidationsPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefscomposedoneofnumberwithvalidationsPostCode200Response1() {
            super(
                Map.ofEntries(
