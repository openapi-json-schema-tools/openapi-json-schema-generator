...
import org.openapijsonschematools.client.paths.fakerefsarraymodel.post.requestbody.content.applicationjson.ApplicationjsonSchema;
...
public class FakerefsarraymodelPostRequestBody {
    ...
    public static class FakerefsarraymodelPostRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakerefsarraymodelPostRequestBody1() {
            super(
                Map.ofEntries(
    ...
    public record ApplicationjsonRequestBody(ApplicationjsonSchema.AnimalFarm1Boxed body) implements SealedRequestBody, GenericRequestBody<ApplicationjsonSchema.AnimalFarm1Boxed> {
        @Override
