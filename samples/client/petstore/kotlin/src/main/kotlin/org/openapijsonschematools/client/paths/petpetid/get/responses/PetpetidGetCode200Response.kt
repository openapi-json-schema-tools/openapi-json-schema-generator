...
public class PetpetidGetCode200Response {
    ...
    public static class PetpetidGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public PetpetidGetCode200Response1() {
            super(
                Map.ofEntries(
