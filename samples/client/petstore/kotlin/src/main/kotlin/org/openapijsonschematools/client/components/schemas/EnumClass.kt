...
public class EnumClass {
    ...
    public static class EnumClass1 extends JsonSchema<EnumClass1Boxed> implements StringSchemaValidator<EnumClass1BoxedString>, StringEnumValidator<StringEnumClassEnums>, DefaultValueMethod<String> {
        ...
        */
        ...
        @Override
        public EnumClass1BoxedString validateAndBox(String arg, SchemaConfiguration configuration) throws ValidationException {
            return new EnumClass1BoxedString(validate(arg, configuration));
        }
        @Override
        public EnumClass1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException {
