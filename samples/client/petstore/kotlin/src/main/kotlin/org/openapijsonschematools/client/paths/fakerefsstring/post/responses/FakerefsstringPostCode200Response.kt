package org.openapijsonschematools.client.paths.fakerefsstring.post.responses;
...
import org.openapijsonschematools.client.paths.fakerefsstring.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakerefsstringPostCode200Response {
    ...
    public static class FakerefsstringPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsstringPostCode200Response1() {
            super(
                Map.ofEntries(
