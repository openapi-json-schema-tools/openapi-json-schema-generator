package org.openapijsonschematools.client.paths.userusername.put.responses;
...
public class UserusernamePutCode404Response {
    ...
    public static class UserusernamePutCode404Response1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public UserusernamePutCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );
