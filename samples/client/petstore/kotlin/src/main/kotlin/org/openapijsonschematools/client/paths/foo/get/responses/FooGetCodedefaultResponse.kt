...
public class FooGetCodedefaultResponse {
    ...
    public static class FooGetCodedefaultResponse1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FooGetCodedefaultResponse1() {
            super(
                Map.ofEntries(
