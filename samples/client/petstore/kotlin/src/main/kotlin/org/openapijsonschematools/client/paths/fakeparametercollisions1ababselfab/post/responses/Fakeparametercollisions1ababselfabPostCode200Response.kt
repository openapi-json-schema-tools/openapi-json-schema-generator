package org.openapijsonschematools.client.paths.fakeparametercollisions1ababselfab.post.responses;
...
import org.openapijsonschematools.client.paths.fakeparametercollisions1ababselfab.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class Fakeparametercollisions1ababselfabPostCode200Response {
    ...
    public static class Fakeparametercollisions1ababselfabPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public Fakeparametercollisions1ababselfabPostCode200Response1() {
            super(
                Map.ofEntries(
