...
public class AnotherfakedummyPatchCode200Response {
    ...
    public static class AnotherfakedummyPatchCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public AnotherfakedummyPatchCode200Response1() {
            super(
                Map.ofEntries(
