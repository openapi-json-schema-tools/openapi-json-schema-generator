package org.openapijsonschematools.client.paths.fakerefsboolean.post.responses;
...
import org.openapijsonschematools.client.paths.fakerefsboolean.post.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class FakerefsbooleanPostCode200Response {
    ...
    public record ApplicationjsonResponseBody(ApplicationjsonSchema.BooleanJsonSchema1Boxed body) implements SealedResponseBody { }

    public static class FakerefsbooleanPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsbooleanPostCode200Response1() {
            super(
                Map.ofEntries(
