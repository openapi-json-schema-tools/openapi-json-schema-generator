package org.openapijsonschematools.client.paths.usercreatewithlist.post.responses;
...
public class UsercreatewithlistPostCodedefaultResponse {
    ...
    public static class UsercreatewithlistPostCodedefaultResponse1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public UsercreatewithlistPostCodedefaultResponse1() {
            super(
                MapUtils.makeMap(
                )
            );
