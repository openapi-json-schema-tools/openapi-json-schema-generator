...
public class FakeuploadfilePostRequestBody {
    ...
    public static class FakeuploadfilePostRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakeuploadfilePostRequestBody1() {
            super(
                Map.ofEntries(
