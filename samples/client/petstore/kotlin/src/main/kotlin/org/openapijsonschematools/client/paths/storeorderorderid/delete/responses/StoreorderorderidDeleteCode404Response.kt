...
public class StoreorderorderidDeleteCode404Response {
    ...
    public static class StoreorderorderidDeleteCode404Response1 extends ResponseDeserializer<Nothing?, Nothing?, Nothing?> {
        public StoreorderorderidDeleteCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );
