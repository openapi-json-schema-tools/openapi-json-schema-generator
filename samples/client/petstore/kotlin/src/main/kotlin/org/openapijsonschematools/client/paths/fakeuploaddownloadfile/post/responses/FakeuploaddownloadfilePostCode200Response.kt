...
public class FakeuploaddownloadfilePostCode200Response {
    ...
    public record ApplicationoctetstreamMediaType(ApplicationoctetstreamSchema.ApplicationoctetstreamSchema1 schema) implements SealedMediaType, MediaType<ApplicationoctetstreamSchema.ApplicationoctetstreamSchema1, Nothing?> {
    ...
    public static class FakeuploaddownloadfilePostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakeuploaddownloadfilePostCode200Response1() {
            super(
                Map.ofEntries(
