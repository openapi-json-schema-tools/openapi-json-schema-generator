...
public class FakerefsnumberPostCode200Response {
    ...
    public static class FakerefsnumberPostCode200Response1 extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
        public FakerefsnumberPostCode200Response1() {
            super(
                Map.ofEntries(
