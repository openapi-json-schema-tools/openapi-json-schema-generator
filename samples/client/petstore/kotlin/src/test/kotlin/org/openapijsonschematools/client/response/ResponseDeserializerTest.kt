...
public class ResponseDeserializerTest {
    ...
    public record ApplicationjsonMediatype(AnyTypeJsonSchema.AnyTypeJsonSchema1 schema) implements SealedMediaType, MediaType<AnyTypeJsonSchema.AnyTypeJsonSchema1, Nothing?> {
    ...
    public record TextplainMediatype(StringJsonSchema.StringJsonSchema1 schema) implements SealedMediaType, MediaType<StringJsonSchema.StringJsonSchema1, Nothing?> {
    ...
    public static class MyResponseDeserializer extends ResponseDeserializer<SealedResponseBody, Nothing?, SealedMediaType> {
    ...
    public void testDeserializeApplicationJsonNull() throws ValidationException, ApiException, NotImplementedException {
        ...
        DeserializedHttpResponse<SealedResponseBody, Nothing?> apiResponse = deserializer.deserialize(response, configuration);
