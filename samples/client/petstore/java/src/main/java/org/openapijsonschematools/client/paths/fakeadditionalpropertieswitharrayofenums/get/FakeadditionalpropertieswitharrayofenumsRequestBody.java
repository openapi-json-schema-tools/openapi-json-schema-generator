...
public class FakeadditionalpropertieswitharrayofenumsRequestBody {
    ...
    public static class FakeadditionalpropertieswitharrayofenumsRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakeadditionalpropertieswitharrayofenumsRequestBody1() {
            super(
                Map.ofEntries(
