...
public class FakebodywithfileschemaRequestBody {
    ...
    public static class FakebodywithfileschemaRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakebodywithfileschemaRequestBody1() {
            super(
                Map.ofEntries(
