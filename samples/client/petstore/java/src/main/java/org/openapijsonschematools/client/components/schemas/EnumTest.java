...
public class EnumTest {
    ...
    public static class EnumString extends NonCollectionJsonSchema {
        public EnumString() {
    ...
    public static class EnumStringRequired extends NonCollectionJsonSchema {
    ...
    public static class EnumInteger extends NonCollectionJsonSchema {
        public EnumInteger() {
            super(new LinkedHashMap<>(Map.ofEntries(
                new KeywordEntry("type", new TypeValidator(Set.of(
                    Integer.class,
    ...
    public static class EnumNumber extends NonCollectionJsonSchema {
        public EnumNumber() {
            super(new LinkedHashMap<>(Map.ofEntries(
                new KeywordEntry("type", new TypeValidator(Set.of(
                    Integer.class,
