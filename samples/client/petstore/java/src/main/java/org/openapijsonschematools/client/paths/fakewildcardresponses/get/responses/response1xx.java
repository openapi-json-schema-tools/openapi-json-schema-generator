...
import org.openapijsonschematools.client.paths.fakewildcardresponses.get.responses.response1xx.content.applicationjson.ApplicationjsonSchema;

import java.util.AbstractMap;
import java.util.Map;
import java.net.http.HttpHeaders;

public class Model1XX {
    ...
    public static class Model1XX1 extends ResponseDeserializer<SealedResponseBody, Void> {
        public Model1XX1() {
            super(
                Map.ofEntries(
