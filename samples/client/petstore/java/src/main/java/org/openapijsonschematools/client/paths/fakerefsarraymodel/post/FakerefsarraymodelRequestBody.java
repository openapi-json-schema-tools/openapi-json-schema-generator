...
public class FakerefsarraymodelRequestBody {
    ...
    public static class FakerefsarraymodelRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakerefsarraymodelRequestBody1() {
            super(
                Map.ofEntries(
