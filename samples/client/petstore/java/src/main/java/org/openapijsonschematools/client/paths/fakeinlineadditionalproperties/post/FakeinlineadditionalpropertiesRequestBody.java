...
public class FakeinlineadditionalpropertiesRequestBody {
    ...
    public static class FakeinlineadditionalpropertiesRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakeinlineadditionalpropertiesRequestBody1() {
            super(
                Map.ofEntries(
