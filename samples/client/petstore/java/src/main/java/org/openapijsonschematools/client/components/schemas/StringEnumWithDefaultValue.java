...
public class StringEnumWithDefaultValue {
    ...
    public static class StringEnumWithDefaultValue1 extends JsonSchema<StringEnumWithDefaultValue1Boxed> implements StringSchemaValidator<StringEnumWithDefaultValue1BoxedString>, StringEnumValidator<StringStringEnumWithDefaultValueEnums>, DefaultValueMethod<String> {
        ...
        */
        ...
        @Override
        public StringEnumWithDefaultValue1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException, InvalidTypeException {
