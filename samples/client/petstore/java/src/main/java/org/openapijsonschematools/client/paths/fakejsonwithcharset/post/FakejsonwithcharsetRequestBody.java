...
public class FakejsonwithcharsetRequestBody {
    ...
    public static class FakejsonwithcharsetRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakejsonwithcharsetRequestBody1() {
            super(
                Map.ofEntries(
