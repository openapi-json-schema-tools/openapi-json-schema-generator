...
public class Headers {
    ...
    public static class Headers1 extends JsonSchema<String, String, HeadersMap, Object, Object, FrozenList<Object>> {
        public Headers1() {
        ...
        @Override
        protected HeadersMap getMapOutputInstance(FrozenMap<String, String> arg) {
