...
public class PetpetiduploadimageRequestBody {
    ...
    public static class PetpetiduploadimageRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public PetpetiduploadimageRequestBody1() {
            super(
                Map.ofEntries(
