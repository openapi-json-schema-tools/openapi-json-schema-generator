...
public class FakeinlinecompositionRequestBody {
    ...
    public static class FakeinlinecompositionRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakeinlinecompositionRequestBody1() {
            super(
                Map.ofEntries(
