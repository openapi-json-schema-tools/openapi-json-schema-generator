...
public class UserloginGet {
    private static class UserloginGetProvider {
        private static final String method = "get";

        public static Responses.EndpointResponse get(
            UserloginGetRequest request,
    ...
    public interface UserloginGetOperation {
        ApiConfiguration getApiConfiguration();
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default Responses.EndpointResponse get(UserloginGetRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
    ...
    public static class UserloginGet1 extends ApiClient implements UserloginGetOperation {
        public UserloginGet1(ApiConfiguration apiConfiguration, SchemaConfiguration schemaConfiguration) {
            super(apiConfiguration, schemaConfiguration);
        }
    }

    public static class UserloginGetRequest {
        public QueryParameters.QueryParametersMap queryParameters;
        public RootServerInfo.@Nullable ServerIndex serverIndex;
        public @Nullable Duration timeout;

        public UserloginGetRequest(
    ...
    public static class UserloginGetNullableRequest {
