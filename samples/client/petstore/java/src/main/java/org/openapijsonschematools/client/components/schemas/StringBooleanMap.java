...
public class StringBooleanMap {
    ...
    public static class StringBooleanMap1 extends JsonSchema<Boolean, StringBooleanMapMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected StringBooleanMapMap getMapOutputInstance(FrozenMap<String, ?> arg) {
