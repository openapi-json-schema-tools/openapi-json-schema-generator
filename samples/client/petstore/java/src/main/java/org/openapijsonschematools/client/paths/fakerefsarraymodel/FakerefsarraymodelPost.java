...
public class FakerefsarraymodelPost {
    private static class PostProvider {
        ...
        public static FakerefsarraymodelPostResponses.EndpointResponse post(
            PostRequest request,
            ...
            if (request.requestBody != null) {
                serializedRequestBody = new FakerefsarraymodelPostRequestBody.FakerefsarraymodelPostRequestBody1().serialize(
                    request.requestBody
                );
            ...
            var responsesDeserializer = new FakerefsarraymodelPostResponses.FakerefsarraymodelPostResponses1();
    ...
    public interface PostOperation {
        ...
        default FakerefsarraymodelPostResponses.EndpointResponse post(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
    ...
    public interface ArrayModelOperation {
        ...
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default FakerefsarraymodelPostResponses.EndpointResponse arrayModel(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return PostProvider.post(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }
    ...
    public static class PostRequest {
        public FakerefsarraymodelPostRequestBody.@Nullable SealedRequestBody requestBody;
    ...
    public interface SetterForRequestBody <T> {
        ...
        default T requestBody(FakerefsarraymodelPostRequestBody.SealedRequestBody requestBody) {
