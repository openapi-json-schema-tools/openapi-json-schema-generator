...
import org.openapijsonschematools.client.paths.foo.get.responses.responsedefault.content.applicationjson.ApplicationjsonSchema;
...
public class ModelDefault {
    ...
    public static class ModelDefault1 extends ResponseDeserializer<SealedResponseBody, Void> {
