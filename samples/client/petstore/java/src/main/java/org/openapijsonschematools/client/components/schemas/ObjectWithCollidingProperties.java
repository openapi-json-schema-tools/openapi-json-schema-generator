...
public class ObjectWithCollidingProperties {
    ...
    public static class ObjectWithCollidingProperties1 extends JsonSchema<ObjectWithCollidingPropertiesMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectWithCollidingPropertiesMap getMapOutputInstance(FrozenMap<?, ?> arg) {
