...
public class ObjectWithCollidingProperties {
    ...
    public static class ObjectWithCollidingProperties1 extends JsonSchema<Object, ObjectWithCollidingPropertiesMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectWithCollidingPropertiesMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new ObjectWithCollidingPropertiesMap((FrozenMap<String, Object>) arg);
        }
