...
public class Bar {
    ...
    public static class Bar1 extends JsonSchema<Bar1Boxed> implements StringSchemaValidator<Bar1BoxedString>, DefaultValueMethod<String> {
        /*
        ...
        */
        ...
        @Override
        public Bar1BoxedString validateAndBox(String arg, SchemaConfiguration configuration) throws ValidationException {
            return new Bar1BoxedString(validate(arg, configuration));
        }
        @Override
        public Bar1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException {
