...
public class UserPost {
    private static class PostProvider {
        ...
        public static UserPostResponses.EndpointResponse post(
            PostRequest request,
            ...
            var responsesDeserializer = new UserPostResponses.UserPostResponses1();
    ...
    public interface PostOperation {
        ...
        default UserPostResponses.EndpointResponse post(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
    ...
    public interface CreateUserOperation {
        ...
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default UserPostResponses.EndpointResponse createUser(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return PostProvider.post(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }
