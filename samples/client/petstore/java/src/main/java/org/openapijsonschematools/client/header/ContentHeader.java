...
public class ContentHeader extends HeaderBase implements Header {
    ...
    @Override
    public HttpHeaders serialize(@Nullable Object inData, String name, boolean validate, SchemaConfiguration configuration) throws NotImplementedException, OpenapiDocumentException {
    ...
    @Override
    public @Nullable Object deserialize(List<String> inData, boolean validate, SchemaConfiguration configuration) throws NotImplementedException, OpenapiDocumentException {
