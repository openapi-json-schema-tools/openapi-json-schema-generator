...
public class Fakeparametercollisions1ababselfabRequestBody {
    ...
    public static class Fakeparametercollisions1ababselfabRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public Fakeparametercollisions1ababselfabRequestBody1() {
            super(
                Map.ofEntries(
