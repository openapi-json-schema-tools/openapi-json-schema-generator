...
public class FakerefscomposedoneofnumberwithvalidationsRequestBody {
    ...
    public static class FakerefscomposedoneofnumberwithvalidationsRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakerefscomposedoneofnumberwithvalidationsRequestBody1() {
            super(
                Map.ofEntries(
