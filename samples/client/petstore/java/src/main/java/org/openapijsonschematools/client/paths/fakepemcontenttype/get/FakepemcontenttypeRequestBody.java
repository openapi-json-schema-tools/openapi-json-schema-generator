...
public class FakepemcontenttypeRequestBody {
    ...
    public static class FakepemcontenttypeRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakepemcontenttypeRequestBody1() {
            super(
                Map.ofEntries(
