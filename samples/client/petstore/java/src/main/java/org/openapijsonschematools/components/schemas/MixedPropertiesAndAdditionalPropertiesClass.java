...
public class MixedPropertiesAndAdditionalPropertiesClass {
    ...
    public record MixedPropertiesAndAdditionalPropertiesClass2(LinkedHashSet<Class<?>> type) implements JsonSchema {
        /*
        ...
        */
        public static MixedPropertiesAndAdditionalPropertiesClass2 withDefaults() {
            LinkedHashSet<Class<?>> type = new LinkedHashSet<>();
            type.add(FrozenMap.class);
            return new MixedPropertiesAndAdditionalPropertiesClass2(type);
        }
        public static <T extends FrozenMap> T validate(Map<String, Object> arg, SchemaConfiguration configuration) {
