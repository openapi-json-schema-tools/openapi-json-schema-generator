...
public class DateWithValidations {
    ...
    public static class DateWithValidations1 extends JsonSchema<DateWithValidations1Boxed> implements StringSchemaValidator<DateWithValidations1BoxedString> {
        ...
        */
        ...
        @Override
        public DateWithValidations1BoxedString validateAndBox(String arg, SchemaConfiguration configuration) throws ValidationException {
            return new DateWithValidations1BoxedString(validate(arg, configuration));
        }
        @Override
        public DateWithValidations1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException {
