...
public class Order {
    ...
    public static class Order1 extends JsonSchema<Object, OrderMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected OrderMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new OrderMap((FrozenMap<String, Object>) arg);
        }
