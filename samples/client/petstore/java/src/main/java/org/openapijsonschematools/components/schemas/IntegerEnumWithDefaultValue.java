...
public class IntegerEnumWithDefaultValue {
    ...
    public record IntegerEnumWithDefaultValue2(LinkedHashSet<Class<?>> type) implements JsonSchema {
        /*
        ...
        */
        public static IntegerEnumWithDefaultValue2 withDefaults() {
            LinkedHashSet<Class<?>> type = new LinkedHashSet<>();
            type.add(Integer.class);
            type.add(Long.class);
            type.add(Float.class);
            type.add(Double.class);
            return new IntegerEnumWithDefaultValue2(type);
        }
        public static Long validate(Integer arg, SchemaConfiguration configuration) {
            return JsonSchema.validate(IntegerEnumWithDefaultValue2.class, Long.valueOf(arg), configuration);
        }
        
        public static Long validate(Float arg, SchemaConfiguration configuration) {
            return JsonSchema.validate(IntegerEnumWithDefaultValue2.class, Long.parseLong(arg.toString()), configuration);
        }
        
        public static Long validate(Long arg, SchemaConfiguration configuration) {
            return JsonSchema.validate(IntegerEnumWithDefaultValue2.class, arg, configuration);
        }
