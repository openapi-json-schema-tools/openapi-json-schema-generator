...
public class FakerefsobjectmodelwithrefpropsRequestBody {
    ...
    public static class FakerefsobjectmodelwithrefpropsRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakerefsobjectmodelwithrefpropsRequestBody1() {
            super(
                Map.ofEntries(
