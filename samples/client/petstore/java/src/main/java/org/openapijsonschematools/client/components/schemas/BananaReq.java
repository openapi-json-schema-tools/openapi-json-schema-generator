...
public class BananaReq {
    ...
    public static class BananaReqMap extends FrozenMap<String, Object> {
        ...
        public static BananaReqMap of(Map<String, Object> arg, SchemaConfiguration configuration) throws ValidationException {
            return JsonSchemaFactory.getInstance(BananaReq1.class).validate(arg, configuration);
        }
    ...
    public static class BananaReq1 extends JsonSchema<Object, BananaReqMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected BananaReqMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new BananaReqMap((FrozenMap<String, Object>) arg);
        }
