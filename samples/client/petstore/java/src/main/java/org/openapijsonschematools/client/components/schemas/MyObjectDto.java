...
public class MyObjectDto {
    ...
    public static class MyObjectDto1 extends JsonSchema<String, MyObjectDtoMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected MyObjectDtoMap getMapOutputInstance(FrozenMap<String, ?> arg) {
