...
public class NumberWithExclusiveMinMax {
    ...
    public static class NumberWithExclusiveMinMax1 extends JsonSchema<NumberWithExclusiveMinMax1Boxed> implements NumberSchemaValidator<NumberWithExclusiveMinMax1BoxedNumber> {
        ...
        */
        ...
        @Override
        public NumberWithExclusiveMinMax1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException, InvalidTypeException {
