...
public class Schema {
    ...
    public static class Schema1 extends JsonSchema<String, String, SchemaMap, Object, Object, FrozenList<Object>> {
        public Schema1() {
        ...
        @Override
        protected SchemaMap getMapOutputInstance(FrozenMap<String, String> arg) {
