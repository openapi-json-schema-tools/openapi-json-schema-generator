...
public class FakemultiplerequestbodycontenttypesRequestBody {
    ...
    public static class FakemultiplerequestbodycontenttypesRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakemultiplerequestbodycontenttypesRequestBody1() {
            super(
                Map.ofEntries(
