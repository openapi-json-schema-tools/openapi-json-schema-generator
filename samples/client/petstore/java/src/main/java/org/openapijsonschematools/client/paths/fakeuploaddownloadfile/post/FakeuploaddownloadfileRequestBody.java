...
public class FakeuploaddownloadfileRequestBody {
    ...
    public static class FakeuploaddownloadfileRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakeuploaddownloadfileRequestBody1() {
            super(
                Map.ofEntries(
