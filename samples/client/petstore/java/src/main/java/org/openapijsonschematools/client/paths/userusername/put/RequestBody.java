...
public class RequestBody {
    ...
    public static final class ApplicationjsonRequestBody extends SealedRequestBody implements GenericRequestBody<ApplicationjsonSchema.User1Boxed> {
        private final String contentType;
        private final ApplicationjsonSchema.User1Boxed body;
        public ApplicationjsonRequestBody(ApplicationjsonSchema.User1Boxed body) {
