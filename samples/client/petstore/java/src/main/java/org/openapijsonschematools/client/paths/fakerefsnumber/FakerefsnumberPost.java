...
public class FakerefsnumberPost {
    private static class FakerefsnumberPostProvider {
        private static final String method = "post";

        public static Responses.EndpointResponse post(
            FakerefsnumberPostRequest request,
    ...
    public interface FakerefsnumberPostOperation {
        ApiConfiguration getApiConfiguration();
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default Responses.EndpointResponse post(FakerefsnumberPostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
    ...
    public static class FakerefsnumberPost1 extends ApiClient implements FakerefsnumberPostOperation {
        public FakerefsnumberPost1(ApiConfiguration apiConfiguration, SchemaConfiguration schemaConfiguration) {
            super(apiConfiguration, schemaConfiguration);
        }
    }

    public static class FakerefsnumberPostRequest {
