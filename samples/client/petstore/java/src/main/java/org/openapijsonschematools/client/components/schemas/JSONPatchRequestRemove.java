...
public class JSONPatchRequestRemove {
    ...
    public static class JSONPatchRequestRemove1 extends JsonSchema<String, JSONPatchRequestRemoveMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected JSONPatchRequestRemoveMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new JSONPatchRequestRemoveMap((FrozenMap<String, String>) arg);
        }
