...
public class JSONPatchRequestRemove {
    ...
    public static class JSONPatchRequestRemove1 extends JsonSchema<JSONPatchRequestRemoveMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected JSONPatchRequestRemoveMap getMapOutputInstance(FrozenMap<?, ?> arg) {
