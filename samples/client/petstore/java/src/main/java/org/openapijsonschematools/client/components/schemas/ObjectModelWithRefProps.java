...
public class ObjectModelWithRefProps {
    ...
    public static class ObjectModelWithRefProps1 extends JsonSchema<Object, ObjectModelWithRefPropsMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectModelWithRefPropsMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new ObjectModelWithRefPropsMap((FrozenMap<String, Object>) arg);
        }
