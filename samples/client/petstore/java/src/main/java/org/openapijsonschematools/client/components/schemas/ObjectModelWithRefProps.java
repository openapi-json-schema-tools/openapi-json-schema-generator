...
public class ObjectModelWithRefProps {
    ...
    public static class ObjectModelWithRefProps1 extends JsonSchema<ObjectModelWithRefPropsMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectModelWithRefPropsMap getMapOutputInstance(FrozenMap<?, ?> arg) {
