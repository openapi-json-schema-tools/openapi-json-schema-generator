...
public class JSONPatchRequestAddReplaceTest {
    ...
    public static class JSONPatchRequestAddReplaceTest1 extends JsonSchema<JSONPatchRequestAddReplaceTestMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected JSONPatchRequestAddReplaceTestMap getMapOutputInstance(FrozenMap<?, ?> arg) {
