...
import org.openapijsonschematools.client.paths.userusername.put.requestbody.content.applicationjson.ApplicationjsonSchema;
...
public class UserusernamePutRequestBody {
    ...
    public static class UserusernamePutRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public UserusernamePutRequestBody1() {
            super(
                Map.ofEntries(
