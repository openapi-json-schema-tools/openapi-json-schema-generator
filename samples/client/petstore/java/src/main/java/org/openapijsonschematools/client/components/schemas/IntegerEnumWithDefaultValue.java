...
public class IntegerEnumWithDefaultValue {
    ...
    public static class IntegerEnumWithDefaultValue1 extends JsonSchema<IntegerEnumWithDefaultValue1Boxed> implements IntegerEnumValidator<IntegerIntegerEnumWithDefaultValueEnums>, LongEnumValidator<LongIntegerEnumWithDefaultValueEnums>, FloatEnumValidator<FloatIntegerEnumWithDefaultValueEnums>, DoubleEnumValidator<DoubleIntegerEnumWithDefaultValueEnums>, NumberSchemaValidator<IntegerEnumWithDefaultValue1BoxedNumber> {
        /*
        ...
        */
        ...
        @Override
        public IntegerEnumWithDefaultValue1BoxedNumber validateAndBox(Number arg, SchemaConfiguration configuration) throws ValidationException {
            return new IntegerEnumWithDefaultValue1BoxedNumber(validate(arg, configuration));
        }
        @Override
        public IntegerEnumWithDefaultValue1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException {
