...
public class RequestBody extends RequestBodySerializer {
    ...
    public static final class RequestBodyApplicationjsonRequestBody extends RequestBodyRequestBody implements RequestBody<ApplicationjsonSchema.StringSchema1Boxed> {
        private final String contentType;
        private final ApplicationjsonSchema.StringSchema1Boxed body;
        public RequestBodyApplicationjsonRequestBody(ApplicationjsonSchema.StringSchema1Boxed body) {
        ...
        @Override
        public ApplicationjsonSchema.StringSchema1Boxed body() {
            return body;
        }
    }
}
