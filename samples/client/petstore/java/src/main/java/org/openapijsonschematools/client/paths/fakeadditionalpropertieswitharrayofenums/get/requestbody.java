...
public class RequestBody extends RequestBodySerializer {
    ...
    public static final class RequestBodyApplicationjsonRequestBody extends RequestBodyRequestBody implements RequestBody<ApplicationjsonSchema.AdditionalPropertiesWithArrayOfEnums1Boxed> {
        private final String contentType;
        private final ApplicationjsonSchema.AdditionalPropertiesWithArrayOfEnums1Boxed body;
        public RequestBodyApplicationjsonRequestBody(ApplicationjsonSchema.AdditionalPropertiesWithArrayOfEnums1Boxed body) {
        ...
        @Override
        public ApplicationjsonSchema.AdditionalPropertiesWithArrayOfEnums1Boxed body() {
            return body;
        }
    }
}
