...
public class ReqPropsFromTrueAddProps {
    ...
    public static class ReqPropsFromTrueAddPropsMap extends FrozenMap<String, Object> {
        ...
        public static ReqPropsFromTrueAddPropsMap of(Map<String, Object> arg, SchemaConfiguration configuration) throws ValidationException {
            return JsonSchemaFactory.getInstance(ReqPropsFromTrueAddProps1.class).validate(arg, configuration);
        }
    ...
    public static class ReqPropsFromTrueAddProps1 extends JsonSchema<Object, ReqPropsFromTrueAddPropsMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected ReqPropsFromTrueAddPropsMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new ReqPropsFromTrueAddPropsMap((FrozenMap<String, Object>) arg);
        }
        public ReqPropsFromTrueAddPropsMap validate(Map<String, Object> arg, SchemaConfiguration configuration) throws ValidationException {
