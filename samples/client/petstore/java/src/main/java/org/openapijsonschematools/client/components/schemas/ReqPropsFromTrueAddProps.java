...
public class ReqPropsFromTrueAddProps {
    ...
    public static class ReqPropsFromTrueAddProps1 extends JsonSchema<ReqPropsFromTrueAddPropsMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected ReqPropsFromTrueAddPropsMap getMapOutputInstance(FrozenMap<?, ?> arg) {
