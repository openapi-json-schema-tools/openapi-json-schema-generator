...
public class DateTimeWithValidations {
    ...
    public record DateTimeWithValidations2(LinkedHashSet<Class<?>> type, String format) implements JsonSchema {
        /*
        ...
        */
        public static DateTimeWithValidations2 withDefaults() {
            LinkedHashSet<Class<?>> type = new LinkedHashSet<>();
            type.add(String.class);
            String format = "date-time";
            return new DateTimeWithValidations2(type, format);
        }
        public static String validate(String arg, SchemaConfiguration configuration) {
            return JsonSchema.validate(DateTimeWithValidations2.class, arg, configuration);
        }
    }}
