...
public class FakebodywithqueryparamsRequestBody {
    ...
    public static class FakebodywithqueryparamsRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakebodywithqueryparamsRequestBody1() {
            super(
                Map.ofEntries(
