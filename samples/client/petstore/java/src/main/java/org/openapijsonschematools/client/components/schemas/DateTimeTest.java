...
public class DateTimeTest {
    ...
    public static class DateTimeTest1 extends JsonSchema<DateTimeTest1Boxed> implements StringSchemaValidator<DateTimeTest1BoxedString>, DefaultValueMethod<String> {
        ...
        */
        ...
        @Override
        public DateTimeTest1BoxedString validateAndBox(String arg, SchemaConfiguration configuration) throws ValidationException {
            return new DateTimeTest1BoxedString(validate(arg, configuration));
        }
        @Override
        public DateTimeTest1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException {
