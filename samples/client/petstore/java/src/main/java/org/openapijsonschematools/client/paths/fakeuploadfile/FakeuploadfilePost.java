...
public class FakeuploadfilePost {
    private static class PostProvider {
        ...
        public static FakeuploadfilePostResponses.EndpointResponse post(
            PostRequest request,
            ...
            var responsesDeserializer = new FakeuploadfilePostResponses.FakeuploadfilePostResponses1();
    ...
    public interface PostOperation {
        ...
        default FakeuploadfilePostResponses.EndpointResponse post(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
    ...
    public interface UploadFileOperation {
        ...
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default FakeuploadfilePostResponses.EndpointResponse uploadFile(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return PostProvider.post(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }
