...
public class RequestBody {
    ...
    public static final class ApplicationjsonRequestBody extends SealedRequestBody implements GenericRequestBody<ApplicationjsonSchema.ArrayOfEnums1Boxed> {
        private final String contentType;
        private final ApplicationjsonSchema.ArrayOfEnums1Boxed body;
        public ApplicationjsonRequestBody(ApplicationjsonSchema.ArrayOfEnums1Boxed body) {
