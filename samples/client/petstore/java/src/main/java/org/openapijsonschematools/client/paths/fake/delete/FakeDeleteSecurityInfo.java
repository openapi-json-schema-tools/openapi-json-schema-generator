...
public class FakeDeleteSecurityInfo implements SecurityRequirementObjectProvider<FakeDeleteSecurityInfo.SecurityIndex> {
    ...
    public static class SecuritiesBuilder implements SetterForFakeDeleteSecurityRequirementObject0<Securities0Builder> {
        private final Map<SecurityIndex, SecurityRequirementObject> instance;
        ...
        public Securities0Builder getBuilderAfterFakeDeleteSecurityRequirementObject0(Map<SecurityIndex, SecurityRequirementObject> instance) {
