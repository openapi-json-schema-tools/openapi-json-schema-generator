...
public class Code200Response {
    ...
    public static class Code200Response1 extends ResponseDeserializer<SealedResponseBody, Code200ResponseHeadersSchema.Code200ResponseHeadersSchemaMap, SealedMediaType> {
        ...
        @Override
        protected Code200ResponseHeadersSchema.Code200ResponseHeadersSchemaMap getHeaders(HttpHeaders headers, SchemaConfiguration configuration) throws ValidationException, NotImplementedException {
