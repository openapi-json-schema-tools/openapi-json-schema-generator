...
public class FakerefsstringPost {
    private static class PostProvider {
        ...
        public static FakerefsstringPostResponses.EndpointResponse post(
            PostRequest request,
            ...
            var responsesDeserializer = new FakerefsstringPostResponses.FakerefsstringPostResponses1();
    ...
    public interface PostOperation {
        ...
        default FakerefsstringPostResponses.EndpointResponse post(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
