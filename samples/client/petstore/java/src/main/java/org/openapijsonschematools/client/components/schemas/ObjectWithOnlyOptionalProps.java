...
public class ObjectWithOnlyOptionalProps {
    ...
    public static class ObjectWithOnlyOptionalProps1 extends JsonSchema<Object, ObjectWithOnlyOptionalPropsMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectWithOnlyOptionalPropsMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new ObjectWithOnlyOptionalPropsMap((FrozenMap<String, Object>) arg);
        }
