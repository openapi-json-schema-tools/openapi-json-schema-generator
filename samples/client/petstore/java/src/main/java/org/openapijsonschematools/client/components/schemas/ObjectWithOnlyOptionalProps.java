...
public class ObjectWithOnlyOptionalProps {
    ...
    public static class ObjectWithOnlyOptionalProps1 extends JsonSchema<ObjectWithOnlyOptionalPropsMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectWithOnlyOptionalPropsMap getMapOutputInstance(FrozenMap<?, ?> arg) {
