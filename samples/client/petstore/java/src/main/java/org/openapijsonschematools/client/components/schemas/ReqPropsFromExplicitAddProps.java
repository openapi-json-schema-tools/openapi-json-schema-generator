...
public class ReqPropsFromExplicitAddProps {
    ...
    public static class ReqPropsFromExplicitAddProps1 extends JsonSchema<String, ReqPropsFromExplicitAddPropsMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected ReqPropsFromExplicitAddPropsMap getMapOutputInstance(FrozenMap<String, ?> arg) {
