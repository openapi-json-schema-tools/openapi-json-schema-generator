...
public class ObjectWithOptionalTestProp {
    ...
    public static class ObjectWithOptionalTestProp1 extends JsonSchema<ObjectWithOptionalTestPropMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectWithOptionalTestPropMap getMapOutputInstance(FrozenMap<?, ?> arg) {
