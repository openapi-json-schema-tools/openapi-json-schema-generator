...
public class ObjectWithOptionalTestProp {
    ...
    public static class ObjectWithOptionalTestPropMap extends FrozenMap<String, Object> {
        ...
        public static ObjectWithOptionalTestPropMap of(Map<String, Object> arg, SchemaConfiguration configuration) throws ValidationException {
            return JsonSchemaFactory.getInstance(ObjectWithOptionalTestProp1.class).validate(arg, configuration);
        }
    ...
    public static class ObjectWithOptionalTestProp1 extends JsonSchema<Object, ObjectWithOptionalTestPropMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected ObjectWithOptionalTestPropMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new ObjectWithOptionalTestPropMap((FrozenMap<String, Object>) arg);
        }
