...
public class IntegerEnumBig {
    ...
    public static class IntegerEnumBig1 extends JsonSchema<IntegerEnumBig1Boxed> implements IntegerEnumValidator<IntegerIntegerEnumBigEnums>, LongEnumValidator<LongIntegerEnumBigEnums>, FloatEnumValidator<FloatIntegerEnumBigEnums>, DoubleEnumValidator<DoubleIntegerEnumBigEnums>, NumberSchemaValidator<IntegerEnumBig1BoxedNumber> {
        ...
        */
        ...
        @Override
        public int validate(IntegerIntegerEnumBigEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
            return (int) validate((Number) arg.value(), configuration);
        }
        
        @Override
        public long validate(LongIntegerEnumBigEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
            return (long) validate((Number) arg.value(), configuration);
        }
        
        @Override
        public float validate(FloatIntegerEnumBigEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
            return (float) validate((Number) arg.value(), configuration);
        }
        
        @Override
        public double validate(DoubleIntegerEnumBigEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
        ...
        @Override
        public IntegerEnumBig1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException, InvalidTypeException {
