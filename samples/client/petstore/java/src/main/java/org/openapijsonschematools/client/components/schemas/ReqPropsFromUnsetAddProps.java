...
public class ReqPropsFromUnsetAddProps {
    ...
    public static class ReqPropsFromUnsetAddProps1 extends JsonSchema<ReqPropsFromUnsetAddPropsMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected ReqPropsFromUnsetAddPropsMap getMapOutputInstance(FrozenMap<?, ?> arg) {
