...
public class ReqPropsFromUnsetAddProps {
    ...
    public static class ReqPropsFromUnsetAddPropsMap extends FrozenMap<String, Object> {
        ...
        public static ReqPropsFromUnsetAddPropsMap of(Map<String, Object> arg, SchemaConfiguration configuration) throws ValidationException {
            return JsonSchemaFactory.getInstance(ReqPropsFromUnsetAddProps1.class).validate(arg, configuration);
        }
    ...
    public static class ReqPropsFromUnsetAddProps1 extends JsonSchema<Object, ReqPropsFromUnsetAddPropsMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected ReqPropsFromUnsetAddPropsMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new ReqPropsFromUnsetAddPropsMap((FrozenMap<String, Object>) arg);
        }
