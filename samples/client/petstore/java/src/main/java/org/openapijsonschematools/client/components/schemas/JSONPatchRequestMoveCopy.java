...
public class JSONPatchRequestMoveCopy {
    ...
    public static class JSONPatchRequestMoveCopy1 extends JsonSchema<String, JSONPatchRequestMoveCopyMap, Object, FrozenList<Object>> {
        /*
        ...
        */
        ...
        @Override
        protected JSONPatchRequestMoveCopyMap getMapOutputInstance(FrozenMap<String, ?> arg) {
            return new JSONPatchRequestMoveCopyMap((FrozenMap<String, String>) arg);
        }
