...
public class JSONPatchRequestMoveCopy {
    ...
    public static class JSONPatchRequestMoveCopy1 extends JsonSchema<JSONPatchRequestMoveCopyMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected JSONPatchRequestMoveCopyMap getMapOutputInstance(FrozenMap<?, ?> arg) {
