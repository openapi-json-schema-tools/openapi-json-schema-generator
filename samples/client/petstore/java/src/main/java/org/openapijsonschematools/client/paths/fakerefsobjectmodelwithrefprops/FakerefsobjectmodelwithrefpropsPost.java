...
public class FakerefsobjectmodelwithrefpropsPost {
    private static class PostProvider {
        ...
        public static FakerefsobjectmodelwithrefpropsPostResponses.EndpointResponse post(
            PostRequest request,
            ...
            var responsesDeserializer = new FakerefsobjectmodelwithrefpropsPostResponses.FakerefsobjectmodelwithrefpropsPostResponses1();
    ...
    public interface PostOperation {
        ...
        default FakerefsobjectmodelwithrefpropsPostResponses.EndpointResponse post(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
    ...
    public interface ObjectModelWithRefPropsOperation {
        ...
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default FakerefsobjectmodelwithrefpropsPostResponses.EndpointResponse objectModelWithRefProps(PostRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return PostProvider.post(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }
