...
public class EnumClass {
    ...
    public static class EnumClass1 extends JsonSchema<EnumClass1Boxed> implements StringSchemaValidator<EnumClass1BoxedString>, StringEnumValidator<StringEnumClassEnums>, DefaultValueMethod<String> {
        /*
        ...
        */
        private static @Nullable EnumClass1 instance = null;
        ...
        @Override
        public String validate(StringEnumClassEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
        ...
        @Override
        public EnumClass1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException, InvalidTypeException {
