...
public class FakepetiduploadimagewithrequiredfileRequestBody {
    ...
    public static class FakepetiduploadimagewithrequiredfileRequestBody1 extends RequestBodySerializer<SealedRequestBody, SealedMediaType> {
        public FakepetiduploadimagewithrequiredfileRequestBody1() {
            super(
                Map.ofEntries(
