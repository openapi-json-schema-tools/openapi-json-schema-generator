...
public class RequestBody extends RequestBodySerializer {
    ...
    public static final class RequestBodyApplicationjsonRequestBody extends RequestBodyRequestBody implements RequestBody<ApplicationjsonSchema.ObjectModelWithRefProps1Boxed> {
        private final String contentType;
        private final ApplicationjsonSchema.ObjectModelWithRefProps1Boxed body;
        public RequestBodyApplicationjsonRequestBody(ApplicationjsonSchema.ObjectModelWithRefProps1Boxed body) {
