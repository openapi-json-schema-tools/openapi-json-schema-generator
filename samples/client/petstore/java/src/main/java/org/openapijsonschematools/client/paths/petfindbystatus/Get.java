...
public class Get {
    public static class GetCallData {
        public @Nullable PetfindbystatusServerInfo.ServerIndex petfindbystatusServerInfo;
        public @Nullable PetfindbystatusGetSecurityInfo.SecurityIndex petfindbystatusGetSecurityInfo;
