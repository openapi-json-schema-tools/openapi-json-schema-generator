...
| sealed interface | [Schema1.SomeProp1Boxed](#someprop1boxed)<br> abstract sealed validated payload class |
...
| sealed interface | [Schema1.Schema01Boxed](#schema01boxed)<br> abstract sealed validated payload class |
