...
// String validation
StringSchema1BoxedString requestBodyPayload = StringSchema.StringSchema1.validateAndBox(
    "a",
    schemaConfiguration
);
...
| ----------------- | --------------------- |
| [RequestBody.@Nullable SealedRequestBody](../../paths/fakerefsstring/post/RequestBody.md#sealedrequestbody) | requestBody<br>optional |
