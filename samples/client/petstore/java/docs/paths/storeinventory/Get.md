...
| StoreinventoryGetSecurityInfo.@Nullable SecurityIndex | securityIndex |
...
| [GetRequestBuilder](#getrequestbuilder) | securityIndex(StoreinventoryGetSecurityInfo.SecurityIndex securityIndex)<br>sets the property |
