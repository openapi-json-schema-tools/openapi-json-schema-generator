...
FakeuploadfilesPost.Post apiClient = new FakeuploadfilesPost.Post(apiConfiguration, schemaConfiguration);
...
| ----------------- | ---------------------- |
| [Responses.EndpointResponse](../../paths/fakeuploadfiles/post/Responses.md#endpointresponse) | post([PostRequest](#postrequest) request) |
...
| ----------------- | --------------------- |
| [FakeuploadfilesPostRequestBody.@Nullable SealedRequestBody](../../paths/fakeuploadfiles/post/FakeuploadfilesPostRequestBody.md#sealedrequestbody) | requestBody<br>optional |
...
| [PostRequestBuilder](#postrequestbuilder) | requestBody([FakeuploadfilesPostRequestBody.SealedRequestBody](../../paths/fakeuploadfiles/post/FakeuploadfilesPostRequestBody.md#sealedrequestbody) requestBody)<br>sets the optional property |
