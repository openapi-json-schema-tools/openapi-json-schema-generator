...
| ----------------- | ---------------------- |
| [Responses.EndpointResponse](../../paths/fakerefsboolean/post/Responses.md#endpointresponse) | post([PostRequest](#postrequest) request) |
...
| ----------------- | --------------------- |
| [FakerefsbooleanPostRequestBody.@Nullable SealedRequestBody](../../paths/fakerefsboolean/post/FakerefsbooleanPostRequestBody.md#sealedrequestbody) | requestBody<br>optional |
...
| [PostRequestBuilder](#postrequestbuilder) | requestBody([FakerefsbooleanPostRequestBody.SealedRequestBody](../../paths/fakerefsboolean/post/FakerefsbooleanPostRequestBody.md#sealedrequestbody) requestBody)<br>sets the optional property |
