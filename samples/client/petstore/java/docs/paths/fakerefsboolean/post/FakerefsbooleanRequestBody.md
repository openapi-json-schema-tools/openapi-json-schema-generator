...
| ----------------- | --------------------- |
| sealed interface | [FakerefsbooleanRequestBody.SealedMediaType](#sealedmediatype)<br>media type sealed interface |
| record | [FakerefsbooleanRequestBody.ApplicationjsonMediaType](#applicationjsonmediatype)<br>record storing schema + encoding for a specific contentType |
| static class | [FakerefsbooleanRequestBody.FakerefsbooleanRequestBody1](#fakerefsbooleanrequestbody1)<br>class that serializes request bodies |
| sealed interface | [FakerefsbooleanRequestBody.SealedRequestBody](#sealedrequestbody)<br>request body sealed interface |
| record | [FakerefsbooleanRequestBody.ApplicationjsonRequestBody](#applicationjsonrequestbody)<br>implements sealed interface to store request body input |
...
implements [SealedMediaType](#sealedmediatype), MediaType<[ApplicationjsonSchema.ApplicationjsonSchema1](../../../paths/fakerefsboolean/post/requestbody/content/applicationjson/ApplicationjsonSchema.md#applicationjsonschema1), Void>
...
## FakerefsbooleanRequestBody1
public static class FakerefsbooleanRequestBody1<br>
...
| Constructor and Description |
| --------------------------- |
| FakerefsbooleanRequestBody1()<br>Creates an instance |
