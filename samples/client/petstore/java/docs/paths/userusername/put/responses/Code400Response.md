...
| ----------------- | --------------------- |
| static class | [Code400Response.Code400Response1](#code400response1)<br>class that deserializes responses |

## Code400Response1
public static class Code400Response1<br>
...
| --------------------------- |
| Code400Response1()<br>Creates an instance |
