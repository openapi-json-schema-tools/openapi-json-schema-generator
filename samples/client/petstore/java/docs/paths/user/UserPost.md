...
| interface | [CreateUserOperation](#createuseroperation)<br>The interface that has a createUser method to call the endpoint |
...
## CreateUserOperation
public interface CreateUserOperation<br>
...
| Modifier and Type | Method and Description |
| ----------------- | ---------------------- |
| [UserPostResponses.EndpointResponse](../../paths/user/post/UserPostResponses.md#endpointresponse) | createUser([PostRequest](#postrequest) request) |
...
| ----------------- | --------------------- |
| [UserPostRequestBody.SealedRequestBody](../../paths/user/post/UserPostRequestBody.md#sealedrequestbody) | requestBody |
...
| Modifier and Type | Field and Description |
| ----------------- | --------------------- |
| [UserPostRequestBody.@Nullable SealedRequestBody](../../paths/user/post/UserPostRequestBody.md#sealedrequestbody) | requestBody |
...
| Modifier and Type | Method and Description |
| ----------------- | ---------------------- |
| [Post0RequestBuilder](#post0requestbuilder) | requestBody([UserPostRequestBody.SealedRequestBody](../../paths/user/post/UserPostRequestBody.md#sealedrequestbody) requestBody)<br>sets the property |
