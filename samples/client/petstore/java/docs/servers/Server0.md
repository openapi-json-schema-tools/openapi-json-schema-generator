...
| sealed interface | [Variables.PortBoxed](#portboxed)<br> abstract sealed validated payload class |
...
| sealed interface | [Variables.ServerBoxed](#serverboxed)<br> abstract sealed validated payload class |
