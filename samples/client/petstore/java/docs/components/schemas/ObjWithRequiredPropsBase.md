...
| ----------------- | ---------------------- |
| static [ObjWithRequiredPropsBaseMap](#objwithrequiredpropsbasemap) | validate([Map<String, ?>](#objwithrequiredpropsbasemapinput) arg, SchemaConfiguration configuration) |
