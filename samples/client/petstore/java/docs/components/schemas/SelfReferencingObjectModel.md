...
| ----------------- | ---------------------- |
| static [SelfReferencingObjectModelMap](#selfreferencingobjectmodelmap) | validate([Map<String, ?>](#selfreferencingobjectmodelmapinput) arg, SchemaConfiguration configuration) |
