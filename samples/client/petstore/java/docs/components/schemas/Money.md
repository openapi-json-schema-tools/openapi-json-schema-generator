...
| --------------------------- |
| Money1BoxedMap(MoneyMap data)<br>Creates an instance, private visibility |

### Field Summary
| Modifier and Type | Field and Description |
| ----------------- | ---------------------- |
| MoneyMap | data<br>validated payload |
...
| [Money1BoxedMap](#money1boxedmap) | validateAndBox([MoneyMap](#moneymap) arg, SchemaConfiguration configuration) |
