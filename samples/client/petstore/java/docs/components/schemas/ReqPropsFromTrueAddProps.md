...
extends ReqPropsFromTrueAddProps1Boxed
...
| --------------------------- |
| ReqPropsFromTrueAddProps1BoxedMap(ReqPropsFromTrueAddPropsMap data)<br>Creates an instance, private visibility |

### Field Summary
| Modifier and Type | Field and Description |
| ----------------- | ---------------------- |
| ReqPropsFromTrueAddPropsMap | data<br>validated payload |
