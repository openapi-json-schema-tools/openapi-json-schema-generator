...
| [NoAdditionalProperties1BoxedMap](#noadditionalproperties1boxedmap) | validateAndBox([NoAdditionalPropertiesMap](#noadditionalpropertiesmap) arg, SchemaConfiguration configuration) |
