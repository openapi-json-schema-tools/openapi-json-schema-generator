...
| enum | [IntegerEnumWithDefaultValue.IntegerIntegerEnumWithDefaultValueEnums]()<br>integer enum |
| enum | [IntegerEnumWithDefaultValue.NumberIntegerEnumWithDefaultValueEnums]()<br>number enum |
