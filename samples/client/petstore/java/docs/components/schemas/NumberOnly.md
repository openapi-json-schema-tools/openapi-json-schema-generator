...
| --------------------------- |
| NumberOnly1BoxedMap(NumberOnlyMap data)<br>Creates an instance, private visibility |

### Field Summary
| Modifier and Type | Field and Description |
| ----------------- | ---------------------- |
| NumberOnlyMap | data<br>validated payload |
...
| [NumberOnly1BoxedMap](#numberonly1boxedmap) | validateAndBox([NumberOnlyMap](#numberonlymap) arg, SchemaConfiguration configuration) |
