...
| ----------------- | ---------------------- |
| static [ObjectWithOnlyOptionalPropsMap](#objectwithonlyoptionalpropsmap) | validate([Map<String, ?>](#objectwithonlyoptionalpropsmapinput) arg, SchemaConfiguration configuration) |
