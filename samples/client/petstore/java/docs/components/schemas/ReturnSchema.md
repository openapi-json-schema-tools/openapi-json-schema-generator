...
------ | ---------- | ----------- | ------
of | Map<String, Object> | ReturnMap | a constructor
get | String | Object | This model has invalid python names so this method is used under the hood when you access instance["return"], 
