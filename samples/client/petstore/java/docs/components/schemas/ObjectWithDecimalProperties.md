...
| ----------------- | ---------------------- |
| static LinkedHashMap<String, KeywordValidator> | keywordToValidator<br/><code>new LinkedHashMap<>(Map.ofEntries(<br/>new KeywordEntry("type", new TypeValidator(Set.of(FrozenMap.class))),<br>new KeywordEntry("properties", new PropertiesValidator(Map.ofEntries(<br>&nbsp;&nbsp;&nbsp;&nbsp;new PropertyEntry("length", DecimalPayload.DecimalPayload1.class),<br>&nbsp;&nbsp;&nbsp;&nbsp;new PropertyEntry("width", Width.class),<br>&nbsp;&nbsp;&nbsp;&nbsp;new PropertyEntry("cost", Money.Money1.class)<br>)))<br>));</code> |
