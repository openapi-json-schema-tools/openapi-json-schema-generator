...
| ----------------- | ---------------------- |
| sealed interface | [SimpleQuadrilateral.SimpleQuadrilateral1Boxed](#simplequadrilateral1boxed)<br> abstract sealed validated payload class |
...
| sealed interface | [SimpleQuadrilateral.Schema1Boxed](#schema1boxed)<br> abstract sealed validated payload class |
...
| sealed interface | [SimpleQuadrilateral.QuadrilateralTypeBoxed](#quadrilateraltypeboxed)<br> abstract sealed validated payload class |
