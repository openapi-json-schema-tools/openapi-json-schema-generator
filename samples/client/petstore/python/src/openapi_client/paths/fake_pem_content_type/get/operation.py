...
from openapi_client.paths.fake_pem_content_type.get.request_body.content.application_x_pem_file import schema
...
class PemContentType(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    pem_content_type = BaseApi._pem_content_type


class ApiForGet(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    get = BaseApi._pem_content_type
