...
from openapi_client.paths.common_param_sub_dir.delete.parameters.parameter_1 import schema
...
class PathParametersDict(schemas.immutabledict[str, typing.Literal["c", "d"]]):
    ...
    @property
    def subDir(self) -> typing.Literal["c", "d"]:
