...
from openapi_client.components.schema import equilateral_triangle
from openapi_client.components.schema import isosceles_triangle
from openapi_client.components.schema import scalene_triangle
OneOf = typing.Tuple[
