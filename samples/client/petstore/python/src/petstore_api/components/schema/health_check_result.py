...
class HealthCheckResultDict(schemas.immutabledict[str, typing.Union[
    ...
    def __new__(
        ...
        NullableMessage: typing.Union[
            NullableMessage: typing.Union[None, schemas.Unset] = schemas.unset,
            NullableMessage: typing.Union[str, schemas.Unset] = schemas.unset,
        ],
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        for key, val in (
            ...
            arg_[key] = val
        arg_.update(kwargs)
        return HealthCheckResult.validate(arg_, configuration=configuration_)
