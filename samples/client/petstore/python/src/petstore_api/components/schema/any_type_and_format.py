...
class AnyTypeAndFormatDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        cls,
        uuid: typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset] = schemas.unset,
        date: typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset] = schemas.unset,
        number: typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset] = schemas.unset,
        binary: typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset] = schemas.unset,
        int32: typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset] = schemas.unset,
        int64: typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset] = schemas.unset,
        double: typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset] = schemas.unset,
