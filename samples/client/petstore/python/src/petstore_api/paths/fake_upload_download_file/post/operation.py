...
from petstore_api.paths.fake_upload_download_file.post.request_body.content.application_octet_stream import schema
    ...
    def _upload_download_file(
        ...
        *,
        ...
        host = self.api_client.configuration.get_server_url(
            "paths//fake/uploadDownloadFile/post/servers", server_index
        )
