...
**snake_case** | int | int, schemas.Unset |  | [optional] value must be a 32 bit integer
**property** | str | str, schemas.Unset | this is a reserved python keyword | [optional] value must be accessed with instance["property"] because the key is not a valid identifier 
