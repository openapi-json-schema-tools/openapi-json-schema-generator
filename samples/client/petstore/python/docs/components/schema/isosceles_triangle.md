...
------------ | ------------- | ------------- | -------------
**triangleType** | typing.Literal["IsoscelesTriangle"] |  | [optional] must be one of ["IsoscelesTriangle"]
...
---------------- | ---- | ----------- | -----
**triangleType** | typing.Literal["IsoscelesTriangle"], schemas.Unset |  | [optional] must be one of ["IsoscelesTriangle"]
