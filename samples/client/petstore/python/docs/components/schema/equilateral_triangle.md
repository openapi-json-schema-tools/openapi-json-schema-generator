...
------------ | ------------- | ------------- | -------------
**triangleType** | typing_extensions.Literal["EquilateralTriangle"] |  | [optional] must be one of ["EquilateralTriangle"]
...
---------------- | ---- | ----------- | -----
**triangleType** | typing_extensions.Literal["EquilateralTriangle"], schemas.Unset |  | [optional] must be one of ["EquilateralTriangle"]
