...
------------ | ------------- | ------------- | -------------
**quadrilateralType** | typing_extensions.Literal["SimpleQuadrilateral"] |  | [optional] must be one of ["SimpleQuadrilateral"]
...
---------------- | ---- | ----------- | -----
**quadrilateralType** | typing_extensions.Literal["SimpleQuadrilateral"], schemas.Unset |  | [optional] must be one of ["SimpleQuadrilateral"]
