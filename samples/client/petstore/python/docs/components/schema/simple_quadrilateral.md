# SimpleQuadrilateral
openapi_client.components.schema.simple_quadrilateral
```
type: schemas.Schema
```
...
------------ | ------------- | ------------- | -------------
**quadrilateralType** | typing.Literal["SimpleQuadrilateral"] |  | [optional] must be one of ["SimpleQuadrilateral"]
...
---------------- | ---- | ----------- | -----
**quadrilateralType** | typing.Literal["SimpleQuadrilateral"], schemas.Unset |  | [optional] must be one of ["SimpleQuadrilateral"]
