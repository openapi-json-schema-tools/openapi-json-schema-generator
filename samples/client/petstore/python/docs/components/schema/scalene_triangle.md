...
------------ | ------------- | ------------- | -------------
**triangleType** | typing_extensions.Literal["ScaleneTriangle"] |  | [optional] must be one of ["ScaleneTriangle"]
...
---------------- | ---- | ----------- | -----
**triangleType** | typing_extensions.Literal["ScaleneTriangle"], schemas.Unset |  | [optional] must be one of ["ScaleneTriangle"]
