...
**quantity** | int | int, schemas.Unset |  | [optional] value must be a 32 bit integer
**shipDate** | str, datetime.datetime | str, schemas.Unset |  | [optional] value must conform to RFC-3339 date-time
**status** | str | str, schemas.Unset | Order Status | [optional] must be one of ["placed", "approved", "delivered"]
**complete** | bool | bool, schemas.Unset |  | [optional] if omitted the server will use the default value of false
