...
### Body Details
petstore_api.paths.foo.get.responses.response_default.content.application_json
...
---------------- | ---- | ----------- | -----
**string** | [**Foo**](../../components/schema/foo.md), dict, schemas.immutabledict, schemas.Unset |  | [optional]
