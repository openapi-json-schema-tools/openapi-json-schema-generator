...
| ----------- | --------- | ----- |
| post_common_param | [FakeApi](../../apis/tags/fake_api.md) | This api is only for tag=fake |
| post | ApiForPost | This api is only for this endpoint |
| post | CommonParamSubDir | This api is only for path=/commonParam/{subDir}/ |
...
### header_params
### HeaderParameters
petstore_api.paths.common_param_sub_dir.post.header_parameters
```
type: schemas.Schema
```
...
### path_params
### PathParameters
petstore_api.paths.common_param_sub_dir.post.path_parameters
```
type: schemas.Schema
```
...
from petstore_api.paths.common_param_sub_dir.post import operation
