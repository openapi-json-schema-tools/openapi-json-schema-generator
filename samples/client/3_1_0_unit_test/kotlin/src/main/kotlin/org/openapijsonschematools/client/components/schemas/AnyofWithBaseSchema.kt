...
class AnyofWithBaseSchema {
    ...
    data class AnyofWithBaseSchema1BoxedString(val data: String) : AnyofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AnyofWithBaseSchema1 private constructor(): JsonSchema<AnyofWithBaseSchema1Boxed>(
        JsonSchemaInfo()
            .type(setOf(
                String::class.java
            ))
    ...
    ), StringSchemaValidator<AnyofWithBaseSchema1BoxedString> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AnyofWithBaseSchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AnyofWithBaseSchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AnyofWithBaseSchema1BoxedString {
            return AnyofWithBaseSchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AnyofWithBaseSchema1Boxed {
            if (arg is String) {
                return validateAndBox(arg, configuration)
            }
            throw ValidationException("Invalid input type="+getClass(arg)+". It can't be validated by this schema")
