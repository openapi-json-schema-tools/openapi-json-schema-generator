...
class MaximumValidation {
    ...
    data class MaximumValidation1BoxedVoid(val data: Nothing?) : MaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidation1BoxedBoolean(val data: Boolean): MaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidation1BoxedNumber(val data: Number) : MaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidation1BoxedString(val data: String) : MaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidation1BoxedList(val data: FrozenList<Any?>) : MaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidation1BoxedMap(val data: FrozenMap<Any?>) : MaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MaximumValidation1 private constructor(): JsonSchema<MaximumValidation1Boxed>(
        JsonSchemaInfo(
            maximum = 3.0,
        )
    ), NullSchemaValidator<MaximumValidation1BoxedVoid>, BooleanSchemaValidator<MaximumValidation1BoxedBoolean>, NumberSchemaValidator<MaximumValidation1BoxedNumber>, StringSchemaValidator<MaximumValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MaximumValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MaximumValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MaximumValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MaximumValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MaximumValidation1BoxedVoid {
            return MaximumValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MaximumValidation1BoxedBoolean {
            return MaximumValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MaximumValidation1BoxedNumber {
            return MaximumValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MaximumValidation1BoxedString {
            return MaximumValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MaximumValidation1BoxedList {
            return MaximumValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MaximumValidation1BoxedMap {
            return MaximumValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MaximumValidation1Boxed {
            if (arg == null) {
