...
class DurationFormat {
    ...
    sealed interface DurationFormat1Boxed {
        fun getData(): Any?
    }
    
    data class DurationFormat1BoxedVoid(val data: Nothing?) : DurationFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DurationFormat1BoxedBoolean(val data: Boolean): DurationFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DurationFormat1BoxedNumber(val data: Number) : DurationFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DurationFormat1BoxedString(val data: String) : DurationFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DurationFormat1BoxedList(val data: FrozenList<Any?>) : DurationFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DurationFormat1BoxedMap(val data: FrozenMap<Any?>) : DurationFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class DurationFormat1 private constructor(): JsonSchema<DurationFormat1Boxed>(
        JsonSchemaInfo()
            .format("duration")
    ), NullSchemaValidator<DurationFormat1BoxedVoid>, BooleanSchemaValidator<DurationFormat1BoxedBoolean>, NumberSchemaValidator<DurationFormat1BoxedNumber>, StringSchemaValidator<DurationFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, DurationFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, DurationFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: DurationFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: DurationFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): DurationFormat1BoxedVoid {
            return DurationFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): DurationFormat1BoxedBoolean {
            return DurationFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): DurationFormat1BoxedNumber {
            return DurationFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): DurationFormat1BoxedString {
            return DurationFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): DurationFormat1BoxedList {
            return DurationFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): DurationFormat1BoxedMap {
            return DurationFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): DurationFormat1Boxed {
            if (arg == null) {
