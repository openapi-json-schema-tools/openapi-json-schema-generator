...
class TimeFormat {
    ...
    sealed interface TimeFormat1Boxed {
        fun getData(): Any?
    }
    
    data class TimeFormat1BoxedVoid(val data: Nothing?) : TimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class TimeFormat1BoxedBoolean(val data: Boolean): TimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class TimeFormat1BoxedNumber(val data: Number) : TimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class TimeFormat1BoxedString(val data: String) : TimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class TimeFormat1BoxedList(val data: FrozenList<Any?>) : TimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class TimeFormat1BoxedMap(val data: FrozenMap<Any?>) : TimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class TimeFormat1 private constructor(): JsonSchema<TimeFormat1Boxed>(
        JsonSchemaInfo(
            format = "time",
        )
    ), NullSchemaValidator<TimeFormat1BoxedVoid>, BooleanSchemaValidator<TimeFormat1BoxedBoolean>, NumberSchemaValidator<TimeFormat1BoxedNumber>, StringSchemaValidator<TimeFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, TimeFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, TimeFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: TimeFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: TimeFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): TimeFormat1BoxedVoid {
            return TimeFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): TimeFormat1BoxedBoolean {
            return TimeFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): TimeFormat1BoxedNumber {
            return TimeFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): TimeFormat1BoxedString {
            return TimeFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): TimeFormat1BoxedList {
            return TimeFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): TimeFormat1BoxedMap {
            return TimeFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): TimeFormat1Boxed {
            if (arg == null) {
