...
class IdnHostnameFormat {
    // nest classes so all schemas and input/output classes can be public
    
    
    sealed interface IdnHostnameFormat1Boxed {
        fun getData(): Any?
    }
    
    data class IdnHostnameFormat1BoxedVoid(val data: Nothing?) : IdnHostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnHostnameFormat1BoxedBoolean(val data: Boolean): IdnHostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnHostnameFormat1BoxedNumber(val data: Number) : IdnHostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnHostnameFormat1BoxedString(val data: String) : IdnHostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnHostnameFormat1BoxedList(val data: FrozenList<Any?>) : IdnHostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnHostnameFormat1BoxedMap(val data: FrozenMap<Any?>) : IdnHostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IdnHostnameFormat1 private constructor(): JsonSchema<IdnHostnameFormat1Boxed>(
        JsonSchemaInfo()
            .format("idn-hostname")
    ), NullSchemaValidator<IdnHostnameFormat1BoxedVoid>, BooleanSchemaValidator<IdnHostnameFormat1BoxedBoolean>, NumberSchemaValidator<IdnHostnameFormat1BoxedNumber>, StringSchemaValidator<IdnHostnameFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IdnHostnameFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IdnHostnameFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IdnHostnameFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IdnHostnameFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IdnHostnameFormat1BoxedVoid {
            return IdnHostnameFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IdnHostnameFormat1BoxedBoolean {
            return IdnHostnameFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IdnHostnameFormat1BoxedNumber {
            return IdnHostnameFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IdnHostnameFormat1BoxedString {
            return IdnHostnameFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IdnHostnameFormat1BoxedList {
            return IdnHostnameFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IdnHostnameFormat1BoxedMap {
            return IdnHostnameFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IdnHostnameFormat1Boxed {
            if (arg == null) {
