...
class HostnameFormat {
    ...
    data class HostnameFormat1BoxedVoid(val data: Nothing?) : HostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class HostnameFormat1BoxedBoolean(val data: Boolean): HostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class HostnameFormat1BoxedNumber(val data: Number) : HostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class HostnameFormat1BoxedString(val data: String) : HostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class HostnameFormat1BoxedList(val data: FrozenList<Any?>) : HostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class HostnameFormat1BoxedMap(val data: FrozenMap<Any?>) : HostnameFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class HostnameFormat1 private constructor(): JsonSchema<HostnameFormat1Boxed>(
        JsonSchemaInfo()
            .format("hostname")
    ), NullSchemaValidator<HostnameFormat1BoxedVoid>, BooleanSchemaValidator<HostnameFormat1BoxedBoolean>, NumberSchemaValidator<HostnameFormat1BoxedNumber>, StringSchemaValidator<HostnameFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, HostnameFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, HostnameFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: HostnameFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: HostnameFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): HostnameFormat1BoxedVoid {
            return HostnameFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): HostnameFormat1BoxedBoolean {
            return HostnameFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): HostnameFormat1BoxedNumber {
            return HostnameFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): HostnameFormat1BoxedString {
            return HostnameFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): HostnameFormat1BoxedList {
            return HostnameFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): HostnameFormat1BoxedMap {
            return HostnameFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): HostnameFormat1Boxed {
            if (arg == null) {
