...
class EmailFormat {
    ...
    data class EmailFormat1BoxedVoid(val data: Nothing?) : EmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmailFormat1BoxedBoolean(val data: Boolean): EmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmailFormat1BoxedNumber(val data: Number) : EmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmailFormat1BoxedString(val data: String) : EmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmailFormat1BoxedList(val data: FrozenList<Any?>) : EmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmailFormat1BoxedMap(val data: FrozenMap<Any?>) : EmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class EmailFormat1 private constructor(): JsonSchema<EmailFormat1Boxed>(
        JsonSchemaInfo()
            .format("email")
    ), NullSchemaValidator<EmailFormat1BoxedVoid>, BooleanSchemaValidator<EmailFormat1BoxedBoolean>, NumberSchemaValidator<EmailFormat1BoxedNumber>, StringSchemaValidator<EmailFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, EmailFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, EmailFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: EmailFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: EmailFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): EmailFormat1BoxedVoid {
            return EmailFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): EmailFormat1BoxedBoolean {
            return EmailFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): EmailFormat1BoxedNumber {
            return EmailFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): EmailFormat1BoxedString {
            return EmailFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): EmailFormat1BoxedList {
            return EmailFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): EmailFormat1BoxedMap {
            return EmailFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): EmailFormat1Boxed {
            if (arg == null) {
