...
class PatternIsNotAnchored {
    ...
    data class PatternIsNotAnchored1BoxedVoid(val data: Nothing?) : PatternIsNotAnchored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternIsNotAnchored1BoxedBoolean(val data: Boolean): PatternIsNotAnchored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternIsNotAnchored1BoxedNumber(val data: Number) : PatternIsNotAnchored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternIsNotAnchored1BoxedString(val data: String) : PatternIsNotAnchored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternIsNotAnchored1BoxedList(val data: FrozenList<Any?>) : PatternIsNotAnchored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternIsNotAnchored1BoxedMap(val data: FrozenMap<Any?>) : PatternIsNotAnchored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class PatternIsNotAnchored1 private constructor(): JsonSchema<PatternIsNotAnchored1Boxed>(
        pattern = Pattern.compile(
            "a+"
        ),
    ), NullSchemaValidator<PatternIsNotAnchored1BoxedVoid>, BooleanSchemaValidator<PatternIsNotAnchored1BoxedBoolean>, NumberSchemaValidator<PatternIsNotAnchored1BoxedNumber>, StringSchemaValidator<PatternIsNotAnchored1BoxedString>, ListSchemaValidator<FrozenList<Any?>, PatternIsNotAnchored1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, PatternIsNotAnchored1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: PatternIsNotAnchored1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: PatternIsNotAnchored1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): PatternIsNotAnchored1BoxedVoid {
            return PatternIsNotAnchored1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): PatternIsNotAnchored1BoxedBoolean {
            return PatternIsNotAnchored1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): PatternIsNotAnchored1BoxedNumber {
            return PatternIsNotAnchored1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): PatternIsNotAnchored1BoxedString {
            return PatternIsNotAnchored1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): PatternIsNotAnchored1BoxedList {
            return PatternIsNotAnchored1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): PatternIsNotAnchored1BoxedMap {
            return PatternIsNotAnchored1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): PatternIsNotAnchored1Boxed {
            if (arg == null) {
