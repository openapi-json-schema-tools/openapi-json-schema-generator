...
class AllofWithOneEmptySchema {
    ...
    data class AllofWithOneEmptySchema1BoxedVoid(val data: Nothing?) : AllofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithOneEmptySchema1BoxedBoolean(val data: Boolean): AllofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithOneEmptySchema1BoxedNumber(val data: Number) : AllofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithOneEmptySchema1BoxedString(val data: String) : AllofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithOneEmptySchema1BoxedList(val data: FrozenList<Any?>) : AllofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithOneEmptySchema1BoxedMap(val data: FrozenMap<Any?>) : AllofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AllofWithOneEmptySchema1 private constructor(): JsonSchema<AllofWithOneEmptySchema1Boxed>(
        allOf = listOf(
            Schema0::class.java
        ),
    ), NullSchemaValidator<AllofWithOneEmptySchema1BoxedVoid>, BooleanSchemaValidator<AllofWithOneEmptySchema1BoxedBoolean>, NumberSchemaValidator<AllofWithOneEmptySchema1BoxedNumber>, StringSchemaValidator<AllofWithOneEmptySchema1BoxedString>, ListSchemaValidator<FrozenList<Any?>, AllofWithOneEmptySchema1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, AllofWithOneEmptySchema1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AllofWithOneEmptySchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AllofWithOneEmptySchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): AllofWithOneEmptySchema1BoxedVoid {
            return AllofWithOneEmptySchema1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): AllofWithOneEmptySchema1BoxedBoolean {
            return AllofWithOneEmptySchema1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): AllofWithOneEmptySchema1BoxedNumber {
            return AllofWithOneEmptySchema1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AllofWithOneEmptySchema1BoxedString {
            return AllofWithOneEmptySchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): AllofWithOneEmptySchema1BoxedList {
            return AllofWithOneEmptySchema1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AllofWithOneEmptySchema1BoxedMap {
            return AllofWithOneEmptySchema1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AllofWithOneEmptySchema1Boxed {
            if (arg == null) {
