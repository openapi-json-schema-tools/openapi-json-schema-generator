...
class ByNumber {
    ...
    data class ByNumber1BoxedVoid(val data: Nothing?) : ByNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByNumber1BoxedBoolean(val data: Boolean): ByNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByNumber1BoxedNumber(val data: Number) : ByNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByNumber1BoxedString(val data: String) : ByNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByNumber1BoxedList(val data: FrozenList<Any?>) : ByNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByNumber1BoxedMap(val data: FrozenMap<Any?>) : ByNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class ByNumber1 private constructor(): JsonSchema<ByNumber1Boxed>(
        multipleOf = BigDecimal("1.5"),
    ), NullSchemaValidator<ByNumber1BoxedVoid>, BooleanSchemaValidator<ByNumber1BoxedBoolean>, NumberSchemaValidator<ByNumber1BoxedNumber>, StringSchemaValidator<ByNumber1BoxedString>, ListSchemaValidator<FrozenList<Any?>, ByNumber1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, ByNumber1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: ByNumber1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: ByNumber1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): ByNumber1BoxedVoid {
            return ByNumber1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): ByNumber1BoxedBoolean {
            return ByNumber1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): ByNumber1BoxedNumber {
            return ByNumber1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): ByNumber1BoxedString {
            return ByNumber1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): ByNumber1BoxedList {
            return ByNumber1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): ByNumber1BoxedMap {
            return ByNumber1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): ByNumber1Boxed {
            if (arg == null) {
