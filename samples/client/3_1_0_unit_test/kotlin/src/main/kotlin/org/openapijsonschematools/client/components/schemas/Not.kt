...
class Not {
    ...
    class Not2 : IntJsonSchema.IntJsonSchema1() {
        companion object {
            @Volatile
            private var instance: Not2? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Not2().also { instance = it }
                }
        }
    }
    ...
    data class Not1BoxedVoid(val data: Nothing?) : Not1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Not1BoxedBoolean(val data: Boolean): Not1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Not1BoxedNumber(val data: Number) : Not1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Not1BoxedString(val data: String) : Not1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Not1BoxedList(val data: FrozenList<Any?>) : Not1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Not1BoxedMap(val data: FrozenMap<Any?>) : Not1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class Not1 private constructor(): JsonSchema<Not1Boxed>(
        not = Not2::class.java,
    ), NullSchemaValidator<Not1BoxedVoid>, BooleanSchemaValidator<Not1BoxedBoolean>, NumberSchemaValidator<Not1BoxedNumber>, StringSchemaValidator<Not1BoxedString>, ListSchemaValidator<FrozenList<Any?>, Not1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, Not1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: Not1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Not1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): Not1BoxedVoid {
            return Not1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): Not1BoxedBoolean {
            return Not1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): Not1BoxedNumber {
            return Not1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): Not1BoxedString {
            return Not1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): Not1BoxedList {
            return Not1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): Not1BoxedMap {
            return Not1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): Not1Boxed {
            if (arg == null) {
