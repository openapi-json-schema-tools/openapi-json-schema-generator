...
class MultipleDependentsRequired {
    // nest classes so all schemas and input/output classes can be public
    
    
    sealed interface MultipleDependentsRequired1Boxed {
        fun getData(): Any?
    }
    
    data class MultipleDependentsRequired1BoxedVoid(val data: Nothing?) : MultipleDependentsRequired1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MultipleDependentsRequired1BoxedBoolean(val data: Boolean): MultipleDependentsRequired1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MultipleDependentsRequired1BoxedNumber(val data: Number) : MultipleDependentsRequired1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MultipleDependentsRequired1BoxedString(val data: String) : MultipleDependentsRequired1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MultipleDependentsRequired1BoxedList(val data: FrozenList<Any?>) : MultipleDependentsRequired1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MultipleDependentsRequired1BoxedMap(val data: FrozenMap<Any?>) : MultipleDependentsRequired1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MultipleDependentsRequired1 private constructor(): JsonSchema<MultipleDependentsRequired1Boxed>(
    ...
    ), NullSchemaValidator<MultipleDependentsRequired1BoxedVoid>, BooleanSchemaValidator<MultipleDependentsRequired1BoxedBoolean>, NumberSchemaValidator<MultipleDependentsRequired1BoxedNumber>, StringSchemaValidator<MultipleDependentsRequired1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MultipleDependentsRequired1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MultipleDependentsRequired1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MultipleDependentsRequired1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MultipleDependentsRequired1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MultipleDependentsRequired1BoxedVoid {
            return MultipleDependentsRequired1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MultipleDependentsRequired1BoxedBoolean {
            return MultipleDependentsRequired1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MultipleDependentsRequired1BoxedNumber {
            return MultipleDependentsRequired1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MultipleDependentsRequired1BoxedString {
            return MultipleDependentsRequired1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MultipleDependentsRequired1BoxedList {
            return MultipleDependentsRequired1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MultipleDependentsRequired1BoxedMap {
            return MultipleDependentsRequired1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MultipleDependentsRequired1Boxed {
            if (arg == null) {
