...
class DependentSchemasDependentSubschemaIncompatibleWithRoot {
    ...
    class FooMap(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        companion object {
            ...
            fun of(arg: Map<String, Any?>, configuration: SchemaConfiguration): FooMap {
    ...
    class FooMapBuilder1: GenericBuilder<Map<String, Any?>>, SetterForBar<FooMapBuilder1> {
        ...
        override fun getBuilderAfterBar(instance: MutableMap<String, Any?>): FooMapBuilder1 {
            return this
        }
    }
    
    
    sealed interface Foo1Boxed {
        fun getData(): Any?
    }
    
    data class Foo1BoxedMap(val data: FooMap) : Foo1Boxed {
    ...
    class Foo1 private constructor(): JsonSchema<Foo1Boxed>(
        JsonSchemaInfo()
    ...
    ), MapSchemaValidator<FooMap, Foo1BoxedMap> {
    
        companion object {
            @Volatile
            private var instance: Foo1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Foo1().also { instance = it }
                }
        }
        
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): FooMap {
            ...
            return FooMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): FooMap {
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): Foo1BoxedMap {
            return Foo1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): Foo1Boxed {
            if (arg is Map<*, *>) {
    ...
    class DependentSchemasDependentSubschemaIncompatibleWithRootMap(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        companion object {
            val requiredKeys: Set<String> = setOf()
            val optionalKeys: Set<String> = setOf(
                "foo"
            ...
            @Throws(ValidationException::class)
            fun of(arg: Map<String, Any?>, configuration: SchemaConfiguration): DependentSchemasDependentSubschemaIncompatibleWithRootMap {
    ...
    class DependentSchemasDependentSubschemaIncompatibleWithRootMapBuilder: UnsetAddPropsSetter<DependentSchemasDependentSubschemaIncompatibleWithRootMapBuilder>, GenericBuilder<Map<String, Any?>>, SetterForFoo<DependentSchemasDependentSubschemaIncompatibleWithRootMapBuilder> {
        private val knownKeys: Set<String> = setOf(
            "foo"
        )
        override fun getKnownKeys(): Set<String> {
        ...
        override fun getBuilderAfterFoo(instance: MutableMap<String, Any?>): DependentSchemasDependentSubschemaIncompatibleWithRootMapBuilder {
            return this
        }
        override fun getBuilderAfterAdditionalProperty(instance: MutableMap<String, Any?>): DependentSchemasDependentSubschemaIncompatibleWithRootMapBuilder  {
            return this
        }
    }
    
    
    sealed interface DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
        fun getData(): Any?
    }
    
    data class DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedVoid(val data: Nothing?) : DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedBoolean(val data: Boolean): DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedNumber(val data: Number) : DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedString(val data: String) : DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedList(val data: FrozenList<Any?>) : DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedMap(val data: DependentSchemasDependentSubschemaIncompatibleWithRootMap) : DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class DependentSchemasDependentSubschemaIncompatibleWithRoot1 private constructor(): JsonSchema<DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed>(
        JsonSchemaInfo()
            .properties(mapOf(
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: DependentSchemasDependentSubschemaIncompatibleWithRoot1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: DependentSchemasDependentSubschemaIncompatibleWithRoot1().also { instance = it }
                }
        }
        ...
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): DependentSchemasDependentSubschemaIncompatibleWithRootMap {
            val properties: LinkedHashMap<String, Any?> = LinkedHashMap()
            ...
            val castProperties: FrozenMap<Any?> = FrozenMap(properties)
            return DependentSchemasDependentSubschemaIncompatibleWithRootMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRootMap {
            val pathSet: MutableSet<List<Any>> = HashSet()
            val pathToItem = listOf<Any>("args[0")
            val castArg = castToAllowedTypes(arg, pathToItem, pathSet)
            val usedConfiguration = configuration ?: SchemaConfiguration(JsonSchemaKeywordFlags.Builder().build())
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedVoid {
            return DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedBoolean {
            return DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedNumber {
            return DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedString {
            return DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedList {
            return DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedMap {
            return DependentSchemasDependentSubschemaIncompatibleWithRoot1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): DependentSchemasDependentSubschemaIncompatibleWithRoot1Boxed {
            if (arg == null) {
