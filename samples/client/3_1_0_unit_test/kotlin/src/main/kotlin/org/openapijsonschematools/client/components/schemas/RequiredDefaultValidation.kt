...
class RequiredDefaultValidation {
    ...
    class RequiredDefaultValidationMap(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        companion object {
            ...
            fun of(arg: Map<String, Any?>, configuration: SchemaConfiguration): RequiredDefaultValidationMap {
    ...
    class RequiredDefaultValidationMapBuilder: UnsetAddPropsSetter<RequiredDefaultValidationMapBuilder>, GenericBuilder<Map<String, Any?>>, SetterForFoo<RequiredDefaultValidationMapBuilder> {
        ...
        override fun getBuilderAfterFoo(instance: MutableMap<String, Any?>): RequiredDefaultValidationMapBuilder {
            return this
        }
        override fun getBuilderAfterAdditionalProperty(instance: MutableMap<String, Any?>): RequiredDefaultValidationMapBuilder  {
            return this
        }
    }
    ...
    data class RequiredDefaultValidation1BoxedVoid(val data: Nothing?) : RequiredDefaultValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredDefaultValidation1BoxedBoolean(val data: Boolean): RequiredDefaultValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredDefaultValidation1BoxedNumber(val data: Number) : RequiredDefaultValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredDefaultValidation1BoxedString(val data: String) : RequiredDefaultValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredDefaultValidation1BoxedList(val data: FrozenList<Any?>) : RequiredDefaultValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredDefaultValidation1BoxedMap(val data: RequiredDefaultValidationMap) : RequiredDefaultValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RequiredDefaultValidation1 private constructor(): JsonSchema<RequiredDefaultValidation1Boxed>(
        properties = mapOf(
            "foo" to Foo::class.java
        ),
    ), NullSchemaValidator<RequiredDefaultValidation1BoxedVoid>, BooleanSchemaValidator<RequiredDefaultValidation1BoxedBoolean>, NumberSchemaValidator<RequiredDefaultValidation1BoxedNumber>, StringSchemaValidator<RequiredDefaultValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RequiredDefaultValidation1BoxedList>, MapSchemaValidator<RequiredDefaultValidationMap, RequiredDefaultValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RequiredDefaultValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RequiredDefaultValidation1().also { instance = it }
                }
        }
        ...
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): RequiredDefaultValidationMap {
            ...
            return RequiredDefaultValidationMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): RequiredDefaultValidationMap {
            val pathSet: MutableSet<List<Any>> = HashSet()
            val pathToItem = listOf<Any>("args[0")
            val castArg = castToAllowedTypes(arg, pathToItem, pathSet)
            val usedConfiguration = configuration ?: SchemaConfiguration(JsonSchemaKeywordFlags.Builder().build())
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RequiredDefaultValidation1BoxedVoid {
            return RequiredDefaultValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RequiredDefaultValidation1BoxedBoolean {
            return RequiredDefaultValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RequiredDefaultValidation1BoxedNumber {
            return RequiredDefaultValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RequiredDefaultValidation1BoxedString {
            return RequiredDefaultValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RequiredDefaultValidation1BoxedList {
            return RequiredDefaultValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RequiredDefaultValidation1BoxedMap {
            return RequiredDefaultValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RequiredDefaultValidation1Boxed {
            if (arg == null) {
