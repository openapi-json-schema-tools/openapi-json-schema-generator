...
class AnyofComplexTypes {
    ...
    data class AnyofComplexTypes1BoxedVoid(val data: Nothing?) : AnyofComplexTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofComplexTypes1BoxedBoolean(val data: Boolean): AnyofComplexTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofComplexTypes1BoxedNumber(val data: Number) : AnyofComplexTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofComplexTypes1BoxedString(val data: String) : AnyofComplexTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofComplexTypes1BoxedList(val data: FrozenList<Any?>) : AnyofComplexTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofComplexTypes1BoxedMap(val data: FrozenMap<Any?>) : AnyofComplexTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AnyofComplexTypes1 private constructor(): JsonSchema<AnyofComplexTypes1Boxed>(
        JsonSchemaInfo()
            .anyOf(listOf(
                Schema0::class.java,
                Schema1::class.java
            ))
    ), NullSchemaValidator<AnyofComplexTypes1BoxedVoid>, BooleanSchemaValidator<AnyofComplexTypes1BoxedBoolean>, NumberSchemaValidator<AnyofComplexTypes1BoxedNumber>, StringSchemaValidator<AnyofComplexTypes1BoxedString>, ListSchemaValidator<FrozenList<Any?>, AnyofComplexTypes1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, AnyofComplexTypes1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AnyofComplexTypes1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AnyofComplexTypes1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): AnyofComplexTypes1BoxedVoid {
            return AnyofComplexTypes1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): AnyofComplexTypes1BoxedBoolean {
            return AnyofComplexTypes1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): AnyofComplexTypes1BoxedNumber {
            return AnyofComplexTypes1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AnyofComplexTypes1BoxedString {
            return AnyofComplexTypes1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): AnyofComplexTypes1BoxedList {
            return AnyofComplexTypes1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AnyofComplexTypes1BoxedMap {
            return AnyofComplexTypes1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AnyofComplexTypes1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
