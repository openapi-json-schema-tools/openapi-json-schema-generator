...
class IgnoreThenWithoutIf {
    ...
    sealed interface IgnoreThenWithoutIf1Boxed {
        fun getData(): Any?
    }
    
    data class IgnoreThenWithoutIf1BoxedVoid(val data: Nothing?) : IgnoreThenWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreThenWithoutIf1BoxedBoolean(val data: Boolean): IgnoreThenWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreThenWithoutIf1BoxedNumber(val data: Number) : IgnoreThenWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreThenWithoutIf1BoxedString(val data: String) : IgnoreThenWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreThenWithoutIf1BoxedList(val data: FrozenList<Any?>) : IgnoreThenWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreThenWithoutIf1BoxedMap(val data: FrozenMap<Any?>) : IgnoreThenWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IgnoreThenWithoutIf1 private constructor(): JsonSchema<IgnoreThenWithoutIf1Boxed>(
        JsonSchemaInfo(
            then =Then::class.java,
        )
    ), NullSchemaValidator<IgnoreThenWithoutIf1BoxedVoid>, BooleanSchemaValidator<IgnoreThenWithoutIf1BoxedBoolean>, NumberSchemaValidator<IgnoreThenWithoutIf1BoxedNumber>, StringSchemaValidator<IgnoreThenWithoutIf1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IgnoreThenWithoutIf1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IgnoreThenWithoutIf1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IgnoreThenWithoutIf1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IgnoreThenWithoutIf1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IgnoreThenWithoutIf1BoxedVoid {
            return IgnoreThenWithoutIf1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IgnoreThenWithoutIf1BoxedBoolean {
            return IgnoreThenWithoutIf1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IgnoreThenWithoutIf1BoxedNumber {
            return IgnoreThenWithoutIf1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IgnoreThenWithoutIf1BoxedString {
            return IgnoreThenWithoutIf1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IgnoreThenWithoutIf1BoxedList {
            return IgnoreThenWithoutIf1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IgnoreThenWithoutIf1BoxedMap {
            return IgnoreThenWithoutIf1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IgnoreThenWithoutIf1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
