...
class AllofWithTheFirstEmptySchema {
    ...
    class Schema1 : NumberJsonSchema.NumberJsonSchema1() {
        companion object {
            @Volatile
    ...
    data class AllofWithTheFirstEmptySchema1BoxedVoid(val data: Nothing?) : AllofWithTheFirstEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheFirstEmptySchema1BoxedBoolean(val data: Boolean): AllofWithTheFirstEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheFirstEmptySchema1BoxedNumber(val data: Number) : AllofWithTheFirstEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheFirstEmptySchema1BoxedString(val data: String) : AllofWithTheFirstEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheFirstEmptySchema1BoxedList(val data: FrozenList<Any?>) : AllofWithTheFirstEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheFirstEmptySchema1BoxedMap(val data: FrozenMap<Any?>) : AllofWithTheFirstEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AllofWithTheFirstEmptySchema1 private constructor(): JsonSchema<AllofWithTheFirstEmptySchema1Boxed>(
        allOf = listOf(
            Schema0::class.java,
            Schema1::class.java
        ),
    ), NullSchemaValidator<AllofWithTheFirstEmptySchema1BoxedVoid>, BooleanSchemaValidator<AllofWithTheFirstEmptySchema1BoxedBoolean>, NumberSchemaValidator<AllofWithTheFirstEmptySchema1BoxedNumber>, StringSchemaValidator<AllofWithTheFirstEmptySchema1BoxedString>, ListSchemaValidator<FrozenList<Any?>, AllofWithTheFirstEmptySchema1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, AllofWithTheFirstEmptySchema1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AllofWithTheFirstEmptySchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AllofWithTheFirstEmptySchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): AllofWithTheFirstEmptySchema1BoxedVoid {
            return AllofWithTheFirstEmptySchema1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): AllofWithTheFirstEmptySchema1BoxedBoolean {
            return AllofWithTheFirstEmptySchema1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): AllofWithTheFirstEmptySchema1BoxedNumber {
            return AllofWithTheFirstEmptySchema1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AllofWithTheFirstEmptySchema1BoxedString {
            return AllofWithTheFirstEmptySchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): AllofWithTheFirstEmptySchema1BoxedList {
            return AllofWithTheFirstEmptySchema1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AllofWithTheFirstEmptySchema1BoxedMap {
            return AllofWithTheFirstEmptySchema1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AllofWithTheFirstEmptySchema1Boxed {
            if (arg == null) {
