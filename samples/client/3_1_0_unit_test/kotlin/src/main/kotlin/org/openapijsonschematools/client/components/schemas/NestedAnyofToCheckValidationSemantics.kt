...
class NestedAnyofToCheckValidationSemantics {
    ...
    data class NestedAnyofToCheckValidationSemantics1BoxedVoid(val data: Nothing?) : NestedAnyofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedAnyofToCheckValidationSemantics1BoxedBoolean(val data: Boolean): NestedAnyofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedAnyofToCheckValidationSemantics1BoxedNumber(val data: Number) : NestedAnyofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedAnyofToCheckValidationSemantics1BoxedString(val data: String) : NestedAnyofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedAnyofToCheckValidationSemantics1BoxedList(val data: FrozenList<Any?>) : NestedAnyofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedAnyofToCheckValidationSemantics1BoxedMap(val data: FrozenMap<Any?>) : NestedAnyofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class NestedAnyofToCheckValidationSemantics1 private constructor(): JsonSchema<NestedAnyofToCheckValidationSemantics1Boxed>(
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: NestedAnyofToCheckValidationSemantics1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: NestedAnyofToCheckValidationSemantics1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): NestedAnyofToCheckValidationSemantics1BoxedVoid {
            return NestedAnyofToCheckValidationSemantics1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): NestedAnyofToCheckValidationSemantics1BoxedBoolean {
            return NestedAnyofToCheckValidationSemantics1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): NestedAnyofToCheckValidationSemantics1BoxedNumber {
            return NestedAnyofToCheckValidationSemantics1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): NestedAnyofToCheckValidationSemantics1BoxedString {
            return NestedAnyofToCheckValidationSemantics1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): NestedAnyofToCheckValidationSemantics1BoxedList {
            return NestedAnyofToCheckValidationSemantics1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): NestedAnyofToCheckValidationSemantics1BoxedMap {
            return NestedAnyofToCheckValidationSemantics1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): NestedAnyofToCheckValidationSemantics1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
