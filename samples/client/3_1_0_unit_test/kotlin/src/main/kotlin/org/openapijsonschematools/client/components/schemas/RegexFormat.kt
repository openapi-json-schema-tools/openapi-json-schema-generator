...
class RegexFormat {
    ...
    sealed interface RegexFormat1Boxed {
        fun getData(): Any?
    }
    
    data class RegexFormat1BoxedVoid(val data: Nothing?) : RegexFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RegexFormat1BoxedBoolean(val data: Boolean): RegexFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RegexFormat1BoxedNumber(val data: Number) : RegexFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RegexFormat1BoxedString(val data: String) : RegexFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RegexFormat1BoxedList(val data: FrozenList<Any?>) : RegexFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RegexFormat1BoxedMap(val data: FrozenMap<Any?>) : RegexFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RegexFormat1 private constructor(): JsonSchema<RegexFormat1Boxed>(
        format = "regex",
    ), NullSchemaValidator<RegexFormat1BoxedVoid>, BooleanSchemaValidator<RegexFormat1BoxedBoolean>, NumberSchemaValidator<RegexFormat1BoxedNumber>, StringSchemaValidator<RegexFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RegexFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, RegexFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RegexFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RegexFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RegexFormat1BoxedVoid {
            return RegexFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RegexFormat1BoxedBoolean {
            return RegexFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RegexFormat1BoxedNumber {
            return RegexFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RegexFormat1BoxedString {
            return RegexFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RegexFormat1BoxedList {
            return RegexFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RegexFormat1BoxedMap {
            return RegexFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RegexFormat1Boxed {
            if (arg == null) {
