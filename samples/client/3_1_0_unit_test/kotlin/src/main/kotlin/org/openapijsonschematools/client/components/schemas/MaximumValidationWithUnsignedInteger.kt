...
class MaximumValidationWithUnsignedInteger {
    ...
    data class MaximumValidationWithUnsignedInteger1BoxedVoid(val data: Nothing?) : MaximumValidationWithUnsignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidationWithUnsignedInteger1BoxedBoolean(val data: Boolean): MaximumValidationWithUnsignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidationWithUnsignedInteger1BoxedNumber(val data: Number) : MaximumValidationWithUnsignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidationWithUnsignedInteger1BoxedString(val data: String) : MaximumValidationWithUnsignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidationWithUnsignedInteger1BoxedList(val data: FrozenList<Any?>) : MaximumValidationWithUnsignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaximumValidationWithUnsignedInteger1BoxedMap(val data: FrozenMap<Any?>) : MaximumValidationWithUnsignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MaximumValidationWithUnsignedInteger1 private constructor(): JsonSchema<MaximumValidationWithUnsignedInteger1Boxed>(
        JsonSchemaInfo()
            .maximum(300)
    ), NullSchemaValidator<MaximumValidationWithUnsignedInteger1BoxedVoid>, BooleanSchemaValidator<MaximumValidationWithUnsignedInteger1BoxedBoolean>, NumberSchemaValidator<MaximumValidationWithUnsignedInteger1BoxedNumber>, StringSchemaValidator<MaximumValidationWithUnsignedInteger1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MaximumValidationWithUnsignedInteger1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MaximumValidationWithUnsignedInteger1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MaximumValidationWithUnsignedInteger1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MaximumValidationWithUnsignedInteger1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MaximumValidationWithUnsignedInteger1BoxedVoid {
            return MaximumValidationWithUnsignedInteger1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MaximumValidationWithUnsignedInteger1BoxedBoolean {
            return MaximumValidationWithUnsignedInteger1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MaximumValidationWithUnsignedInteger1BoxedNumber {
            return MaximumValidationWithUnsignedInteger1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MaximumValidationWithUnsignedInteger1BoxedString {
            return MaximumValidationWithUnsignedInteger1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MaximumValidationWithUnsignedInteger1BoxedList {
            return MaximumValidationWithUnsignedInteger1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MaximumValidationWithUnsignedInteger1BoxedMap {
            return MaximumValidationWithUnsignedInteger1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MaximumValidationWithUnsignedInteger1Boxed {
            if (arg == null) {
