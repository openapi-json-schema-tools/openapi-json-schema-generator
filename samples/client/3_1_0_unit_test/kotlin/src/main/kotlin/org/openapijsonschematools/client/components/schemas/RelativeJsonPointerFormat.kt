...
class RelativeJsonPointerFormat {
    // nest classes so all schemas and input/output classes can be public
    
    
    sealed interface RelativeJsonPointerFormat1Boxed {
        fun getData(): Any?
    }
    
    data class RelativeJsonPointerFormat1BoxedVoid(val data: Nothing?) : RelativeJsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RelativeJsonPointerFormat1BoxedBoolean(val data: Boolean): RelativeJsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RelativeJsonPointerFormat1BoxedNumber(val data: Number) : RelativeJsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RelativeJsonPointerFormat1BoxedString(val data: String) : RelativeJsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RelativeJsonPointerFormat1BoxedList(val data: FrozenList<Any?>) : RelativeJsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RelativeJsonPointerFormat1BoxedMap(val data: FrozenMap<Any?>) : RelativeJsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RelativeJsonPointerFormat1 private constructor(): JsonSchema<RelativeJsonPointerFormat1Boxed>(
        JsonSchemaInfo(
            format = "relative-json-pointer",
        )
    ), NullSchemaValidator<RelativeJsonPointerFormat1BoxedVoid>, BooleanSchemaValidator<RelativeJsonPointerFormat1BoxedBoolean>, NumberSchemaValidator<RelativeJsonPointerFormat1BoxedNumber>, StringSchemaValidator<RelativeJsonPointerFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RelativeJsonPointerFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, RelativeJsonPointerFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RelativeJsonPointerFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RelativeJsonPointerFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RelativeJsonPointerFormat1BoxedVoid {
            return RelativeJsonPointerFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RelativeJsonPointerFormat1BoxedBoolean {
            return RelativeJsonPointerFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RelativeJsonPointerFormat1BoxedNumber {
            return RelativeJsonPointerFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RelativeJsonPointerFormat1BoxedString {
            return RelativeJsonPointerFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RelativeJsonPointerFormat1BoxedList {
            return RelativeJsonPointerFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RelativeJsonPointerFormat1BoxedMap {
            return RelativeJsonPointerFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RelativeJsonPointerFormat1Boxed {
            if (arg == null) {
