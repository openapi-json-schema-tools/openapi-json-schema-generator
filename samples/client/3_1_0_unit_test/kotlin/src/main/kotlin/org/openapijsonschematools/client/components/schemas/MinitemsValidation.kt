...
class MinitemsValidation {
    ...
    data class MinitemsValidation1BoxedVoid(val data: Nothing?) : MinitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinitemsValidation1BoxedBoolean(val data: Boolean): MinitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinitemsValidation1BoxedNumber(val data: Number) : MinitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinitemsValidation1BoxedString(val data: String) : MinitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinitemsValidation1BoxedList(val data: FrozenList<Any?>) : MinitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinitemsValidation1BoxedMap(val data: FrozenMap<Any?>) : MinitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MinitemsValidation1 private constructor(): JsonSchema<MinitemsValidation1Boxed>(
        minItems = 1,
    ), NullSchemaValidator<MinitemsValidation1BoxedVoid>, BooleanSchemaValidator<MinitemsValidation1BoxedBoolean>, NumberSchemaValidator<MinitemsValidation1BoxedNumber>, StringSchemaValidator<MinitemsValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MinitemsValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MinitemsValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MinitemsValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MinitemsValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MinitemsValidation1BoxedVoid {
            return MinitemsValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MinitemsValidation1BoxedBoolean {
            return MinitemsValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MinitemsValidation1BoxedNumber {
            return MinitemsValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MinitemsValidation1BoxedString {
            return MinitemsValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MinitemsValidation1BoxedList {
            return MinitemsValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MinitemsValidation1BoxedMap {
            return MinitemsValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MinitemsValidation1Boxed {
            if (arg == null) {
