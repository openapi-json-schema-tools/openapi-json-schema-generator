...
class NotMultipleTypes {
    ...
    data class NotBoxedNumber(val data: Number) : NotBoxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NotBoxedBoolean(val data: Boolean): NotBoxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class Not private constructor(): JsonSchema<NotBoxed>(
    ...
    ), NumberSchemaValidator<NotBoxedNumber>, BooleanSchemaValidator<NotBoxedBoolean> {
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): NotBoxedNumber {
            return NotBoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): NotBoxedBoolean {
            return NotBoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
    ...
    sealed interface NotMultipleTypes1Boxed {
        fun getData(): Any?
    }
    
    data class NotMultipleTypes1BoxedVoid(val data: Nothing?) : NotMultipleTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NotMultipleTypes1BoxedBoolean(val data: Boolean): NotMultipleTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NotMultipleTypes1BoxedNumber(val data: Number) : NotMultipleTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NotMultipleTypes1BoxedString(val data: String) : NotMultipleTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NotMultipleTypes1BoxedList(val data: FrozenList<Any?>) : NotMultipleTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NotMultipleTypes1BoxedMap(val data: FrozenMap<Any?>) : NotMultipleTypes1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class NotMultipleTypes1 private constructor(): JsonSchema<NotMultipleTypes1Boxed>(
        JsonSchemaInfo(
            not = Not::class.java,
        )
    ), NullSchemaValidator<NotMultipleTypes1BoxedVoid>, BooleanSchemaValidator<NotMultipleTypes1BoxedBoolean>, NumberSchemaValidator<NotMultipleTypes1BoxedNumber>, StringSchemaValidator<NotMultipleTypes1BoxedString>, ListSchemaValidator<FrozenList<Any?>, NotMultipleTypes1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, NotMultipleTypes1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: NotMultipleTypes1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: NotMultipleTypes1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): NotMultipleTypes1BoxedVoid {
            return NotMultipleTypes1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): NotMultipleTypes1BoxedBoolean {
            return NotMultipleTypes1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): NotMultipleTypes1BoxedNumber {
            return NotMultipleTypes1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): NotMultipleTypes1BoxedString {
            return NotMultipleTypes1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): NotMultipleTypes1BoxedList {
            return NotMultipleTypes1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): NotMultipleTypes1BoxedMap {
            return NotMultipleTypes1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): NotMultipleTypes1Boxed {
            if (arg == null) {
