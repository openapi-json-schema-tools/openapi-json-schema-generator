...
class IgnoreIfWithoutThenOrElse {
    ...
    enum class StringIfConst(private val value: String): StringValueMethod {
        POSITIVE_0("0");
    ...
    sealed interface IgnoreIfWithoutThenOrElse1Boxed {
        fun getData(): Any?
    }
    
    data class IgnoreIfWithoutThenOrElse1BoxedVoid(val data: Nothing?) : IgnoreIfWithoutThenOrElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreIfWithoutThenOrElse1BoxedBoolean(val data: Boolean): IgnoreIfWithoutThenOrElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreIfWithoutThenOrElse1BoxedNumber(val data: Number) : IgnoreIfWithoutThenOrElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreIfWithoutThenOrElse1BoxedString(val data: String) : IgnoreIfWithoutThenOrElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreIfWithoutThenOrElse1BoxedList(val data: FrozenList<Any?>) : IgnoreIfWithoutThenOrElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreIfWithoutThenOrElse1BoxedMap(val data: FrozenMap<Any?>) : IgnoreIfWithoutThenOrElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IgnoreIfWithoutThenOrElse1 private constructor(): JsonSchema<IgnoreIfWithoutThenOrElse1Boxed>(
        ifSchema = IfSchema::class.java,
    ), NullSchemaValidator<IgnoreIfWithoutThenOrElse1BoxedVoid>, BooleanSchemaValidator<IgnoreIfWithoutThenOrElse1BoxedBoolean>, NumberSchemaValidator<IgnoreIfWithoutThenOrElse1BoxedNumber>, StringSchemaValidator<IgnoreIfWithoutThenOrElse1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IgnoreIfWithoutThenOrElse1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IgnoreIfWithoutThenOrElse1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IgnoreIfWithoutThenOrElse1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IgnoreIfWithoutThenOrElse1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IgnoreIfWithoutThenOrElse1BoxedVoid {
            return IgnoreIfWithoutThenOrElse1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IgnoreIfWithoutThenOrElse1BoxedBoolean {
            return IgnoreIfWithoutThenOrElse1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IgnoreIfWithoutThenOrElse1BoxedNumber {
            return IgnoreIfWithoutThenOrElse1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IgnoreIfWithoutThenOrElse1BoxedString {
            return IgnoreIfWithoutThenOrElse1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IgnoreIfWithoutThenOrElse1BoxedList {
            return IgnoreIfWithoutThenOrElse1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IgnoreIfWithoutThenOrElse1BoxedMap {
            return IgnoreIfWithoutThenOrElse1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IgnoreIfWithoutThenOrElse1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
