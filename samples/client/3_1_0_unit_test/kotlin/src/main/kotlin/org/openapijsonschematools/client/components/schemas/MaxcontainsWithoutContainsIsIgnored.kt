...
class MaxcontainsWithoutContainsIsIgnored {
    // nest classes so all schemas and input/output classes can be public
    
    
    sealed interface MaxcontainsWithoutContainsIsIgnored1Boxed {
        fun getData(): Any?
    }
    
    data class MaxcontainsWithoutContainsIsIgnored1BoxedVoid(val data: Nothing?) : MaxcontainsWithoutContainsIsIgnored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxcontainsWithoutContainsIsIgnored1BoxedBoolean(val data: Boolean): MaxcontainsWithoutContainsIsIgnored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxcontainsWithoutContainsIsIgnored1BoxedNumber(val data: Number) : MaxcontainsWithoutContainsIsIgnored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxcontainsWithoutContainsIsIgnored1BoxedString(val data: String) : MaxcontainsWithoutContainsIsIgnored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxcontainsWithoutContainsIsIgnored1BoxedList(val data: FrozenList<Any?>) : MaxcontainsWithoutContainsIsIgnored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxcontainsWithoutContainsIsIgnored1BoxedMap(val data: FrozenMap<Any?>) : MaxcontainsWithoutContainsIsIgnored1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MaxcontainsWithoutContainsIsIgnored1 private constructor(): JsonSchema<MaxcontainsWithoutContainsIsIgnored1Boxed>(
        JsonSchemaInfo()
            .maxContains(1)
    ), NullSchemaValidator<MaxcontainsWithoutContainsIsIgnored1BoxedVoid>, BooleanSchemaValidator<MaxcontainsWithoutContainsIsIgnored1BoxedBoolean>, NumberSchemaValidator<MaxcontainsWithoutContainsIsIgnored1BoxedNumber>, StringSchemaValidator<MaxcontainsWithoutContainsIsIgnored1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MaxcontainsWithoutContainsIsIgnored1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MaxcontainsWithoutContainsIsIgnored1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MaxcontainsWithoutContainsIsIgnored1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MaxcontainsWithoutContainsIsIgnored1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MaxcontainsWithoutContainsIsIgnored1BoxedVoid {
            return MaxcontainsWithoutContainsIsIgnored1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MaxcontainsWithoutContainsIsIgnored1BoxedBoolean {
            return MaxcontainsWithoutContainsIsIgnored1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MaxcontainsWithoutContainsIsIgnored1BoxedNumber {
            return MaxcontainsWithoutContainsIsIgnored1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MaxcontainsWithoutContainsIsIgnored1BoxedString {
            return MaxcontainsWithoutContainsIsIgnored1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MaxcontainsWithoutContainsIsIgnored1BoxedList {
            return MaxcontainsWithoutContainsIsIgnored1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MaxcontainsWithoutContainsIsIgnored1BoxedMap {
            return MaxcontainsWithoutContainsIsIgnored1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MaxcontainsWithoutContainsIsIgnored1Boxed {
            if (arg == null) {
