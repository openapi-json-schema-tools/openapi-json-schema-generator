...
class MinimumValidation {
    ...
    data class MinimumValidation1BoxedVoid(val data: Nothing?) : MinimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidation1BoxedBoolean(val data: Boolean): MinimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidation1BoxedNumber(val data: Number) : MinimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidation1BoxedString(val data: String) : MinimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidation1BoxedList(val data: FrozenList<Any?>) : MinimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidation1BoxedMap(val data: FrozenMap<Any?>) : MinimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MinimumValidation1 private constructor(): JsonSchema<MinimumValidation1Boxed>(
        minimum = 1.1,
    ), NullSchemaValidator<MinimumValidation1BoxedVoid>, BooleanSchemaValidator<MinimumValidation1BoxedBoolean>, NumberSchemaValidator<MinimumValidation1BoxedNumber>, StringSchemaValidator<MinimumValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MinimumValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MinimumValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MinimumValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MinimumValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MinimumValidation1BoxedVoid {
            return MinimumValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MinimumValidation1BoxedBoolean {
            return MinimumValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MinimumValidation1BoxedNumber {
            return MinimumValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MinimumValidation1BoxedString {
            return MinimumValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MinimumValidation1BoxedList {
            return MinimumValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MinimumValidation1BoxedMap {
            return MinimumValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MinimumValidation1Boxed {
            if (arg == null) {
