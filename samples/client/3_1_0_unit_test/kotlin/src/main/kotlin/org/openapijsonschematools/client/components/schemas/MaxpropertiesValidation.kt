...
class MaxpropertiesValidation {
    ...
    data class MaxpropertiesValidation1BoxedVoid(val data: Nothing?) : MaxpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxpropertiesValidation1BoxedBoolean(val data: Boolean): MaxpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxpropertiesValidation1BoxedNumber(val data: Number) : MaxpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxpropertiesValidation1BoxedString(val data: String) : MaxpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxpropertiesValidation1BoxedList(val data: FrozenList<Any?>) : MaxpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxpropertiesValidation1BoxedMap(val data: FrozenMap<Any?>) : MaxpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MaxpropertiesValidation1 private constructor(): JsonSchema<MaxpropertiesValidation1Boxed>(
        maxProperties = 2,
    ), NullSchemaValidator<MaxpropertiesValidation1BoxedVoid>, BooleanSchemaValidator<MaxpropertiesValidation1BoxedBoolean>, NumberSchemaValidator<MaxpropertiesValidation1BoxedNumber>, StringSchemaValidator<MaxpropertiesValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MaxpropertiesValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MaxpropertiesValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MaxpropertiesValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MaxpropertiesValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MaxpropertiesValidation1BoxedVoid {
            return MaxpropertiesValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MaxpropertiesValidation1BoxedBoolean {
            return MaxpropertiesValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MaxpropertiesValidation1BoxedNumber {
            return MaxpropertiesValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MaxpropertiesValidation1BoxedString {
            return MaxpropertiesValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MaxpropertiesValidation1BoxedList {
            return MaxpropertiesValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MaxpropertiesValidation1BoxedMap {
            return MaxpropertiesValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MaxpropertiesValidation1Boxed {
            if (arg == null) {
