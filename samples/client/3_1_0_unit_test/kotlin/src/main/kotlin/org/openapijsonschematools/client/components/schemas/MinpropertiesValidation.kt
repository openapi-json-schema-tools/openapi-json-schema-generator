...
class MinpropertiesValidation {
    ...
    data class MinpropertiesValidation1BoxedVoid(val data: Nothing?) : MinpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinpropertiesValidation1BoxedBoolean(val data: Boolean): MinpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinpropertiesValidation1BoxedNumber(val data: Number) : MinpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinpropertiesValidation1BoxedString(val data: String) : MinpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinpropertiesValidation1BoxedList(val data: FrozenList<Any?>) : MinpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinpropertiesValidation1BoxedMap(val data: FrozenMap<Any?>) : MinpropertiesValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MinpropertiesValidation1 private constructor(): JsonSchema<MinpropertiesValidation1Boxed>(
        minProperties = 1,
    ), NullSchemaValidator<MinpropertiesValidation1BoxedVoid>, BooleanSchemaValidator<MinpropertiesValidation1BoxedBoolean>, NumberSchemaValidator<MinpropertiesValidation1BoxedNumber>, StringSchemaValidator<MinpropertiesValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MinpropertiesValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MinpropertiesValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MinpropertiesValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MinpropertiesValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MinpropertiesValidation1BoxedVoid {
            return MinpropertiesValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MinpropertiesValidation1BoxedBoolean {
            return MinpropertiesValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MinpropertiesValidation1BoxedNumber {
            return MinpropertiesValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MinpropertiesValidation1BoxedString {
            return MinpropertiesValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MinpropertiesValidation1BoxedList {
            return MinpropertiesValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MinpropertiesValidation1BoxedMap {
            return MinpropertiesValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MinpropertiesValidation1Boxed {
            if (arg == null) {
