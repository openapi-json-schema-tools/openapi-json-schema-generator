...
class UriTemplateFormat {
    ...
    data class UriTemplateFormat1BoxedVoid(val data: Nothing?) : UriTemplateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriTemplateFormat1BoxedBoolean(val data: Boolean): UriTemplateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriTemplateFormat1BoxedNumber(val data: Number) : UriTemplateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriTemplateFormat1BoxedString(val data: String) : UriTemplateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriTemplateFormat1BoxedList(val data: FrozenList<Any?>) : UriTemplateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriTemplateFormat1BoxedMap(val data: FrozenMap<Any?>) : UriTemplateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class UriTemplateFormat1 private constructor(): JsonSchema<UriTemplateFormat1Boxed>(
        format = "uri-template",
    ), NullSchemaValidator<UriTemplateFormat1BoxedVoid>, BooleanSchemaValidator<UriTemplateFormat1BoxedBoolean>, NumberSchemaValidator<UriTemplateFormat1BoxedNumber>, StringSchemaValidator<UriTemplateFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, UriTemplateFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, UriTemplateFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: UriTemplateFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: UriTemplateFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): UriTemplateFormat1BoxedVoid {
            return UriTemplateFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): UriTemplateFormat1BoxedBoolean {
            return UriTemplateFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): UriTemplateFormat1BoxedNumber {
            return UriTemplateFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): UriTemplateFormat1BoxedString {
            return UriTemplateFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): UriTemplateFormat1BoxedList {
            return UriTemplateFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): UriTemplateFormat1BoxedMap {
            return UriTemplateFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): UriTemplateFormat1Boxed {
            if (arg == null) {
