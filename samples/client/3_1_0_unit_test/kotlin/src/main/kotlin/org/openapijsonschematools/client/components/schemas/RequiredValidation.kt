...
class RequiredValidation {
    ...
    class RequiredValidationMap(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        companion object {
            ...
            fun of(arg: Map<String, Any?>, configuration: SchemaConfiguration): RequiredValidationMap {
    ...
    class RequiredValidationMap0Builder(private val instance: MutableMap<String, Any?>): UnsetAddPropsSetter<RequiredValidationMap0Builder>, GenericBuilder<Map<String, Any?>>, SetterForBar<RequiredValidationMap0Builder> {
        ...
        override fun getBuilderAfterBar(instance: MutableMap<String, Any?>): RequiredValidationMap0Builder {
            return this
        }
        override fun getBuilderAfterAdditionalProperty(instance: MutableMap<String, Any?>): RequiredValidationMap0Builder  {
            return this
        }
    }
    
    class RequiredValidationMapBuilder: SetterForFoo<RequiredValidationMap0Builder> {
        ...
        override fun getBuilderAfterFoo(instance: MutableMap<String, Any?>): RequiredValidationMap0Builder {
            return RequiredValidationMap0Builder(instance)
        }
    }
    ...
    data class RequiredValidation1BoxedVoid(val data: Nothing?) : RequiredValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredValidation1BoxedBoolean(val data: Boolean): RequiredValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredValidation1BoxedNumber(val data: Number) : RequiredValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredValidation1BoxedString(val data: String) : RequiredValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredValidation1BoxedList(val data: FrozenList<Any?>) : RequiredValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredValidation1BoxedMap(val data: RequiredValidationMap) : RequiredValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RequiredValidation1 private constructor(): JsonSchema<RequiredValidation1Boxed>(
        JsonSchemaInfo()
            .properties(mapOf(
    ...
    ), NullSchemaValidator<RequiredValidation1BoxedVoid>, BooleanSchemaValidator<RequiredValidation1BoxedBoolean>, NumberSchemaValidator<RequiredValidation1BoxedNumber>, StringSchemaValidator<RequiredValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RequiredValidation1BoxedList>, MapSchemaValidator<RequiredValidationMap, RequiredValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RequiredValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RequiredValidation1().also { instance = it }
                }
        }
        ...
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): RequiredValidationMap {
            ...
            return RequiredValidationMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): RequiredValidationMap {
            val pathSet: MutableSet<List<Any>> = HashSet()
            val pathToItem = listOf<Any>("args[0")
            val castArg = castToAllowedTypes(arg, pathToItem, pathSet)
            val usedConfiguration = configuration ?: SchemaConfiguration(JsonSchemaKeywordFlags.Builder().build())
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RequiredValidation1BoxedVoid {
            return RequiredValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RequiredValidation1BoxedBoolean {
            return RequiredValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RequiredValidation1BoxedNumber {
            return RequiredValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RequiredValidation1BoxedString {
            return RequiredValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RequiredValidation1BoxedList {
            return RequiredValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RequiredValidation1BoxedMap {
            return RequiredValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RequiredValidation1Boxed {
            if (arg == null) {
