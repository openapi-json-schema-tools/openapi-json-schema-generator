...
class ValidateAgainstCorrectBranchThenVsElse {
    ...
    sealed interface ValidateAgainstCorrectBranchThenVsElse1Boxed {
        fun getData(): Any?
    }
    
    data class ValidateAgainstCorrectBranchThenVsElse1BoxedVoid(val data: Nothing?) : ValidateAgainstCorrectBranchThenVsElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ValidateAgainstCorrectBranchThenVsElse1BoxedBoolean(val data: Boolean): ValidateAgainstCorrectBranchThenVsElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ValidateAgainstCorrectBranchThenVsElse1BoxedNumber(val data: Number) : ValidateAgainstCorrectBranchThenVsElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ValidateAgainstCorrectBranchThenVsElse1BoxedString(val data: String) : ValidateAgainstCorrectBranchThenVsElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ValidateAgainstCorrectBranchThenVsElse1BoxedList(val data: FrozenList<Any?>) : ValidateAgainstCorrectBranchThenVsElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ValidateAgainstCorrectBranchThenVsElse1BoxedMap(val data: FrozenMap<Any?>) : ValidateAgainstCorrectBranchThenVsElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class ValidateAgainstCorrectBranchThenVsElse1 private constructor(): JsonSchema<ValidateAgainstCorrectBranchThenVsElse1Boxed>(
        JsonSchemaInfo()
            .ifSchema(IfSchema::class.java)
            .then(Then::class.java)
            .elseSchema(ElseSchema::class.java)
    ), NullSchemaValidator<ValidateAgainstCorrectBranchThenVsElse1BoxedVoid>, BooleanSchemaValidator<ValidateAgainstCorrectBranchThenVsElse1BoxedBoolean>, NumberSchemaValidator<ValidateAgainstCorrectBranchThenVsElse1BoxedNumber>, StringSchemaValidator<ValidateAgainstCorrectBranchThenVsElse1BoxedString>, ListSchemaValidator<FrozenList<Any?>, ValidateAgainstCorrectBranchThenVsElse1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, ValidateAgainstCorrectBranchThenVsElse1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: ValidateAgainstCorrectBranchThenVsElse1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: ValidateAgainstCorrectBranchThenVsElse1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): ValidateAgainstCorrectBranchThenVsElse1BoxedVoid {
            return ValidateAgainstCorrectBranchThenVsElse1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): ValidateAgainstCorrectBranchThenVsElse1BoxedBoolean {
            return ValidateAgainstCorrectBranchThenVsElse1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): ValidateAgainstCorrectBranchThenVsElse1BoxedNumber {
            return ValidateAgainstCorrectBranchThenVsElse1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): ValidateAgainstCorrectBranchThenVsElse1BoxedString {
            return ValidateAgainstCorrectBranchThenVsElse1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): ValidateAgainstCorrectBranchThenVsElse1BoxedList {
            return ValidateAgainstCorrectBranchThenVsElse1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): ValidateAgainstCorrectBranchThenVsElse1BoxedMap {
            return ValidateAgainstCorrectBranchThenVsElse1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): ValidateAgainstCorrectBranchThenVsElse1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
