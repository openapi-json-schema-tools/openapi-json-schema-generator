...
class EmptyDependents {
    // nest classes so all schemas and input/output classes can be public
    
    
    sealed interface EmptyDependents1Boxed {
        fun getData(): Any?
    }
    
    data class EmptyDependents1BoxedVoid(val data: Nothing?) : EmptyDependents1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmptyDependents1BoxedBoolean(val data: Boolean): EmptyDependents1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmptyDependents1BoxedNumber(val data: Number) : EmptyDependents1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmptyDependents1BoxedString(val data: String) : EmptyDependents1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmptyDependents1BoxedList(val data: FrozenList<Any?>) : EmptyDependents1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class EmptyDependents1BoxedMap(val data: FrozenMap<Any?>) : EmptyDependents1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class EmptyDependents1 private constructor(): JsonSchema<EmptyDependents1Boxed>(
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: EmptyDependents1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: EmptyDependents1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): EmptyDependents1BoxedVoid {
            return EmptyDependents1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): EmptyDependents1BoxedBoolean {
            return EmptyDependents1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): EmptyDependents1BoxedNumber {
            return EmptyDependents1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): EmptyDependents1BoxedString {
            return EmptyDependents1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): EmptyDependents1BoxedList {
            return EmptyDependents1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): EmptyDependents1BoxedMap {
            return EmptyDependents1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): EmptyDependents1Boxed {
            if (arg == null) {
