...
class RequiredWithEmptyArray {
    ...
    class RequiredWithEmptyArrayMap(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        companion object {
            ...
            fun of(arg: Map<String, Any?>, configuration: SchemaConfiguration): RequiredWithEmptyArrayMap {
    ...
    class RequiredWithEmptyArrayMapBuilder: UnsetAddPropsSetter<RequiredWithEmptyArrayMapBuilder>, GenericBuilder<Map<String, Any?>>, SetterForFoo<RequiredWithEmptyArrayMapBuilder> {
        ...
        override fun getBuilderAfterFoo(instance: MutableMap<String, Any?>): RequiredWithEmptyArrayMapBuilder {
            return this
        }
        override fun getBuilderAfterAdditionalProperty(instance: MutableMap<String, Any?>): RequiredWithEmptyArrayMapBuilder  {
            return this
        }
    }
    ...
    data class RequiredWithEmptyArray1BoxedVoid(val data: Nothing?) : RequiredWithEmptyArray1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredWithEmptyArray1BoxedBoolean(val data: Boolean): RequiredWithEmptyArray1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredWithEmptyArray1BoxedNumber(val data: Number) : RequiredWithEmptyArray1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredWithEmptyArray1BoxedString(val data: String) : RequiredWithEmptyArray1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredWithEmptyArray1BoxedList(val data: FrozenList<Any?>) : RequiredWithEmptyArray1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RequiredWithEmptyArray1BoxedMap(val data: RequiredWithEmptyArrayMap) : RequiredWithEmptyArray1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RequiredWithEmptyArray1 private constructor(): JsonSchema<RequiredWithEmptyArray1Boxed>(
        properties = mapOf(
            "foo" to Foo::class.java
        ),
    ), NullSchemaValidator<RequiredWithEmptyArray1BoxedVoid>, BooleanSchemaValidator<RequiredWithEmptyArray1BoxedBoolean>, NumberSchemaValidator<RequiredWithEmptyArray1BoxedNumber>, StringSchemaValidator<RequiredWithEmptyArray1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RequiredWithEmptyArray1BoxedList>, MapSchemaValidator<RequiredWithEmptyArrayMap, RequiredWithEmptyArray1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RequiredWithEmptyArray1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RequiredWithEmptyArray1().also { instance = it }
                }
        }
        ...
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): RequiredWithEmptyArrayMap {
            ...
            return RequiredWithEmptyArrayMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): RequiredWithEmptyArrayMap {
            val pathSet: MutableSet<List<Any>> = HashSet()
            val pathToItem = listOf<Any>("args[0")
            val castArg = castToAllowedTypes(arg, pathToItem, pathSet)
            val usedConfiguration = configuration ?: SchemaConfiguration(JsonSchemaKeywordFlags.Builder().build())
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RequiredWithEmptyArray1BoxedVoid {
            return RequiredWithEmptyArray1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RequiredWithEmptyArray1BoxedBoolean {
            return RequiredWithEmptyArray1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RequiredWithEmptyArray1BoxedNumber {
            return RequiredWithEmptyArray1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RequiredWithEmptyArray1BoxedString {
            return RequiredWithEmptyArray1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RequiredWithEmptyArray1BoxedList {
            return RequiredWithEmptyArray1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RequiredWithEmptyArray1BoxedMap {
            return RequiredWithEmptyArray1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RequiredWithEmptyArray1Boxed {
            if (arg == null) {
