...
class ContainsWithNullInstanceElements {
    // nest classes so all schemas and input/output classes can be public
    
    
    class Contains : NullJsonSchema.NullJsonSchema1() {
        companion object {
            @Volatile
    ...
    sealed interface ContainsWithNullInstanceElements1Boxed {
        fun getData(): Any?
    }
    
    data class ContainsWithNullInstanceElements1BoxedVoid(val data: Nothing?) : ContainsWithNullInstanceElements1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ContainsWithNullInstanceElements1BoxedBoolean(val data: Boolean): ContainsWithNullInstanceElements1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ContainsWithNullInstanceElements1BoxedNumber(val data: Number) : ContainsWithNullInstanceElements1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ContainsWithNullInstanceElements1BoxedString(val data: String) : ContainsWithNullInstanceElements1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ContainsWithNullInstanceElements1BoxedList(val data: FrozenList<Any?>) : ContainsWithNullInstanceElements1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ContainsWithNullInstanceElements1BoxedMap(val data: FrozenMap<Any?>) : ContainsWithNullInstanceElements1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class ContainsWithNullInstanceElements1 private constructor(): JsonSchema<ContainsWithNullInstanceElements1Boxed>(
        contains = Contains::class.java,
    ), NullSchemaValidator<ContainsWithNullInstanceElements1BoxedVoid>, BooleanSchemaValidator<ContainsWithNullInstanceElements1BoxedBoolean>, NumberSchemaValidator<ContainsWithNullInstanceElements1BoxedNumber>, StringSchemaValidator<ContainsWithNullInstanceElements1BoxedString>, ListSchemaValidator<FrozenList<Any?>, ContainsWithNullInstanceElements1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, ContainsWithNullInstanceElements1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: ContainsWithNullInstanceElements1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: ContainsWithNullInstanceElements1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): ContainsWithNullInstanceElements1BoxedVoid {
            return ContainsWithNullInstanceElements1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): ContainsWithNullInstanceElements1BoxedBoolean {
            return ContainsWithNullInstanceElements1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): ContainsWithNullInstanceElements1BoxedNumber {
            return ContainsWithNullInstanceElements1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): ContainsWithNullInstanceElements1BoxedString {
            return ContainsWithNullInstanceElements1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): ContainsWithNullInstanceElements1BoxedList {
            return ContainsWithNullInstanceElements1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): ContainsWithNullInstanceElements1BoxedMap {
            return ContainsWithNullInstanceElements1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): ContainsWithNullInstanceElements1Boxed {
            if (arg == null) {
