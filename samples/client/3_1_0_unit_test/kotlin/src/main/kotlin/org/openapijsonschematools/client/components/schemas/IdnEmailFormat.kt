...
class IdnEmailFormat {
    ...
    sealed interface IdnEmailFormat1Boxed {
        fun getData(): Any?
    }
    
    data class IdnEmailFormat1BoxedVoid(val data: Nothing?) : IdnEmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnEmailFormat1BoxedBoolean(val data: Boolean): IdnEmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnEmailFormat1BoxedNumber(val data: Number) : IdnEmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnEmailFormat1BoxedString(val data: String) : IdnEmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnEmailFormat1BoxedList(val data: FrozenList<Any?>) : IdnEmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IdnEmailFormat1BoxedMap(val data: FrozenMap<Any?>) : IdnEmailFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IdnEmailFormat1 private constructor(): JsonSchema<IdnEmailFormat1Boxed>(
        format = "idn-email",
    ), NullSchemaValidator<IdnEmailFormat1BoxedVoid>, BooleanSchemaValidator<IdnEmailFormat1BoxedBoolean>, NumberSchemaValidator<IdnEmailFormat1BoxedNumber>, StringSchemaValidator<IdnEmailFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IdnEmailFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IdnEmailFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IdnEmailFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IdnEmailFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IdnEmailFormat1BoxedVoid {
            return IdnEmailFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IdnEmailFormat1BoxedBoolean {
            return IdnEmailFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IdnEmailFormat1BoxedNumber {
            return IdnEmailFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IdnEmailFormat1BoxedString {
            return IdnEmailFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IdnEmailFormat1BoxedList {
            return IdnEmailFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IdnEmailFormat1BoxedMap {
            return IdnEmailFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IdnEmailFormat1Boxed {
            if (arg == null) {
