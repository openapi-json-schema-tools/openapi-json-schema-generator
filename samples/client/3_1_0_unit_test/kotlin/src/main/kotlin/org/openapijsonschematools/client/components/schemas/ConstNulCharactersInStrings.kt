...
class ConstNulCharactersInStrings {
    ...
    enum class StringConstNulCharactersInStringsConst(private val value: String): StringValueMethod {
    ...
    sealed interface ConstNulCharactersInStrings1Boxed {
        fun getData(): Any?
    }
    
    data class ConstNulCharactersInStrings1BoxedVoid(val data: Nothing?) : ConstNulCharactersInStrings1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ConstNulCharactersInStrings1BoxedBoolean(val data: Boolean): ConstNulCharactersInStrings1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ConstNulCharactersInStrings1BoxedNumber(val data: Number) : ConstNulCharactersInStrings1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ConstNulCharactersInStrings1BoxedString(val data: String) : ConstNulCharactersInStrings1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ConstNulCharactersInStrings1BoxedList(val data: FrozenList<Any?>) : ConstNulCharactersInStrings1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ConstNulCharactersInStrings1BoxedMap(val data: FrozenMap<Any?>) : ConstNulCharactersInStrings1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class ConstNulCharactersInStrings1 private constructor(): JsonSchema<ConstNulCharactersInStrings1Boxed>(
        JsonSchemaInfo()
            .constValue(JsonValue.of("hello\u0000there"))
    ), NullSchemaValidator<ConstNulCharactersInStrings1BoxedVoid>, BooleanSchemaValidator<ConstNulCharactersInStrings1BoxedBoolean>, NumberSchemaValidator<ConstNulCharactersInStrings1BoxedNumber>, StringSchemaValidator<ConstNulCharactersInStrings1BoxedString>, ListSchemaValidator<FrozenList<Any?>, ConstNulCharactersInStrings1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, ConstNulCharactersInStrings1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: ConstNulCharactersInStrings1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: ConstNulCharactersInStrings1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): ConstNulCharactersInStrings1BoxedVoid {
            return ConstNulCharactersInStrings1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): ConstNulCharactersInStrings1BoxedBoolean {
            return ConstNulCharactersInStrings1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): ConstNulCharactersInStrings1BoxedNumber {
            return ConstNulCharactersInStrings1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): ConstNulCharactersInStrings1BoxedString {
            return ConstNulCharactersInStrings1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): ConstNulCharactersInStrings1BoxedList {
            return ConstNulCharactersInStrings1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): ConstNulCharactersInStrings1BoxedMap {
            return ConstNulCharactersInStrings1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): ConstNulCharactersInStrings1Boxed {
            if (arg == null) {
