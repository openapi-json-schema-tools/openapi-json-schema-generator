...
class IfAndThenWithoutElse {
    ...
    sealed interface IfAndThenWithoutElse1Boxed {
        fun getData(): Any?
    }
    
    data class IfAndThenWithoutElse1BoxedVoid(val data: Nothing?) : IfAndThenWithoutElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAndThenWithoutElse1BoxedBoolean(val data: Boolean): IfAndThenWithoutElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAndThenWithoutElse1BoxedNumber(val data: Number) : IfAndThenWithoutElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAndThenWithoutElse1BoxedString(val data: String) : IfAndThenWithoutElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAndThenWithoutElse1BoxedList(val data: FrozenList<Any?>) : IfAndThenWithoutElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAndThenWithoutElse1BoxedMap(val data: FrozenMap<Any?>) : IfAndThenWithoutElse1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IfAndThenWithoutElse1 private constructor(): JsonSchema<IfAndThenWithoutElse1Boxed>(
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IfAndThenWithoutElse1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IfAndThenWithoutElse1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IfAndThenWithoutElse1BoxedVoid {
            return IfAndThenWithoutElse1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IfAndThenWithoutElse1BoxedBoolean {
            return IfAndThenWithoutElse1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IfAndThenWithoutElse1BoxedNumber {
            return IfAndThenWithoutElse1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IfAndThenWithoutElse1BoxedString {
            return IfAndThenWithoutElse1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IfAndThenWithoutElse1BoxedList {
            return IfAndThenWithoutElse1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IfAndThenWithoutElse1BoxedMap {
            return IfAndThenWithoutElse1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IfAndThenWithoutElse1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
