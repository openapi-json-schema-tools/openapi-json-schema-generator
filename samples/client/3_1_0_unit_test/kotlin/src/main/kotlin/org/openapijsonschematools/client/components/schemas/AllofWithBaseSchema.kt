...
class AllofWithBaseSchema {
    ...
    class Schema0MapBuilder: SetterForFoo<Schema0Map0Builder> {
        ...
        override fun getBuilderAfterFoo(instance: MutableMap<String, Any?>): Schema0Map0Builder {
    ...
    class Baz : NullJsonSchema.NullJsonSchema1() {
        companion object {
            @Volatile
            private var instance: Baz? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Baz().also { instance = it }
                }
        }
    }
    ...
    class Schema1Map(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        ...
        fun baz(): Nothing? {
            val value: Any? = get("baz")
            if (!(value == null || value is Nothing?)) {
                throw RuntimeException("Invalid value stored for baz")
            }
            return value
        }
    ...
    class Schema1MapBuilder: SetterForBaz<Schema1Map0Builder> {
        private val instance: MutableMap<String, Any?>
        init {
            this.instance = LinkedHashMap()
        }
        ...
        override fun getBuilderAfterBaz(instance: MutableMap<String, Any?>): Schema1Map0Builder {
    ...
    class AllofWithBaseSchemaMap(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        companion object {
            val requiredKeys: Set<String> = setOf(
                "bar"
            )
            val optionalKeys: Set<String> = setOf()
            @Throws(ValidationException::class)
            fun of(arg: Map<String, Any?>, configuration: SchemaConfiguration): AllofWithBaseSchemaMap {
    ...
    class AllofWithBaseSchemaMap0Builder(private val instance: MutableMap<String, Any?>): UnsetAddPropsSetter<AllofWithBaseSchemaMap0Builder>, GenericBuilder<Map<String, Any?>> {
        private val knownKeys: Set<String> = setOf(
            "bar"
        )
        override fun getKnownKeys(): Set<String> {
        ...
        override fun getBuilderAfterAdditionalProperty(instance: MutableMap<String, Any?>): AllofWithBaseSchemaMap0Builder  {
            return this
        }
    }
    
    class AllofWithBaseSchemaMapBuilder: SetterForBar<AllofWithBaseSchemaMap0Builder> {
        private val instance: MutableMap<String, Any?>
        init {
            this.instance = LinkedHashMap()
        }
        ...
        override fun getBuilderAfterBar(instance: MutableMap<String, Any?>): AllofWithBaseSchemaMap0Builder {
    ...
    data class AllofWithBaseSchema1BoxedVoid(val data: Nothing?) : AllofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithBaseSchema1BoxedBoolean(val data: Boolean): AllofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithBaseSchema1BoxedNumber(val data: Number) : AllofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithBaseSchema1BoxedString(val data: String) : AllofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithBaseSchema1BoxedList(val data: FrozenList<Any?>) : AllofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithBaseSchema1BoxedMap(val data: AllofWithBaseSchemaMap) : AllofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AllofWithBaseSchema1 private constructor(): JsonSchema<AllofWithBaseSchema1Boxed>(
        JsonSchemaInfo()
            .properties(mapOf(
    ...
    ), NullSchemaValidator<AllofWithBaseSchema1BoxedVoid>, BooleanSchemaValidator<AllofWithBaseSchema1BoxedBoolean>, NumberSchemaValidator<AllofWithBaseSchema1BoxedNumber>, StringSchemaValidator<AllofWithBaseSchema1BoxedString>, ListSchemaValidator<FrozenList<Any?>, AllofWithBaseSchema1BoxedList>, MapSchemaValidator<AllofWithBaseSchemaMap, AllofWithBaseSchema1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AllofWithBaseSchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AllofWithBaseSchema1().also { instance = it }
                }
        }
        ...
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): AllofWithBaseSchemaMap {
            val properties: LinkedHashMap<String, Any?> = LinkedHashMap()
            for((propertyName, value) in arg) {
                if (!(propertyName is String)) {
                    throw RuntimeException("Invalid non-string key value")
            ...
            val castProperties: FrozenMap<Any?> = FrozenMap(properties)
            return AllofWithBaseSchemaMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): AllofWithBaseSchemaMap {
            val pathSet: MutableSet<List<Any>> = HashSet()
            val pathToItem = listOf<Any>("args[0")
            val castArg = castToAllowedTypes(arg, pathToItem, pathSet)
            val usedConfiguration = configuration ?: SchemaConfiguration(JsonSchemaKeywordFlags.Builder().build())
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): AllofWithBaseSchema1BoxedVoid {
            return AllofWithBaseSchema1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): AllofWithBaseSchema1BoxedBoolean {
            return AllofWithBaseSchema1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): AllofWithBaseSchema1BoxedNumber {
            return AllofWithBaseSchema1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AllofWithBaseSchema1BoxedString {
            return AllofWithBaseSchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): AllofWithBaseSchema1BoxedList {
            return AllofWithBaseSchema1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AllofWithBaseSchema1BoxedMap {
            return AllofWithBaseSchema1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AllofWithBaseSchema1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
