...
class Ipv6Format {
    ...
    data class Ipv6Format1BoxedVoid(val data: Nothing?) : Ipv6Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv6Format1BoxedBoolean(val data: Boolean): Ipv6Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv6Format1BoxedNumber(val data: Number) : Ipv6Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv6Format1BoxedString(val data: String) : Ipv6Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv6Format1BoxedList(val data: FrozenList<Any?>) : Ipv6Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv6Format1BoxedMap(val data: FrozenMap<Any?>) : Ipv6Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class Ipv6Format1 private constructor(): JsonSchema<Ipv6Format1Boxed>(
        format = "ipv6",
    ), NullSchemaValidator<Ipv6Format1BoxedVoid>, BooleanSchemaValidator<Ipv6Format1BoxedBoolean>, NumberSchemaValidator<Ipv6Format1BoxedNumber>, StringSchemaValidator<Ipv6Format1BoxedString>, ListSchemaValidator<FrozenList<Any?>, Ipv6Format1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, Ipv6Format1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: Ipv6Format1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Ipv6Format1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): Ipv6Format1BoxedVoid {
            return Ipv6Format1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): Ipv6Format1BoxedBoolean {
            return Ipv6Format1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): Ipv6Format1BoxedNumber {
            return Ipv6Format1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): Ipv6Format1BoxedString {
            return Ipv6Format1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): Ipv6Format1BoxedList {
            return Ipv6Format1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): Ipv6Format1BoxedMap {
            return Ipv6Format1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): Ipv6Format1Boxed {
            if (arg == null) {
