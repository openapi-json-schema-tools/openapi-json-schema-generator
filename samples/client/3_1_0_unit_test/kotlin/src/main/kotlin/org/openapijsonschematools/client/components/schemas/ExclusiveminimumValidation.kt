...
class ExclusiveminimumValidation {
    // nest classes so all schemas and input/output classes can be public
    
    
    sealed interface ExclusiveminimumValidation1Boxed {
        fun getData(): Any?
    }
    
    data class ExclusiveminimumValidation1BoxedVoid(val data: Nothing?) : ExclusiveminimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusiveminimumValidation1BoxedBoolean(val data: Boolean): ExclusiveminimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusiveminimumValidation1BoxedNumber(val data: Number) : ExclusiveminimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusiveminimumValidation1BoxedString(val data: String) : ExclusiveminimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusiveminimumValidation1BoxedList(val data: FrozenList<Any?>) : ExclusiveminimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusiveminimumValidation1BoxedMap(val data: FrozenMap<Any?>) : ExclusiveminimumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class ExclusiveminimumValidation1 private constructor(): JsonSchema<ExclusiveminimumValidation1Boxed>(
        JsonSchemaInfo()
            .exclusiveMinimum(1.1)
    ), NullSchemaValidator<ExclusiveminimumValidation1BoxedVoid>, BooleanSchemaValidator<ExclusiveminimumValidation1BoxedBoolean>, NumberSchemaValidator<ExclusiveminimumValidation1BoxedNumber>, StringSchemaValidator<ExclusiveminimumValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, ExclusiveminimumValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, ExclusiveminimumValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: ExclusiveminimumValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: ExclusiveminimumValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): ExclusiveminimumValidation1BoxedVoid {
            return ExclusiveminimumValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): ExclusiveminimumValidation1BoxedBoolean {
            return ExclusiveminimumValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): ExclusiveminimumValidation1BoxedNumber {
            return ExclusiveminimumValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): ExclusiveminimumValidation1BoxedString {
            return ExclusiveminimumValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): ExclusiveminimumValidation1BoxedList {
            return ExclusiveminimumValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): ExclusiveminimumValidation1BoxedMap {
            return ExclusiveminimumValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): ExclusiveminimumValidation1Boxed {
            if (arg == null) {
