...
class OneofWithEmptySchema {
    ...
    data class OneofWithEmptySchema1BoxedVoid(val data: Nothing?) : OneofWithEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class OneofWithEmptySchema1BoxedBoolean(val data: Boolean): OneofWithEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class OneofWithEmptySchema1BoxedNumber(val data: Number) : OneofWithEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class OneofWithEmptySchema1BoxedString(val data: String) : OneofWithEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class OneofWithEmptySchema1BoxedList(val data: FrozenList<Any?>) : OneofWithEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class OneofWithEmptySchema1BoxedMap(val data: FrozenMap<Any?>) : OneofWithEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class OneofWithEmptySchema1 private constructor(): JsonSchema<OneofWithEmptySchema1Boxed>(
        oneOf = listOf(
            Schema0::class.java,
            Schema1::class.java
        ),
    ), NullSchemaValidator<OneofWithEmptySchema1BoxedVoid>, BooleanSchemaValidator<OneofWithEmptySchema1BoxedBoolean>, NumberSchemaValidator<OneofWithEmptySchema1BoxedNumber>, StringSchemaValidator<OneofWithEmptySchema1BoxedString>, ListSchemaValidator<FrozenList<Any?>, OneofWithEmptySchema1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, OneofWithEmptySchema1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: OneofWithEmptySchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: OneofWithEmptySchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): OneofWithEmptySchema1BoxedVoid {
            return OneofWithEmptySchema1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): OneofWithEmptySchema1BoxedBoolean {
            return OneofWithEmptySchema1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): OneofWithEmptySchema1BoxedNumber {
            return OneofWithEmptySchema1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): OneofWithEmptySchema1BoxedString {
            return OneofWithEmptySchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): OneofWithEmptySchema1BoxedList {
            return OneofWithEmptySchema1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): OneofWithEmptySchema1BoxedMap {
            return OneofWithEmptySchema1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): OneofWithEmptySchema1Boxed {
            if (arg == null) {
