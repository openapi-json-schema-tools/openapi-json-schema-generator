...
class JsonPointerFormat {
    ...
    data class JsonPointerFormat1BoxedVoid(val data: Nothing?) : JsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class JsonPointerFormat1BoxedBoolean(val data: Boolean): JsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class JsonPointerFormat1BoxedNumber(val data: Number) : JsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class JsonPointerFormat1BoxedString(val data: String) : JsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class JsonPointerFormat1BoxedList(val data: FrozenList<Any?>) : JsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class JsonPointerFormat1BoxedMap(val data: FrozenMap<Any?>) : JsonPointerFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class JsonPointerFormat1 private constructor(): JsonSchema<JsonPointerFormat1Boxed>(
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: JsonPointerFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: JsonPointerFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): JsonPointerFormat1BoxedVoid {
            return JsonPointerFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): JsonPointerFormat1BoxedBoolean {
            return JsonPointerFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): JsonPointerFormat1BoxedNumber {
            return JsonPointerFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): JsonPointerFormat1BoxedString {
            return JsonPointerFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): JsonPointerFormat1BoxedList {
            return JsonPointerFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): JsonPointerFormat1BoxedMap {
            return JsonPointerFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): JsonPointerFormat1Boxed {
            if (arg == null) {
