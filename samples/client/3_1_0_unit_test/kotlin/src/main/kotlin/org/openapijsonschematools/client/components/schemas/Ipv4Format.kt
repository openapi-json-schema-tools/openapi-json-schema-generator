...
class Ipv4Format {
    ...
    data class Ipv4Format1BoxedVoid(val data: Nothing?) : Ipv4Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv4Format1BoxedBoolean(val data: Boolean): Ipv4Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv4Format1BoxedNumber(val data: Number) : Ipv4Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv4Format1BoxedString(val data: String) : Ipv4Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv4Format1BoxedList(val data: FrozenList<Any?>) : Ipv4Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Ipv4Format1BoxedMap(val data: FrozenMap<Any?>) : Ipv4Format1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class Ipv4Format1 private constructor(): JsonSchema<Ipv4Format1Boxed>(
        JsonSchemaInfo(
            format = "ipv4",
        )
    ), NullSchemaValidator<Ipv4Format1BoxedVoid>, BooleanSchemaValidator<Ipv4Format1BoxedBoolean>, NumberSchemaValidator<Ipv4Format1BoxedNumber>, StringSchemaValidator<Ipv4Format1BoxedString>, ListSchemaValidator<FrozenList<Any?>, Ipv4Format1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, Ipv4Format1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: Ipv4Format1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Ipv4Format1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): Ipv4Format1BoxedVoid {
            return Ipv4Format1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): Ipv4Format1BoxedBoolean {
            return Ipv4Format1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): Ipv4Format1BoxedNumber {
            return Ipv4Format1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): Ipv4Format1BoxedString {
            return Ipv4Format1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): Ipv4Format1BoxedList {
            return Ipv4Format1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): Ipv4Format1BoxedMap {
            return Ipv4Format1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): Ipv4Format1Boxed {
            if (arg == null) {
