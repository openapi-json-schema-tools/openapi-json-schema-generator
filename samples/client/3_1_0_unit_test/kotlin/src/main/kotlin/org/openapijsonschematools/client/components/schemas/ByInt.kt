...
class ByInt {
    ...
    data class ByInt1BoxedVoid(val data: Nothing?) : ByInt1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByInt1BoxedBoolean(val data: Boolean): ByInt1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByInt1BoxedNumber(val data: Number) : ByInt1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByInt1BoxedString(val data: String) : ByInt1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByInt1BoxedList(val data: FrozenList<Any?>) : ByInt1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ByInt1BoxedMap(val data: FrozenMap<Any?>) : ByInt1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class ByInt1 private constructor(): JsonSchema<ByInt1Boxed>(
        JsonSchemaInfo()
            .multipleOf(BigDecimal("2"))
    ), NullSchemaValidator<ByInt1BoxedVoid>, BooleanSchemaValidator<ByInt1BoxedBoolean>, NumberSchemaValidator<ByInt1BoxedNumber>, StringSchemaValidator<ByInt1BoxedString>, ListSchemaValidator<FrozenList<Any?>, ByInt1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, ByInt1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: ByInt1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: ByInt1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): ByInt1BoxedVoid {
            return ByInt1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): ByInt1BoxedBoolean {
            return ByInt1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): ByInt1BoxedNumber {
            return ByInt1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): ByInt1BoxedString {
            return ByInt1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): ByInt1BoxedList {
            return ByInt1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): ByInt1BoxedMap {
            return ByInt1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): ByInt1Boxed {
            if (arg == null) {
