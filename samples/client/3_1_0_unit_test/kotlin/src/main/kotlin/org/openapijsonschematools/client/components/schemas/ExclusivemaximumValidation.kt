...
class ExclusivemaximumValidation {
    // nest classes so all schemas and input/output classes can be public
    
    
    sealed interface ExclusivemaximumValidation1Boxed {
        fun getData(): Any?
    }
    
    data class ExclusivemaximumValidation1BoxedVoid(val data: Nothing?) : ExclusivemaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusivemaximumValidation1BoxedBoolean(val data: Boolean): ExclusivemaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusivemaximumValidation1BoxedNumber(val data: Number) : ExclusivemaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusivemaximumValidation1BoxedString(val data: String) : ExclusivemaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusivemaximumValidation1BoxedList(val data: FrozenList<Any?>) : ExclusivemaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class ExclusivemaximumValidation1BoxedMap(val data: FrozenMap<Any?>) : ExclusivemaximumValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class ExclusivemaximumValidation1 private constructor(): JsonSchema<ExclusivemaximumValidation1Boxed>(
        exclusiveMaximum = 3.0,
    ), NullSchemaValidator<ExclusivemaximumValidation1BoxedVoid>, BooleanSchemaValidator<ExclusivemaximumValidation1BoxedBoolean>, NumberSchemaValidator<ExclusivemaximumValidation1BoxedNumber>, StringSchemaValidator<ExclusivemaximumValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, ExclusivemaximumValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, ExclusivemaximumValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: ExclusivemaximumValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: ExclusivemaximumValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): ExclusivemaximumValidation1BoxedVoid {
            return ExclusivemaximumValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): ExclusivemaximumValidation1BoxedBoolean {
            return ExclusivemaximumValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): ExclusivemaximumValidation1BoxedNumber {
            return ExclusivemaximumValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): ExclusivemaximumValidation1BoxedString {
            return ExclusivemaximumValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): ExclusivemaximumValidation1BoxedList {
            return ExclusivemaximumValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): ExclusivemaximumValidation1BoxedMap {
            return ExclusivemaximumValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): ExclusivemaximumValidation1Boxed {
            if (arg == null) {
