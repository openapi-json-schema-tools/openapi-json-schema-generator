...
class SmallMultipleOfLargeInteger {
    ...
    sealed interface SmallMultipleOfLargeInteger1Boxed {
        fun getData(): Any?
    }
    
    data class SmallMultipleOfLargeInteger1BoxedNumber(val data: Number) : SmallMultipleOfLargeInteger1Boxed {
    ...
    class SmallMultipleOfLargeInteger1 private constructor(): JsonSchema<SmallMultipleOfLargeInteger1Boxed>(
        JsonSchemaInfo()
            .type(setOf(
                Int::class.java,
                Long::class.java,
            ...
            .format("int")
            .multipleOf(BigDecimal("1.0E-8"))
    ), NumberSchemaValidator<SmallMultipleOfLargeInteger1BoxedNumber> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: SmallMultipleOfLargeInteger1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: SmallMultipleOfLargeInteger1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): SmallMultipleOfLargeInteger1BoxedNumber {
            return SmallMultipleOfLargeInteger1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): SmallMultipleOfLargeInteger1Boxed {
            if (arg is Number) {
