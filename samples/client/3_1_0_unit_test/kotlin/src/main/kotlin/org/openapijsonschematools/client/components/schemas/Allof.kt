...
class Allof {
    ...
    data class Allof1BoxedVoid(val data: Nothing?) : Allof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Allof1BoxedBoolean(val data: Boolean): Allof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Allof1BoxedNumber(val data: Number) : Allof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Allof1BoxedString(val data: String) : Allof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Allof1BoxedList(val data: FrozenList<Any?>) : Allof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Allof1BoxedMap(val data: FrozenMap<Any?>) : Allof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class Allof1 private constructor(): JsonSchema<Allof1Boxed>(
        allOf = listOf(
            Schema0::class.java,
            Schema1::class.java
        ),
    ), NullSchemaValidator<Allof1BoxedVoid>, BooleanSchemaValidator<Allof1BoxedBoolean>, NumberSchemaValidator<Allof1BoxedNumber>, StringSchemaValidator<Allof1BoxedString>, ListSchemaValidator<FrozenList<Any?>, Allof1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, Allof1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: Allof1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Allof1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): Allof1BoxedVoid {
            return Allof1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): Allof1BoxedBoolean {
            return Allof1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): Allof1BoxedNumber {
            return Allof1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): Allof1BoxedString {
            return Allof1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): Allof1BoxedList {
            return Allof1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): Allof1BoxedMap {
            return Allof1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): Allof1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
