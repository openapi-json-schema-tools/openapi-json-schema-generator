...
class PatternpropertiesWithNullValuedInstanceProperties {
    // nest classes so all schemas and input/output classes can be public
    
    
    class Bar : NullJsonSchema.NullJsonSchema1() {
        companion object {
            @Volatile
    ...
    sealed interface PatternpropertiesWithNullValuedInstanceProperties1Boxed {
        fun getData(): Any?
    }
    
    data class PatternpropertiesWithNullValuedInstanceProperties1BoxedVoid(val data: Nothing?) : PatternpropertiesWithNullValuedInstanceProperties1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternpropertiesWithNullValuedInstanceProperties1BoxedBoolean(val data: Boolean): PatternpropertiesWithNullValuedInstanceProperties1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternpropertiesWithNullValuedInstanceProperties1BoxedNumber(val data: Number) : PatternpropertiesWithNullValuedInstanceProperties1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternpropertiesWithNullValuedInstanceProperties1BoxedString(val data: String) : PatternpropertiesWithNullValuedInstanceProperties1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternpropertiesWithNullValuedInstanceProperties1BoxedList(val data: FrozenList<Any?>) : PatternpropertiesWithNullValuedInstanceProperties1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternpropertiesWithNullValuedInstanceProperties1BoxedMap(val data: FrozenMap<Any?>) : PatternpropertiesWithNullValuedInstanceProperties1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class PatternpropertiesWithNullValuedInstanceProperties1 private constructor(): JsonSchema<PatternpropertiesWithNullValuedInstanceProperties1Boxed>(
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: PatternpropertiesWithNullValuedInstanceProperties1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: PatternpropertiesWithNullValuedInstanceProperties1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): PatternpropertiesWithNullValuedInstanceProperties1BoxedVoid {
            return PatternpropertiesWithNullValuedInstanceProperties1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): PatternpropertiesWithNullValuedInstanceProperties1BoxedBoolean {
            return PatternpropertiesWithNullValuedInstanceProperties1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): PatternpropertiesWithNullValuedInstanceProperties1BoxedNumber {
            return PatternpropertiesWithNullValuedInstanceProperties1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): PatternpropertiesWithNullValuedInstanceProperties1BoxedString {
            return PatternpropertiesWithNullValuedInstanceProperties1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): PatternpropertiesWithNullValuedInstanceProperties1BoxedList {
            return PatternpropertiesWithNullValuedInstanceProperties1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): PatternpropertiesWithNullValuedInstanceProperties1BoxedMap {
            return PatternpropertiesWithNullValuedInstanceProperties1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): PatternpropertiesWithNullValuedInstanceProperties1Boxed {
            if (arg == null) {
