...
class MaxlengthValidation {
    ...
    data class MaxlengthValidation1BoxedVoid(val data: Nothing?) : MaxlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxlengthValidation1BoxedBoolean(val data: Boolean): MaxlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxlengthValidation1BoxedNumber(val data: Number) : MaxlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxlengthValidation1BoxedString(val data: String) : MaxlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxlengthValidation1BoxedList(val data: FrozenList<Any?>) : MaxlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxlengthValidation1BoxedMap(val data: FrozenMap<Any?>) : MaxlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MaxlengthValidation1 private constructor(): JsonSchema<MaxlengthValidation1Boxed>(
        maxLength = 2,
    ), NullSchemaValidator<MaxlengthValidation1BoxedVoid>, BooleanSchemaValidator<MaxlengthValidation1BoxedBoolean>, NumberSchemaValidator<MaxlengthValidation1BoxedNumber>, StringSchemaValidator<MaxlengthValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MaxlengthValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MaxlengthValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MaxlengthValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MaxlengthValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MaxlengthValidation1BoxedVoid {
            return MaxlengthValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MaxlengthValidation1BoxedBoolean {
            return MaxlengthValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MaxlengthValidation1BoxedNumber {
            return MaxlengthValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MaxlengthValidation1BoxedString {
            return MaxlengthValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MaxlengthValidation1BoxedList {
            return MaxlengthValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MaxlengthValidation1BoxedMap {
            return MaxlengthValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MaxlengthValidation1Boxed {
            if (arg == null) {
