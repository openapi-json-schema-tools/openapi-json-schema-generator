...
class IgnoreElseWithoutIf {
    ...
    sealed interface IgnoreElseWithoutIf1Boxed {
        fun getData(): Any?
    }
    
    data class IgnoreElseWithoutIf1BoxedVoid(val data: Nothing?) : IgnoreElseWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreElseWithoutIf1BoxedBoolean(val data: Boolean): IgnoreElseWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreElseWithoutIf1BoxedNumber(val data: Number) : IgnoreElseWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreElseWithoutIf1BoxedString(val data: String) : IgnoreElseWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreElseWithoutIf1BoxedList(val data: FrozenList<Any?>) : IgnoreElseWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IgnoreElseWithoutIf1BoxedMap(val data: FrozenMap<Any?>) : IgnoreElseWithoutIf1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IgnoreElseWithoutIf1 private constructor(): JsonSchema<IgnoreElseWithoutIf1Boxed>(
        JsonSchemaInfo(
            elseSchema = ElseSchema::class.java,
        )
    ), NullSchemaValidator<IgnoreElseWithoutIf1BoxedVoid>, BooleanSchemaValidator<IgnoreElseWithoutIf1BoxedBoolean>, NumberSchemaValidator<IgnoreElseWithoutIf1BoxedNumber>, StringSchemaValidator<IgnoreElseWithoutIf1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IgnoreElseWithoutIf1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IgnoreElseWithoutIf1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IgnoreElseWithoutIf1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IgnoreElseWithoutIf1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IgnoreElseWithoutIf1BoxedVoid {
            return IgnoreElseWithoutIf1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IgnoreElseWithoutIf1BoxedBoolean {
            return IgnoreElseWithoutIf1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IgnoreElseWithoutIf1BoxedNumber {
            return IgnoreElseWithoutIf1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IgnoreElseWithoutIf1BoxedString {
            return IgnoreElseWithoutIf1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IgnoreElseWithoutIf1BoxedList {
            return IgnoreElseWithoutIf1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IgnoreElseWithoutIf1BoxedMap {
            return IgnoreElseWithoutIf1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IgnoreElseWithoutIf1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
