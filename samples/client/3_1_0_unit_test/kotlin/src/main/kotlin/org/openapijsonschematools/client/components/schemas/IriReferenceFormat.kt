...
class IriReferenceFormat {
    ...
    sealed interface IriReferenceFormat1Boxed {
        fun getData(): Any?
    }
    
    data class IriReferenceFormat1BoxedVoid(val data: Nothing?) : IriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriReferenceFormat1BoxedBoolean(val data: Boolean): IriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriReferenceFormat1BoxedNumber(val data: Number) : IriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriReferenceFormat1BoxedString(val data: String) : IriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriReferenceFormat1BoxedList(val data: FrozenList<Any?>) : IriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriReferenceFormat1BoxedMap(val data: FrozenMap<Any?>) : IriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IriReferenceFormat1 private constructor(): JsonSchema<IriReferenceFormat1Boxed>(
        format = "iri-reference",
    ), NullSchemaValidator<IriReferenceFormat1BoxedVoid>, BooleanSchemaValidator<IriReferenceFormat1BoxedBoolean>, NumberSchemaValidator<IriReferenceFormat1BoxedNumber>, StringSchemaValidator<IriReferenceFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IriReferenceFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IriReferenceFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IriReferenceFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IriReferenceFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IriReferenceFormat1BoxedVoid {
            return IriReferenceFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IriReferenceFormat1BoxedBoolean {
            return IriReferenceFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IriReferenceFormat1BoxedNumber {
            return IriReferenceFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IriReferenceFormat1BoxedString {
            return IriReferenceFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IriReferenceFormat1BoxedList {
            return IriReferenceFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IriReferenceFormat1BoxedMap {
            return IriReferenceFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IriReferenceFormat1Boxed {
            if (arg == null) {
