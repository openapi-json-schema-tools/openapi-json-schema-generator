...
class BySmallNumber {
    ...
    data class BySmallNumber1BoxedVoid(val data: Nothing?) : BySmallNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class BySmallNumber1BoxedBoolean(val data: Boolean): BySmallNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class BySmallNumber1BoxedNumber(val data: Number) : BySmallNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class BySmallNumber1BoxedString(val data: String) : BySmallNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class BySmallNumber1BoxedList(val data: FrozenList<Any?>) : BySmallNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class BySmallNumber1BoxedMap(val data: FrozenMap<Any?>) : BySmallNumber1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class BySmallNumber1 private constructor(): JsonSchema<BySmallNumber1Boxed>(
        multipleOf = BigDecimal("0.00010"),
    ), NullSchemaValidator<BySmallNumber1BoxedVoid>, BooleanSchemaValidator<BySmallNumber1BoxedBoolean>, NumberSchemaValidator<BySmallNumber1BoxedNumber>, StringSchemaValidator<BySmallNumber1BoxedString>, ListSchemaValidator<FrozenList<Any?>, BySmallNumber1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, BySmallNumber1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: BySmallNumber1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: BySmallNumber1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): BySmallNumber1BoxedVoid {
            return BySmallNumber1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): BySmallNumber1BoxedBoolean {
            return BySmallNumber1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): BySmallNumber1BoxedNumber {
            return BySmallNumber1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): BySmallNumber1BoxedString {
            return BySmallNumber1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): BySmallNumber1BoxedList {
            return BySmallNumber1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): BySmallNumber1BoxedMap {
            return BySmallNumber1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): BySmallNumber1Boxed {
            if (arg == null) {
