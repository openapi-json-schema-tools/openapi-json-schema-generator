...
class UriReferenceFormat {
    ...
    data class UriReferenceFormat1BoxedVoid(val data: Nothing?) : UriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriReferenceFormat1BoxedBoolean(val data: Boolean): UriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriReferenceFormat1BoxedNumber(val data: Number) : UriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriReferenceFormat1BoxedString(val data: String) : UriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriReferenceFormat1BoxedList(val data: FrozenList<Any?>) : UriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriReferenceFormat1BoxedMap(val data: FrozenMap<Any?>) : UriReferenceFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class UriReferenceFormat1 private constructor(): JsonSchema<UriReferenceFormat1Boxed>(
        JsonSchemaInfo()
            .format("uri-reference")
    ), NullSchemaValidator<UriReferenceFormat1BoxedVoid>, BooleanSchemaValidator<UriReferenceFormat1BoxedBoolean>, NumberSchemaValidator<UriReferenceFormat1BoxedNumber>, StringSchemaValidator<UriReferenceFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, UriReferenceFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, UriReferenceFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: UriReferenceFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: UriReferenceFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): UriReferenceFormat1BoxedVoid {
            return UriReferenceFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): UriReferenceFormat1BoxedBoolean {
            return UriReferenceFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): UriReferenceFormat1BoxedNumber {
            return UriReferenceFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): UriReferenceFormat1BoxedString {
            return UriReferenceFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): UriReferenceFormat1BoxedList {
            return UriReferenceFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): UriReferenceFormat1BoxedMap {
            return UriReferenceFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): UriReferenceFormat1Boxed {
            if (arg == null) {
