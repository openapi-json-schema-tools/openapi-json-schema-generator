...
class MinlengthValidation {
    ...
    data class MinlengthValidation1BoxedVoid(val data: Nothing?) : MinlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinlengthValidation1BoxedBoolean(val data: Boolean): MinlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinlengthValidation1BoxedNumber(val data: Number) : MinlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinlengthValidation1BoxedString(val data: String) : MinlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinlengthValidation1BoxedList(val data: FrozenList<Any?>) : MinlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinlengthValidation1BoxedMap(val data: FrozenMap<Any?>) : MinlengthValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MinlengthValidation1 private constructor(): JsonSchema<MinlengthValidation1Boxed>(
        JsonSchemaInfo()
            .minLength(2)
    ), NullSchemaValidator<MinlengthValidation1BoxedVoid>, BooleanSchemaValidator<MinlengthValidation1BoxedBoolean>, NumberSchemaValidator<MinlengthValidation1BoxedNumber>, StringSchemaValidator<MinlengthValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MinlengthValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MinlengthValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MinlengthValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MinlengthValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MinlengthValidation1BoxedVoid {
            return MinlengthValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MinlengthValidation1BoxedBoolean {
            return MinlengthValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MinlengthValidation1BoxedNumber {
            return MinlengthValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MinlengthValidation1BoxedString {
            return MinlengthValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MinlengthValidation1BoxedList {
            return MinlengthValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MinlengthValidation1BoxedMap {
            return MinlengthValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MinlengthValidation1Boxed {
            if (arg == null) {
