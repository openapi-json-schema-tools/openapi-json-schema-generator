...
class DateFormat {
    ...
    sealed interface DateFormat1Boxed {
        fun getData(): Any?
    }
    
    data class DateFormat1BoxedVoid(val data: Nothing?) : DateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateFormat1BoxedBoolean(val data: Boolean): DateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateFormat1BoxedNumber(val data: Number) : DateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateFormat1BoxedString(val data: String) : DateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateFormat1BoxedList(val data: FrozenList<Any?>) : DateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateFormat1BoxedMap(val data: FrozenMap<Any?>) : DateFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class DateFormat1 private constructor(): JsonSchema<DateFormat1Boxed>(
        JsonSchemaInfo()
            .format("date")
    ), NullSchemaValidator<DateFormat1BoxedVoid>, BooleanSchemaValidator<DateFormat1BoxedBoolean>, NumberSchemaValidator<DateFormat1BoxedNumber>, StringSchemaValidator<DateFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, DateFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, DateFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: DateFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: DateFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): DateFormat1BoxedVoid {
            return DateFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): DateFormat1BoxedBoolean {
            return DateFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): DateFormat1BoxedNumber {
            return DateFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): DateFormat1BoxedString {
            return DateFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): DateFormat1BoxedList {
            return DateFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): DateFormat1BoxedMap {
            return DateFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): DateFormat1Boxed {
            if (arg == null) {
