...
class UuidFormat {
    ...
    sealed interface UuidFormat1Boxed {
        fun getData(): Any?
    }
    
    data class UuidFormat1BoxedVoid(val data: Nothing?) : UuidFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UuidFormat1BoxedBoolean(val data: Boolean): UuidFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UuidFormat1BoxedNumber(val data: Number) : UuidFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UuidFormat1BoxedString(val data: String) : UuidFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UuidFormat1BoxedList(val data: FrozenList<Any?>) : UuidFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UuidFormat1BoxedMap(val data: FrozenMap<Any?>) : UuidFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class UuidFormat1 private constructor(): JsonSchema<UuidFormat1Boxed>(
        JsonSchemaInfo()
            .format("uuid")
    ), NullSchemaValidator<UuidFormat1BoxedVoid>, BooleanSchemaValidator<UuidFormat1BoxedBoolean>, NumberSchemaValidator<UuidFormat1BoxedNumber>, StringSchemaValidator<UuidFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, UuidFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, UuidFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: UuidFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: UuidFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): UuidFormat1BoxedVoid {
            return UuidFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): UuidFormat1BoxedBoolean {
            return UuidFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): UuidFormat1BoxedNumber {
            return UuidFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): UuidFormat1BoxedString {
            return UuidFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): UuidFormat1BoxedList {
            return UuidFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): UuidFormat1BoxedMap {
            return UuidFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): UuidFormat1Boxed {
            if (arg == null) {
