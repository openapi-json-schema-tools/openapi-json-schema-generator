...
class UniqueitemsValidation {
    ...
    data class UniqueitemsValidation1BoxedVoid(val data: Nothing?) : UniqueitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsValidation1BoxedBoolean(val data: Boolean): UniqueitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsValidation1BoxedNumber(val data: Number) : UniqueitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsValidation1BoxedString(val data: String) : UniqueitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsValidation1BoxedList(val data: FrozenList<Any?>) : UniqueitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsValidation1BoxedMap(val data: FrozenMap<Any?>) : UniqueitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class UniqueitemsValidation1 private constructor(): JsonSchema<UniqueitemsValidation1Boxed>(
        uniqueItems = true,
    ), NullSchemaValidator<UniqueitemsValidation1BoxedVoid>, BooleanSchemaValidator<UniqueitemsValidation1BoxedBoolean>, NumberSchemaValidator<UniqueitemsValidation1BoxedNumber>, StringSchemaValidator<UniqueitemsValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, UniqueitemsValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, UniqueitemsValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: UniqueitemsValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: UniqueitemsValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): UniqueitemsValidation1BoxedVoid {
            return UniqueitemsValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): UniqueitemsValidation1BoxedBoolean {
            return UniqueitemsValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): UniqueitemsValidation1BoxedNumber {
            return UniqueitemsValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): UniqueitemsValidation1BoxedString {
            return UniqueitemsValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): UniqueitemsValidation1BoxedList {
            return UniqueitemsValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): UniqueitemsValidation1BoxedMap {
            return UniqueitemsValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): UniqueitemsValidation1Boxed {
            if (arg == null) {
