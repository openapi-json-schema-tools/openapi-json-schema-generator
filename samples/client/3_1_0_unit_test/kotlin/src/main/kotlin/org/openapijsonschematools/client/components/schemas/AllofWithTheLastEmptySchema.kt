...
class AllofWithTheLastEmptySchema {
    ...
    class Schema0 : NumberJsonSchema.NumberJsonSchema1() {
        companion object {
            @Volatile
    ...
    data class AllofWithTheLastEmptySchema1BoxedVoid(val data: Nothing?) : AllofWithTheLastEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheLastEmptySchema1BoxedBoolean(val data: Boolean): AllofWithTheLastEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheLastEmptySchema1BoxedNumber(val data: Number) : AllofWithTheLastEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheLastEmptySchema1BoxedString(val data: String) : AllofWithTheLastEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheLastEmptySchema1BoxedList(val data: FrozenList<Any?>) : AllofWithTheLastEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AllofWithTheLastEmptySchema1BoxedMap(val data: FrozenMap<Any?>) : AllofWithTheLastEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AllofWithTheLastEmptySchema1 private constructor(): JsonSchema<AllofWithTheLastEmptySchema1Boxed>(
        JsonSchemaInfo()
            .allOf(listOf(
                Schema0::class.java,
                Schema1::class.java
            ))
    ), NullSchemaValidator<AllofWithTheLastEmptySchema1BoxedVoid>, BooleanSchemaValidator<AllofWithTheLastEmptySchema1BoxedBoolean>, NumberSchemaValidator<AllofWithTheLastEmptySchema1BoxedNumber>, StringSchemaValidator<AllofWithTheLastEmptySchema1BoxedString>, ListSchemaValidator<FrozenList<Any?>, AllofWithTheLastEmptySchema1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, AllofWithTheLastEmptySchema1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AllofWithTheLastEmptySchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AllofWithTheLastEmptySchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): AllofWithTheLastEmptySchema1BoxedVoid {
            return AllofWithTheLastEmptySchema1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): AllofWithTheLastEmptySchema1BoxedBoolean {
            return AllofWithTheLastEmptySchema1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): AllofWithTheLastEmptySchema1BoxedNumber {
            return AllofWithTheLastEmptySchema1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AllofWithTheLastEmptySchema1BoxedString {
            return AllofWithTheLastEmptySchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): AllofWithTheLastEmptySchema1BoxedList {
            return AllofWithTheLastEmptySchema1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AllofWithTheLastEmptySchema1BoxedMap {
            return AllofWithTheLastEmptySchema1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AllofWithTheLastEmptySchema1Boxed {
            if (arg == null) {
