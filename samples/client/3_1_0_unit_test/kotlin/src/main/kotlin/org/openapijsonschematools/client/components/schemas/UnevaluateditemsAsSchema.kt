...
class UnevaluateditemsAsSchema {
    ...
    sealed interface UnevaluateditemsAsSchema1Boxed {
        fun getData(): Any?
    }
    
    data class UnevaluateditemsAsSchema1BoxedVoid(val data: Nothing?) : UnevaluateditemsAsSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UnevaluateditemsAsSchema1BoxedBoolean(val data: Boolean): UnevaluateditemsAsSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UnevaluateditemsAsSchema1BoxedNumber(val data: Number) : UnevaluateditemsAsSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UnevaluateditemsAsSchema1BoxedString(val data: String) : UnevaluateditemsAsSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UnevaluateditemsAsSchema1BoxedList(val data: FrozenList<Any?>) : UnevaluateditemsAsSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UnevaluateditemsAsSchema1BoxedMap(val data: FrozenMap<Any?>) : UnevaluateditemsAsSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class UnevaluateditemsAsSchema1 private constructor(): JsonSchema<UnevaluateditemsAsSchema1Boxed>(
        JsonSchemaInfo()
            .unevaluatedItems(UnevaluatedItems::class.java)
    ), NullSchemaValidator<UnevaluateditemsAsSchema1BoxedVoid>, BooleanSchemaValidator<UnevaluateditemsAsSchema1BoxedBoolean>, NumberSchemaValidator<UnevaluateditemsAsSchema1BoxedNumber>, StringSchemaValidator<UnevaluateditemsAsSchema1BoxedString>, ListSchemaValidator<FrozenList<Any?>, UnevaluateditemsAsSchema1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, UnevaluateditemsAsSchema1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: UnevaluateditemsAsSchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: UnevaluateditemsAsSchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): UnevaluateditemsAsSchema1BoxedVoid {
            return UnevaluateditemsAsSchema1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): UnevaluateditemsAsSchema1BoxedBoolean {
            return UnevaluateditemsAsSchema1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): UnevaluateditemsAsSchema1BoxedNumber {
            return UnevaluateditemsAsSchema1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): UnevaluateditemsAsSchema1BoxedString {
            return UnevaluateditemsAsSchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): UnevaluateditemsAsSchema1BoxedList {
            return UnevaluateditemsAsSchema1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): UnevaluateditemsAsSchema1BoxedMap {
            return UnevaluateditemsAsSchema1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): UnevaluateditemsAsSchema1Boxed {
            if (arg == null) {
