...
class NestedOneofToCheckValidationSemantics {
    ...
    class Schema01 : NullJsonSchema.NullJsonSchema1() {
        companion object {
            @Volatile
    ...
    data class NestedOneofToCheckValidationSemantics1BoxedVoid(val data: Nothing?) : NestedOneofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedOneofToCheckValidationSemantics1BoxedBoolean(val data: Boolean): NestedOneofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedOneofToCheckValidationSemantics1BoxedNumber(val data: Number) : NestedOneofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedOneofToCheckValidationSemantics1BoxedString(val data: String) : NestedOneofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedOneofToCheckValidationSemantics1BoxedList(val data: FrozenList<Any?>) : NestedOneofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class NestedOneofToCheckValidationSemantics1BoxedMap(val data: FrozenMap<Any?>) : NestedOneofToCheckValidationSemantics1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class NestedOneofToCheckValidationSemantics1 private constructor(): JsonSchema<NestedOneofToCheckValidationSemantics1Boxed>(
        JsonSchemaInfo()
            .oneOf(listOf(
                Schema0::class.java
            ))
    ), NullSchemaValidator<NestedOneofToCheckValidationSemantics1BoxedVoid>, BooleanSchemaValidator<NestedOneofToCheckValidationSemantics1BoxedBoolean>, NumberSchemaValidator<NestedOneofToCheckValidationSemantics1BoxedNumber>, StringSchemaValidator<NestedOneofToCheckValidationSemantics1BoxedString>, ListSchemaValidator<FrozenList<Any?>, NestedOneofToCheckValidationSemantics1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, NestedOneofToCheckValidationSemantics1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: NestedOneofToCheckValidationSemantics1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: NestedOneofToCheckValidationSemantics1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): NestedOneofToCheckValidationSemantics1BoxedVoid {
            return NestedOneofToCheckValidationSemantics1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): NestedOneofToCheckValidationSemantics1BoxedBoolean {
            return NestedOneofToCheckValidationSemantics1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): NestedOneofToCheckValidationSemantics1BoxedNumber {
            return NestedOneofToCheckValidationSemantics1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): NestedOneofToCheckValidationSemantics1BoxedString {
            return NestedOneofToCheckValidationSemantics1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): NestedOneofToCheckValidationSemantics1BoxedList {
            return NestedOneofToCheckValidationSemantics1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): NestedOneofToCheckValidationSemantics1BoxedMap {
            return NestedOneofToCheckValidationSemantics1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): NestedOneofToCheckValidationSemantics1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
