...
class UriFormat {
    ...
    data class UriFormat1BoxedVoid(val data: Nothing?) : UriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriFormat1BoxedBoolean(val data: Boolean): UriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriFormat1BoxedNumber(val data: Number) : UriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriFormat1BoxedString(val data: String) : UriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriFormat1BoxedList(val data: FrozenList<Any?>) : UriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UriFormat1BoxedMap(val data: FrozenMap<Any?>) : UriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class UriFormat1 private constructor(): JsonSchema<UriFormat1Boxed>(
        format = "uri",
    ), NullSchemaValidator<UriFormat1BoxedVoid>, BooleanSchemaValidator<UriFormat1BoxedBoolean>, NumberSchemaValidator<UriFormat1BoxedNumber>, StringSchemaValidator<UriFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, UriFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, UriFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: UriFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: UriFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): UriFormat1BoxedVoid {
            return UriFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): UriFormat1BoxedBoolean {
            return UriFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): UriFormat1BoxedNumber {
            return UriFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): UriFormat1BoxedString {
            return UriFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): UriFormat1BoxedList {
            return UriFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): UriFormat1BoxedMap {
            return UriFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): UriFormat1Boxed {
            if (arg == null) {
