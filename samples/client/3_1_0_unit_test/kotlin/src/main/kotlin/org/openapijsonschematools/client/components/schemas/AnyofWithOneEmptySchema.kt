...
class AnyofWithOneEmptySchema {
    ...
    data class AnyofWithOneEmptySchema1BoxedVoid(val data: Nothing?) : AnyofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofWithOneEmptySchema1BoxedBoolean(val data: Boolean): AnyofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofWithOneEmptySchema1BoxedNumber(val data: Number) : AnyofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofWithOneEmptySchema1BoxedString(val data: String) : AnyofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofWithOneEmptySchema1BoxedList(val data: FrozenList<Any?>) : AnyofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AnyofWithOneEmptySchema1BoxedMap(val data: FrozenMap<Any?>) : AnyofWithOneEmptySchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AnyofWithOneEmptySchema1 private constructor(): JsonSchema<AnyofWithOneEmptySchema1Boxed>(
        JsonSchemaInfo()
            .anyOf(listOf(
                Schema0::class.java,
                Schema1::class.java
            ))
    ), NullSchemaValidator<AnyofWithOneEmptySchema1BoxedVoid>, BooleanSchemaValidator<AnyofWithOneEmptySchema1BoxedBoolean>, NumberSchemaValidator<AnyofWithOneEmptySchema1BoxedNumber>, StringSchemaValidator<AnyofWithOneEmptySchema1BoxedString>, ListSchemaValidator<FrozenList<Any?>, AnyofWithOneEmptySchema1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, AnyofWithOneEmptySchema1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AnyofWithOneEmptySchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AnyofWithOneEmptySchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): AnyofWithOneEmptySchema1BoxedVoid {
            return AnyofWithOneEmptySchema1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): AnyofWithOneEmptySchema1BoxedBoolean {
            return AnyofWithOneEmptySchema1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): AnyofWithOneEmptySchema1BoxedNumber {
            return AnyofWithOneEmptySchema1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AnyofWithOneEmptySchema1BoxedString {
            return AnyofWithOneEmptySchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): AnyofWithOneEmptySchema1BoxedList {
            return AnyofWithOneEmptySchema1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AnyofWithOneEmptySchema1BoxedMap {
            return AnyofWithOneEmptySchema1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AnyofWithOneEmptySchema1Boxed {
            if (arg == null) {
