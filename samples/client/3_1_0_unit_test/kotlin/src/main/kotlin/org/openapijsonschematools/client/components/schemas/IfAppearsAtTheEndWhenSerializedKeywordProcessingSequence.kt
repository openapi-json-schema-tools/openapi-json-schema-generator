...
class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence {
    ...
    enum class StringElseConst(private val value: String): StringValueMethod {
        OTHER("other");
    ...
    enum class StringThenConst(private val value: String): StringValueMethod {
        YES("yes");
    ...
    sealed interface IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
        fun getData(): Any?
    }
    
    data class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedVoid(val data: Nothing?) : IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedBoolean(val data: Boolean): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedNumber(val data: Number) : IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedString(val data: String) : IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedList(val data: FrozenList<Any?>) : IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedMap(val data: FrozenMap<Any?>) : IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1 private constructor(): JsonSchema<IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed>(
        JsonSchemaInfo()
            .ifSchema(IfSchema::class.java)
            .then(Then::class.java)
            .elseSchema(ElseSchema::class.java)
    ), NullSchemaValidator<IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedVoid>, BooleanSchemaValidator<IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedBoolean>, NumberSchemaValidator<IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedNumber>, StringSchemaValidator<IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedVoid {
            return IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedBoolean {
            return IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedNumber {
            return IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedString {
            return IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedList {
            return IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedMap {
            return IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IfAppearsAtTheEndWhenSerializedKeywordProcessingSequence1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
