...
class AdditionalpropertiesDoesNotLookInApplicators {
    ...
    class AdditionalpropertiesDoesNotLookInApplicatorsMap(m: FrozenMap<Boolean>) : FrozenMap<Boolean>(m) {
        companion object {
            val requiredKeys: Set<String> = setOf()
            val optionalKeys: Set<String> = setOf()
            @Throws(ValidationException::class)
            fun of(arg: Map<String, Boolean>, configuration: SchemaConfiguration): AdditionalpropertiesDoesNotLookInApplicatorsMap {
                return AdditionalpropertiesDoesNotLookInApplicators1.getInstance().validate(arg, configuration)
            }
        }
    ...
    class AdditionalpropertiesDoesNotLookInApplicatorsMapBuilder: GenericBuilder<Map<String, Boolean>>, SetterForAdditionalProperties<AdditionalpropertiesDoesNotLookInApplicatorsMapBuilder> {
        private val knownKeys: Set<String> = setOf()
        override fun getKnownKeys(): Set<String> {
            return knownKeys
        }
        ...
        override fun getBuilderAfterAdditionalProperty(instance: MutableMap<String, Boolean>): AdditionalpropertiesDoesNotLookInApplicatorsMapBuilder  {
            return this
        }
    }
    ...
    data class AdditionalpropertiesDoesNotLookInApplicators1BoxedVoid(val data: Nothing?) : AdditionalpropertiesDoesNotLookInApplicators1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AdditionalpropertiesDoesNotLookInApplicators1BoxedBoolean(val data: Boolean): AdditionalpropertiesDoesNotLookInApplicators1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AdditionalpropertiesDoesNotLookInApplicators1BoxedNumber(val data: Number) : AdditionalpropertiesDoesNotLookInApplicators1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AdditionalpropertiesDoesNotLookInApplicators1BoxedString(val data: String) : AdditionalpropertiesDoesNotLookInApplicators1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AdditionalpropertiesDoesNotLookInApplicators1BoxedList(val data: FrozenList<Any?>) : AdditionalpropertiesDoesNotLookInApplicators1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class AdditionalpropertiesDoesNotLookInApplicators1BoxedMap(val data: AdditionalpropertiesDoesNotLookInApplicatorsMap) : AdditionalpropertiesDoesNotLookInApplicators1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class AdditionalpropertiesDoesNotLookInApplicators1 private constructor(): JsonSchema<AdditionalpropertiesDoesNotLookInApplicators1Boxed>(
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AdditionalpropertiesDoesNotLookInApplicators1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AdditionalpropertiesDoesNotLookInApplicators1().also { instance = it }
                }
        }
        ...
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): AdditionalpropertiesDoesNotLookInApplicatorsMap {
            ...
            return AdditionalpropertiesDoesNotLookInApplicatorsMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicatorsMap {
            val pathSet: MutableSet<List<Any>> = HashSet()
            val pathToItem = listOf<Any>("args[0")
            val castArg = castToAllowedTypes(arg, pathToItem, pathSet)
            val usedConfiguration = configuration ?: SchemaConfiguration(JsonSchemaKeywordFlags.Builder().build())
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicators1BoxedVoid {
            return AdditionalpropertiesDoesNotLookInApplicators1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicators1BoxedBoolean {
            return AdditionalpropertiesDoesNotLookInApplicators1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicators1BoxedNumber {
            return AdditionalpropertiesDoesNotLookInApplicators1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicators1BoxedString {
            return AdditionalpropertiesDoesNotLookInApplicators1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicators1BoxedList {
            return AdditionalpropertiesDoesNotLookInApplicators1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicators1BoxedMap {
            return AdditionalpropertiesDoesNotLookInApplicators1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AdditionalpropertiesDoesNotLookInApplicators1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
