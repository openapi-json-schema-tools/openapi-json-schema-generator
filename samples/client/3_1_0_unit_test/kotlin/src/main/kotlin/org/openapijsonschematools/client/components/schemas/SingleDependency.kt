...
class SingleDependency {
    ...
    sealed interface SingleDependency1Boxed {
        fun getData(): Any?
    }
    
    data class SingleDependency1BoxedVoid(val data: Nothing?) : SingleDependency1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class SingleDependency1BoxedBoolean(val data: Boolean): SingleDependency1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class SingleDependency1BoxedNumber(val data: Number) : SingleDependency1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class SingleDependency1BoxedString(val data: String) : SingleDependency1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class SingleDependency1BoxedList(val data: FrozenList<Any?>) : SingleDependency1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class SingleDependency1BoxedMap(val data: FrozenMap<Any?>) : SingleDependency1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class SingleDependency1 private constructor(): JsonSchema<SingleDependency1Boxed>(
    ...
    ), NullSchemaValidator<SingleDependency1BoxedVoid>, BooleanSchemaValidator<SingleDependency1BoxedBoolean>, NumberSchemaValidator<SingleDependency1BoxedNumber>, StringSchemaValidator<SingleDependency1BoxedString>, ListSchemaValidator<FrozenList<Any?>, SingleDependency1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, SingleDependency1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: SingleDependency1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: SingleDependency1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): SingleDependency1BoxedVoid {
            return SingleDependency1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): SingleDependency1BoxedBoolean {
            return SingleDependency1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): SingleDependency1BoxedNumber {
            return SingleDependency1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): SingleDependency1BoxedString {
            return SingleDependency1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): SingleDependency1BoxedList {
            return SingleDependency1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): SingleDependency1BoxedMap {
            return SingleDependency1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): SingleDependency1Boxed {
            if (arg == null) {
