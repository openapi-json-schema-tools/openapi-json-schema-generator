...
class ForbiddenProperty {
    ...
    class Not : AnyTypeJsonSchema.AnyTypeJsonSchema1() {
        companion object {
            @Volatile
    ...
    data class FooBoxedVoid(val data: Nothing?) : FooBoxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class FooBoxedBoolean(val data: Boolean): FooBoxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class FooBoxedNumber(val data: Number) : FooBoxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    data class FooBoxedMap(val data: FrozenMap<Any?>) : FooBoxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class Foo private constructor(): JsonSchema<FooBoxed>(
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): FooBoxedVoid {
            return FooBoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): FooBoxedBoolean {
            return FooBoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): FooBoxedNumber {
            return FooBoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): FooBoxedMap {
            return FooBoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
