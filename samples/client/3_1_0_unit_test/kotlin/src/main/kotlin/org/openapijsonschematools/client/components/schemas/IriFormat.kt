...
class IriFormat {
    ...
    sealed interface IriFormat1Boxed {
        fun getData(): Any?
    }
    
    data class IriFormat1BoxedVoid(val data: Nothing?) : IriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriFormat1BoxedBoolean(val data: Boolean): IriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriFormat1BoxedNumber(val data: Number) : IriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriFormat1BoxedString(val data: String) : IriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriFormat1BoxedList(val data: FrozenList<Any?>) : IriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class IriFormat1BoxedMap(val data: FrozenMap<Any?>) : IriFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class IriFormat1 private constructor(): JsonSchema<IriFormat1Boxed>(
        format = "iri",
    ), NullSchemaValidator<IriFormat1BoxedVoid>, BooleanSchemaValidator<IriFormat1BoxedBoolean>, NumberSchemaValidator<IriFormat1BoxedNumber>, StringSchemaValidator<IriFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, IriFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, IriFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: IriFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: IriFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): IriFormat1BoxedVoid {
            return IriFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): IriFormat1BoxedBoolean {
            return IriFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): IriFormat1BoxedNumber {
            return IriFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): IriFormat1BoxedString {
            return IriFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): IriFormat1BoxedList {
            return IriFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): IriFormat1BoxedMap {
            return IriFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): IriFormat1Boxed {
            if (arg == null) {
