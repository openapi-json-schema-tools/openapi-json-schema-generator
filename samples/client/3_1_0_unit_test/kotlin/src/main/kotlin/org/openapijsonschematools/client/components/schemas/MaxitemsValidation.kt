...
class MaxitemsValidation {
    ...
    data class MaxitemsValidation1BoxedVoid(val data: Nothing?) : MaxitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxitemsValidation1BoxedBoolean(val data: Boolean): MaxitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxitemsValidation1BoxedNumber(val data: Number) : MaxitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxitemsValidation1BoxedString(val data: String) : MaxitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxitemsValidation1BoxedList(val data: FrozenList<Any?>) : MaxitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MaxitemsValidation1BoxedMap(val data: FrozenMap<Any?>) : MaxitemsValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MaxitemsValidation1 private constructor(): JsonSchema<MaxitemsValidation1Boxed>(
        maxItems = 2,
    ), NullSchemaValidator<MaxitemsValidation1BoxedVoid>, BooleanSchemaValidator<MaxitemsValidation1BoxedBoolean>, NumberSchemaValidator<MaxitemsValidation1BoxedNumber>, StringSchemaValidator<MaxitemsValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MaxitemsValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MaxitemsValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MaxitemsValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MaxitemsValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MaxitemsValidation1BoxedVoid {
            return MaxitemsValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MaxitemsValidation1BoxedBoolean {
            return MaxitemsValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MaxitemsValidation1BoxedNumber {
            return MaxitemsValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MaxitemsValidation1BoxedString {
            return MaxitemsValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MaxitemsValidation1BoxedList {
            return MaxitemsValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MaxitemsValidation1BoxedMap {
            return MaxitemsValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MaxitemsValidation1Boxed {
            if (arg == null) {
