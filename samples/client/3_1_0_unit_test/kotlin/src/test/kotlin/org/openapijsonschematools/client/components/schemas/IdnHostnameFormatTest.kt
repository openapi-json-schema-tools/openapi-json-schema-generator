...
class IdnHostnameFormatTest {
    ...
    fun testAllStringFormatsIgnoreIntegersPasses() {
        ...
        val schema = IdnHostnameFormat.IdnHostnameFormat1.getInstance()
        schema.validate(
            12,
            configuration
        )
    ...
    @Test
    fun testInvalidIdnHostnameStringIsOnlyAnAnnotationByDefaultPasses() {
