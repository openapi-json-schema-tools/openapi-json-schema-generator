...
Bar2: typing_extensions.TypeAlias = schemas.IntSchema
Properties = typing.TypedDict(
    'Properties',
    {
        "foo": typing.Type[Foo],
        "bar": typing.Type[Bar2],
    }
)
...
class BarDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def from_dict_(
        ...
        return Bar.validate(arg, configuration=configuration)
    ...
    @property
    def bar(self) -> typing.Union[int, schemas.Unset]:
...
BarDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class Bar(
    schemas.AnyTypeSchema[BarDict, typing.Tuple[schemas.OUTPUT_BASE_TYPES, ...]],
):
    # any type
