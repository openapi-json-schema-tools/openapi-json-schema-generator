...
class AdditionalpropertiesWithSchemaDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def from_dict_(
        ...
        return AdditionalpropertiesWithSchema.validate(arg, configuration=configuration)
...
AdditionalpropertiesWithSchemaDictInput = typing.Mapping[
    str,
    typing.Union[
        typing.Union[
            schemas.INPUT_TYPES_ALL,
...
class AdditionalpropertiesWithSchema(
    schemas.Schema[AdditionalpropertiesWithSchemaDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: AdditionalpropertiesWithSchemaDict
        }
    )
