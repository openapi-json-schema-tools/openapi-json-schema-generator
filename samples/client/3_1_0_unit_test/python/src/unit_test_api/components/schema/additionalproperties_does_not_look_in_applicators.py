...
class AdditionalpropertiesDoesNotLookInApplicatorsDict(schemas.immutabledict[str, bool]):
    ...
    def __new__(
        ...
        **kwargs: bool,
        ...
        used_kwargs = typing.cast(AdditionalpropertiesDoesNotLookInApplicatorsDictInput, kwargs)
        return AdditionalpropertiesDoesNotLookInApplicators.validate(used_kwargs, configuration=configuration_)
    ...
    def from_dict_(
        ...
        return AdditionalpropertiesDoesNotLookInApplicators.validate(arg, configuration=configuration)
...
AdditionalpropertiesDoesNotLookInApplicatorsDictInput = typing.Mapping[
    str,
    bool,
]
...
class AdditionalpropertiesDoesNotLookInApplicators(
    schemas.AnyTypeSchema[AdditionalpropertiesDoesNotLookInApplicatorsDict, typing.Tuple[schemas.OUTPUT_BASE_TYPES, ...]],
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: AdditionalpropertiesDoesNotLookInApplicatorsDict,
        }
    )
