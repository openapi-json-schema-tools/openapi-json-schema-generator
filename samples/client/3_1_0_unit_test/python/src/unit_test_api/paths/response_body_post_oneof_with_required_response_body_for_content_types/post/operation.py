    ...
    def _post_oneof_with_required_response_body_for_content_types(
        ...
        *,
        ...
        host = self.api_client.configuration.get_server_url(
            "paths//responseBody/postOneofWithRequiredResponseBodyForContentTypes/post/servers", server_index
        )
...
class PostOneofWithRequiredResponseBodyForContentTypes(BaseApi):
    ...
    post_oneof_with_required_response_body_for_content_types = BaseApi._post_oneof_with_required_response_body_for_content_types


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_oneof_with_required_response_body_for_content_types
