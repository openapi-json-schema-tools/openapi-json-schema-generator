...
class ApiResponse(api_response.ApiResponse):
    ...
    body: application_json_schema.additionalproperties_being_false_does_not_allow_other_properties.AdditionalpropertiesBeingFalseDoesNotAllowOtherPropertiesDict
