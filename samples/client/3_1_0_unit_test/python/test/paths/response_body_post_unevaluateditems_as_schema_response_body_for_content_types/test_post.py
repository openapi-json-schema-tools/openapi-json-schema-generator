...
from unit_test_api.paths.response_body_post_unevaluateditems_as_schema_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_with_invalid_unevaluated_items_fails(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postUnevaluateditemsAsSchemaResponseBodyForContentTypes",
                method='post'.upper(),
                content_type=None,
