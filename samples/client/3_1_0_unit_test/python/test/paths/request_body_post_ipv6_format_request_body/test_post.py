...
from unit_test_api.paths.request_body_post_ipv6_format_request_body.post import operation as post  # noqa: E501
    ...
    def test_invalid_ipv6_string_is_only_an_annotation_by_default_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postIpv6FormatRequestBody",
                method='post'.upper(),
