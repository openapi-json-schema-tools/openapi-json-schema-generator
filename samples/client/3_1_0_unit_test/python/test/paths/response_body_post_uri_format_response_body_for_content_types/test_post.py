...
from unit_test_api.paths.response_body_post_uri_format_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_all_string_formats_ignore_objects_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postUriFormatResponseBodyForContentTypes",
                method='post'.upper(),
