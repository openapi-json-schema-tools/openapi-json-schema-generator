...
from unit_test_api.paths.response_body_post_ipv4_format_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_invalid_ipv4_string_is_only_an_annotation_by_default_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postIpv4FormatResponseBodyForContentTypes",
                method='post'.upper(),
