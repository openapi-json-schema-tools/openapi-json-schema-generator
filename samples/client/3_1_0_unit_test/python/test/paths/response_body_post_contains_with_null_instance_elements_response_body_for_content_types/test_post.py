...
from unit_test_api.paths.response_body_post_contains_with_null_instance_elements_response_body_for_content_types.post import operation as post  # noqa: E501
...
class TestPost(ApiTestMixin, unittest.TestCase):
    ...
    def test_allows_null_items_passes(self):
        # allows null items
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postContainsWithNullInstanceElementsResponseBodyForContentTypes",
                method='post'.upper(),
