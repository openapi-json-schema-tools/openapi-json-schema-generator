...
from unit_test_api.paths.request_body_post_iri_format_request_body.post import operation as post  # noqa: E501
    ...
    def test_all_string_formats_ignore_objects_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postIriFormatRequestBody",
                method='post'.upper(),
