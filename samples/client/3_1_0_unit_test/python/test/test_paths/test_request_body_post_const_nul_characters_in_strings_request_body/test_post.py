...
from unit_test_api.paths.request_body_post_const_nul_characters_in_strings_request_body.post import operation as post  # noqa: E501
    ...
    def test_match_string_with_nul_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postConstNulCharactersInStringsRequestBody",
                method='post'.upper(),
