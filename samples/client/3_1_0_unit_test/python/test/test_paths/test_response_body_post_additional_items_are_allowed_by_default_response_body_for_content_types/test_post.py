...
from unit_test_api.paths.response_body_post_additional_items_are_allowed_by_default_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_only_the_first_item_is_validated_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postAdditionalItemsAreAllowedByDefaultResponseBodyForContentTypes",
                method='post'.upper(),
