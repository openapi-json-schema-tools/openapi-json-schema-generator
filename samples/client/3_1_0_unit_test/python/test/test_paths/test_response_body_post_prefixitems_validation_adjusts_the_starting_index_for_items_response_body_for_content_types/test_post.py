...
from unit_test_api.paths.response_body_post_prefixitems_validation_adjusts_the_starting_index_for_items_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_wrong_type_of_second_item_fails(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postPrefixitemsValidationAdjustsTheStartingIndexForItemsResponseBodyForContentTypes",
                method='post'.upper(),
                content_type=None,
