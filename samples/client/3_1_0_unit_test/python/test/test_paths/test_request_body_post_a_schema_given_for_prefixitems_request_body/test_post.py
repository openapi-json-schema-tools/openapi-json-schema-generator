...
from unit_test_api.paths.request_body_post_a_schema_given_for_prefixitems_request_body.post import operation as post  # noqa: E501
    ...
    def test_incomplete_array_of_items_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postASchemaGivenForPrefixitemsRequestBody",
                method='post'.upper(),
