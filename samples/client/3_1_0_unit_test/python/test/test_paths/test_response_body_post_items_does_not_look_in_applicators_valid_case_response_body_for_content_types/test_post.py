...
from unit_test_api.paths.response_body_post_items_does_not_look_in_applicators_valid_case_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_prefixitems_in_allof_does_not_constrain_items_valid_case_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postItemsDoesNotLookInApplicatorsValidCaseResponseBodyForContentTypes",
                method='post'.upper(),
