...
from unit_test_api.paths.response_body_post_const_validation_response_body_for_content_types.post import operation as post  # noqa: E501
...
class TestPost(ApiTestMixin, unittest.TestCase):
    ...
    def test_another_value_is_invalid_fails(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postConstValidationResponseBodyForContentTypes",
                method='post'.upper(),
                content_type=None,
                accept_content_type=accept_content_type,
            )
    
    def test_another_type_is_invalid_fails(self):
    ...
    def test_same_value_is_valid_passes(self):
        # same value is valid
        accept_content_type = 'application/json'
