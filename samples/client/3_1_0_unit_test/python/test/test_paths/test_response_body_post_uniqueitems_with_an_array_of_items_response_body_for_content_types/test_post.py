...
from unit_test_api.paths.response_body_post_uniqueitems_with_an_array_of_items_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_unique_array_extended_from_false_true_is_valid_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postUniqueitemsWithAnArrayOfItemsResponseBodyForContentTypes",
                method='post'.upper(),
