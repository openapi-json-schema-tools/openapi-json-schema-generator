...
from unit_test_api.paths.request_body_post_additionalproperties_being_false_does_not_allow_other_properties_request_body.post import operation as post  # noqa: E501
    ...
    def test_patternproperties_are_not_additional_properties_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postAdditionalpropertiesBeingFalseDoesNotAllowOtherPropertiesRequestBody",
                method='post'.upper(),
