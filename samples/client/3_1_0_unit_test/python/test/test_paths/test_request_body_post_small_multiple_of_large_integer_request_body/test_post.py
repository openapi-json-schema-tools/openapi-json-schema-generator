...
from unit_test_api.paths.request_body_post_small_multiple_of_large_integer_request_body.post import operation as post  # noqa: E501
    ...
    def test_any_integer_is_a_multiple_of1_e8_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postSmallMultipleOfLargeIntegerRequestBody",
                method='post'.upper(),
