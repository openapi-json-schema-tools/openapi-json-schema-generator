...
from unit_test_api.paths.request_body_post_ignore_then_without_if_request_body.post import operation as post  # noqa: E501
    ...
    def test_valid_when_invalid_against_lone_then_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postIgnoreThenWithoutIfRequestBody",
                method='post'.upper(),
