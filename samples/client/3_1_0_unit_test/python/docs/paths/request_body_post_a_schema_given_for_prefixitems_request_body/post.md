unit_test_api.paths.request_body_post_a_schema_given_for_prefixitems_request_body.operation
...
unit_test_api.paths.request_body_post_a_schema_given_for_prefixitems_request_body.post.request_body.content.application_json.schema
```
type: schemas.Schema
```
