...
unit_test_api.components.schemas.NonAsciiPatternWithAdditionalproperties.java
...
import unit_test_api.components.schemas.NonAsciiPatternWithAdditionalproperties;
