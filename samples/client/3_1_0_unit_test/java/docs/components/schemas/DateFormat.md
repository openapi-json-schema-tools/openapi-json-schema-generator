...
| ----------------- | ---------------------- |
| static class | [DateFormat.DateFormat1Boxed](#dateformat1boxed)<br> abstract sealed validated payload class |
| static class | [DateFormat.DateFormat1BoxedVoid](#dateformat1boxedvoid)<br> boxed class to store validated null payloads |
| static class | [DateFormat.DateFormat1BoxedBoolean](#dateformat1boxedboolean)<br> boxed class to store validated boolean payloads |
| static class | [DateFormat.DateFormat1BoxedNumber](#dateformat1boxednumber)<br> boxed class to store validated Number payloads |
| static class | [DateFormat.DateFormat1BoxedString](#dateformat1boxedstring)<br> boxed class to store validated String payloads |
| static class | [DateFormat.DateFormat1BoxedList](#dateformat1boxedlist)<br> boxed class to store validated List payloads |
| static class | [DateFormat.DateFormat1BoxedMap](#dateformat1boxedmap)<br> boxed class to store validated Map payloads |
| static class | [DateFormat.DateFormat1](#dateformat1)<br> schema class |

## DateFormat1Boxed
public static abstract sealed class DateFormat1Boxed<br>
permits<br>
...
public static final class DateFormat1BoxedVoid<br>
extends [DateFormat1Boxed](#dateformat1boxed)
...
public static final class DateFormat1BoxedBoolean<br>
extends [DateFormat1Boxed](#dateformat1boxed)
...
public static final class DateFormat1BoxedNumber<br>
extends [DateFormat1Boxed](#dateformat1boxed)
...
public static final class DateFormat1BoxedString<br>
extends [DateFormat1Boxed](#dateformat1boxed)
...
public static final class DateFormat1BoxedList<br>
extends [DateFormat1Boxed](#dateformat1boxed)
...
## DateFormat1BoxedMap
public static final class DateFormat1BoxedMap<br>
extends [DateFormat1Boxed](#dateformat1boxed)
