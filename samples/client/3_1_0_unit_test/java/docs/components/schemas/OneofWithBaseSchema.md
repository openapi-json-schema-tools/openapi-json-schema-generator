# OneofWithBaseSchema
unit_test_api.components.schemas.OneofWithBaseSchema.java
...
public sealed interface OneofWithBaseSchema1Boxed<br>
permits<br>
...
public record OneofWithBaseSchema1BoxedString<br>
...
import unit_test_api.components.schemas.OneofWithBaseSchema;
