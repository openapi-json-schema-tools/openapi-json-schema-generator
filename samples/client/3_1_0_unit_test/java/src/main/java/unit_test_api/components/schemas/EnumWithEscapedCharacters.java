...
public class EnumWithEscapedCharacters {
    ...
    public static class EnumWithEscapedCharacters1 extends JsonSchema<EnumWithEscapedCharacters1Boxed> implements StringSchemaValidator<EnumWithEscapedCharacters1BoxedString>, StringEnumValidator<StringEnumWithEscapedCharactersEnums> {
        ...
        */
        ...
        @Override
        public EnumWithEscapedCharacters1BoxedString validateAndBox(String arg, SchemaConfiguration configuration) throws ValidationException {
            return new EnumWithEscapedCharacters1BoxedString(validate(arg, configuration));
        }
        @Override
        public EnumWithEscapedCharacters1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException {
