...
public class IdnHostnameFormatTest {
    ...
    @Test
    public void testInvalidIdnHostnameStringIsOnlyAnAnnotationByDefaultPasses() throws ValidationException {
