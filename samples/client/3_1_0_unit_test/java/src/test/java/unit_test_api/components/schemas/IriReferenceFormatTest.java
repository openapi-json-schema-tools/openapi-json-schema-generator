...
public class IriReferenceFormatTest {
    ...
    @Test
    public void testInvalidIriReferenceStringIsOnlyAnAnnotationByDefaultPasses() throws ValidationException {
