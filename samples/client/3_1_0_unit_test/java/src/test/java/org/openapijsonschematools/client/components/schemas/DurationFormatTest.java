...
public class DurationFormatTest {
    ...
    public void testAllStringFormatsIgnoreIntegersPasses() throws ValidationException {
        ...
        final var schema = DurationFormat.DurationFormat1.getInstance();
        schema.validate(
            12,
            configuration
        );
    ...
    @Test
    public void testInvalidDurationStringIsOnlyAnAnnotationByDefaultPasses() throws ValidationException {
