...
org.openapijsonschematools.components.schemas.Maxproperties0MeansTheObjectIsEmpty.java
...
| ----------------- | ---------------------- |
| static LinkedHashMap<String, KeywordValidator> |keywordToValidator<br/>new LinkedHashMap<>(Map.ofEntries(<br/>&nbsp;&nbsp;&nbsp;&nbsp;new KeywordEntry("maxProperties", new MaxPropertiesValidator(0))<br>)); |
