...
| static [ObjectPropertiesValidationMap](#objectpropertiesvalidationmap) | validate([Map<?, ?>](#objectpropertiesvalidationmapinput) arg, SchemaConfiguration configuration) |
