...
| static [ForbiddenPropertyMap](#forbiddenpropertymap) | validate([Map<String, @Nullable Object>](#forbiddenpropertymapinput) arg, SchemaConfiguration configuration) |
...
| Modifier and Type | Method and Description |
| ----------------- | ---------------------- |
| static [ForbiddenPropertyMap](#forbiddenpropertymap) | of([Map<String, @Nullable Object>](#forbiddenpropertymapinput) arg, SchemaConfiguration configuration) |
