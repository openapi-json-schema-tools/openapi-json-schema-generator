...
| static [PropertiesWithEscapedCharactersMap](#propertieswithescapedcharactersmap) | validate([Map<String, ? extends @Nullable Object>](#propertieswithescapedcharactersmapinput) arg, SchemaConfiguration configuration) |
