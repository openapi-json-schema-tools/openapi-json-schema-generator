...
| static [PropertyNamedRefThatIsNotAReferenceMap](#propertynamedrefthatisnotareferencemap) | validate([Map<String, Object>](#propertynamedrefthatisnotareferencedictinput) arg, SchemaConfiguration configuration) |
