...
public class ResponseDeserializerTest {
    ...
    public static class MyResponseDeserializer extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        ...
        @Override
        protected SealedResponseBody getBody(String contentType, byte[] body, SchemaConfiguration configuration) throws ValidationException, NotImplementedException, InvalidTypeException {
    ...
    @Test
    public void testDeserializeApplicationJsonNull() throws ValidationException, OpenapiDocumentException, NotImplementedException, InvalidTypeException {
    ...
    @Test
    public void testDeserializeApplicationJsonTrue() throws ValidationException, OpenapiDocumentException, NotImplementedException, InvalidTypeException {
        var deserializer = new MyResponseDeserializer();
    ...
    @Test
    public void testDeserializeApplicationJsonFalse() throws ValidationException, OpenapiDocumentException, NotImplementedException, InvalidTypeException {
        var deserializer = new MyResponseDeserializer();
    ...
    @Test
    public void testDeserializeApplicationJsonInt() throws ValidationException, OpenapiDocumentException, NotImplementedException, InvalidTypeException {
        var deserializer = new MyResponseDeserializer();
    ...
    @Test
    public void testDeserializeApplicationJsonFloat() throws ValidationException, OpenapiDocumentException, NotImplementedException, InvalidTypeException {
        var deserializer = new MyResponseDeserializer();
    ...
    @Test
    public void testDeserializeApplicationJsonString() throws ValidationException, OpenapiDocumentException, NotImplementedException, InvalidTypeException {
        var deserializer = new MyResponseDeserializer();
