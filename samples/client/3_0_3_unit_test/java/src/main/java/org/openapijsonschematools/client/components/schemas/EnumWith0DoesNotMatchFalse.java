...
public class EnumWith0DoesNotMatchFalse {
    ...
    public static class EnumWith0DoesNotMatchFalse1 extends JsonSchema implements IntegerEnumValidator<IntegerEnumWith0DoesNotMatchFalseEnums>, NumberSchemaValidator {
        /*
