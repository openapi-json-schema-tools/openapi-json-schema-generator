...
public class SimpleEnumValidation {
    ...
    public sealed interface SimpleEnumValidation1Boxed permits SimpleEnumValidation1BoxedNumber {
        @Nullable Object getData();
    }
    
    public record SimpleEnumValidation1BoxedNumber(Number data) implements SimpleEnumValidation1Boxed {
        @Override
    ...
    public static class SimpleEnumValidation1 extends JsonSchema<SimpleEnumValidation1Boxed> implements IntegerEnumValidator<IntegerSimpleEnumValidationEnums>, LongEnumValidator<LongSimpleEnumValidationEnums>, FloatEnumValidator<FloatSimpleEnumValidationEnums>, DoubleEnumValidator<DoubleSimpleEnumValidationEnums>, NumberSchemaValidator<SimpleEnumValidation1BoxedNumber> {
        /*
        ...
        */
        ...
        @Override
        public int validate(IntegerSimpleEnumValidationEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
            return (int) validate((Number) arg.value(), configuration);
        }
        
        @Override
        public long validate(LongSimpleEnumValidationEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
            return (long) validate((Number) arg.value(), configuration);
        }
        
        @Override
        public float validate(FloatSimpleEnumValidationEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
            return (float) validate((Number) arg.value(), configuration);
        }
        
        @Override
        public double validate(DoubleSimpleEnumValidationEnums arg,SchemaConfiguration configuration) throws InvalidTypeException, ValidationException {
        ...
        @Override
        public SimpleEnumValidation1BoxedNumber validateAndBox(Number arg, SchemaConfiguration configuration) throws ValidationException, InvalidTypeException {
            return new SimpleEnumValidation1BoxedNumber(validate(arg, configuration));
        }
        @Override
        public SimpleEnumValidation1Boxed validateAndBox(@Nullable Object arg, SchemaConfiguration configuration) throws ValidationException, InvalidTypeException {
