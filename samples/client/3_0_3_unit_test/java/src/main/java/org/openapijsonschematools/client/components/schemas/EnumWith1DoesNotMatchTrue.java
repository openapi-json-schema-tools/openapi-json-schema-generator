...
public class EnumWith1DoesNotMatchTrue {
    ...
    public static class EnumWith1DoesNotMatchTrue1 extends JsonSchema implements IntegerEnumValidator<IntegerEnumWith1DoesNotMatchTrueEnums>, NumberSchemaValidator {
        /*
