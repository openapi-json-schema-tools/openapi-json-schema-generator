...
public class TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing {
    ...
    public static class TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing1 extends JsonSchema<TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissingMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissingMap getMapOutputInstance(FrozenMap<?, ?> arg) {
