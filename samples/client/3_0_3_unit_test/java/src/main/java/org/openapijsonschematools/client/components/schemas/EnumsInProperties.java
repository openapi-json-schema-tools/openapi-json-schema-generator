...
public class EnumsInProperties {
    ...
    public static class EnumsInProperties1 extends JsonSchema<EnumsInPropertiesMap, FrozenList> {
        /*
        ...
        */
        ...
        @Override
        protected EnumsInPropertiesMap getMapOutputInstance(FrozenMap<?, ?> arg) {
