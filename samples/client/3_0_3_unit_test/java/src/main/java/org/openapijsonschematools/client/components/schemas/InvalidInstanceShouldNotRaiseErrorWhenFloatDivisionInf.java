...
public class InvalidInstanceShouldNotRaiseErrorWhenFloatDivisionInf {
    ...
    public static class InvalidInstanceShouldNotRaiseErrorWhenFloatDivisionInf1 extends JsonSchema implements NumberSchemaValidator<InvalidInstanceShouldNotRaiseErrorWhenFloatDivisionInf1BoxedNumber> {
        /*
        ...
        */
        ...
        @Override
        public InvalidInstanceShouldNotRaiseErrorWhenFloatDivisionInf1BoxedNumber validateAndBox(Number arg, SchemaConfiguration configuration) throws ValidationException, InvalidTypeException {
