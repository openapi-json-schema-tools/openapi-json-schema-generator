    ...
    def _post_additionalproperties_are_allowed_by_default_request_body(
        ...
        *,
        ...
        host = self.api_client.configuration.get_server_url(
            "paths//requestBody/postAdditionalpropertiesAreAllowedByDefaultRequestBody/post/servers", server_index
        )
...
class PostAdditionalpropertiesAreAllowedByDefaultRequestBody(BaseApi):
    ...
    post_additionalproperties_are_allowed_by_default_request_body = BaseApi._post_additionalproperties_are_allowed_by_default_request_body


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_additionalproperties_are_allowed_by_default_request_body
