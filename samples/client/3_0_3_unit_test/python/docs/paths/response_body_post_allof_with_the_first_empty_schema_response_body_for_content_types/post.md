...
unit_test_api.paths.response_body_post_allof_with_the_first_empty_schema_response_body_for_content_types.post.responses.response_200.content.application_json.schema
```
type: schemas.Schema
```
