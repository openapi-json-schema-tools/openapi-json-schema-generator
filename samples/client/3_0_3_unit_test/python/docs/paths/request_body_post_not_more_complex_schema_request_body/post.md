unit_test_api.paths.request_body_post_not_more_complex_schema_request_body.operation
...
| post | RequestBodyPostNotMoreComplexSchemaRequestBody | This api is only for path=/requestBody/postNotMoreComplexSchemaRequestBody |
...
--------- | ---------- | ------------- | ------------
[NotMoreComplexSchema](../../components/schema/not_more_complex_schema.md) | dict, schemas.immutabledict, str, datetime.date, datetime.datetime, uuid.UUID, int, float, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader | schemas.immutabledict, str, float, int, bool, None, tuple, bytes, io.FileIO |
...
from unit_test_api.paths.request_body_post_not_more_complex_schema_request_body.post import request_body
