unit_test_api.paths.request_body_post_additionalproperties_can_exist_by_itself_request_body.operation
...
unit_test_api.paths.request_body_post_additionalproperties_can_exist_by_itself_request_body.post.request_body.content.application_json.schema
```
type: schemas.Schema
```
