# RequiredValidation
openapi_client.components.schema.required_validation
```
type: schemas.Schema
```
...
------------ | ------------- | -------------
[RequiredValidationDictInput](#requiredvalidationdictinput), [RequiredValidationDict](#requiredvalidationdict), str, datetime.date, datetime.datetime, uuid.UUID, int, float, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader | [RequiredValidationDict](#requiredvalidationdict), str, float, int, bool, None, tuple, bytes, io.FileIO |
...
------------ | ------------- | ------------- | -------------
**foo** | dict, schemas.immutabledict, str, datetime.date, datetime.datetime, uuid.UUID, int, float, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader |  |
...
-------- | ---- | ----------- | -----
**foo** | schemas.immutabledict, str, float, int, bool, None, tuple, bytes, io.FileIO |  |
