...
class RefInNot {
    ...
    data class RefInNot1BoxedVoid(val data: Nothing?) : RefInNot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInNot1BoxedBoolean(val data: Boolean): RefInNot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInNot1BoxedNumber(val data: Number) : RefInNot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInNot1BoxedString(val data: String) : RefInNot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInNot1BoxedList(val data: FrozenList<Any?>) : RefInNot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInNot1BoxedMap(val data: FrozenMap<Any?>) : RefInNot1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RefInNot1 private constructor(): JsonSchema<RefInNot1Boxed>(
        not = PropertyNamedRefThatIsNotAReference.PropertyNamedRefThatIsNotAReference1::class.java,
    ), NullSchemaValidator<RefInNot1BoxedVoid>, BooleanSchemaValidator<RefInNot1BoxedBoolean>, NumberSchemaValidator<RefInNot1BoxedNumber>, StringSchemaValidator<RefInNot1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RefInNot1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, RefInNot1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RefInNot1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RefInNot1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RefInNot1BoxedVoid {
            return RefInNot1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RefInNot1BoxedBoolean {
            return RefInNot1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RefInNot1BoxedNumber {
            return RefInNot1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RefInNot1BoxedString {
            return RefInNot1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RefInNot1BoxedList {
            return RefInNot1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RefInNot1BoxedMap {
            return RefInNot1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RefInNot1Boxed {
            if (arg == null) {
