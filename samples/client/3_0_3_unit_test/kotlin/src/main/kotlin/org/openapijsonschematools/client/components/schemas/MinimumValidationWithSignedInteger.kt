...
class MinimumValidationWithSignedInteger {
    ...
    data class MinimumValidationWithSignedInteger1BoxedVoid(val data: Nothing?) : MinimumValidationWithSignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidationWithSignedInteger1BoxedBoolean(val data: Boolean): MinimumValidationWithSignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidationWithSignedInteger1BoxedNumber(val data: Number) : MinimumValidationWithSignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidationWithSignedInteger1BoxedString(val data: String) : MinimumValidationWithSignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidationWithSignedInteger1BoxedList(val data: FrozenList<Any?>) : MinimumValidationWithSignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class MinimumValidationWithSignedInteger1BoxedMap(val data: FrozenMap<Any?>) : MinimumValidationWithSignedInteger1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class MinimumValidationWithSignedInteger1 private constructor(): JsonSchema<MinimumValidationWithSignedInteger1Boxed>(
        JsonSchemaInfo()
            .minimum(-2)
    ), NullSchemaValidator<MinimumValidationWithSignedInteger1BoxedVoid>, BooleanSchemaValidator<MinimumValidationWithSignedInteger1BoxedBoolean>, NumberSchemaValidator<MinimumValidationWithSignedInteger1BoxedNumber>, StringSchemaValidator<MinimumValidationWithSignedInteger1BoxedString>, ListSchemaValidator<FrozenList<Any?>, MinimumValidationWithSignedInteger1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, MinimumValidationWithSignedInteger1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: MinimumValidationWithSignedInteger1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: MinimumValidationWithSignedInteger1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): MinimumValidationWithSignedInteger1BoxedVoid {
            return MinimumValidationWithSignedInteger1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): MinimumValidationWithSignedInteger1BoxedBoolean {
            return MinimumValidationWithSignedInteger1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): MinimumValidationWithSignedInteger1BoxedNumber {
            return MinimumValidationWithSignedInteger1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): MinimumValidationWithSignedInteger1BoxedString {
            return MinimumValidationWithSignedInteger1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): MinimumValidationWithSignedInteger1BoxedList {
            return MinimumValidationWithSignedInteger1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): MinimumValidationWithSignedInteger1BoxedMap {
            return MinimumValidationWithSignedInteger1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): MinimumValidationWithSignedInteger1Boxed {
            if (arg == null) {
