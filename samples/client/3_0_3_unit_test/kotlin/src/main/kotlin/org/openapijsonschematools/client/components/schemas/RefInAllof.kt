...
class RefInAllof {
    ...
    data class RefInAllof1BoxedVoid(val data: Nothing?) : RefInAllof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAllof1BoxedBoolean(val data: Boolean): RefInAllof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAllof1BoxedNumber(val data: Number) : RefInAllof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAllof1BoxedString(val data: String) : RefInAllof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAllof1BoxedList(val data: FrozenList<Any?>) : RefInAllof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAllof1BoxedMap(val data: FrozenMap<Any?>) : RefInAllof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RefInAllof1 private constructor(): JsonSchema<RefInAllof1Boxed>(
        allOf = listOf(
            PropertyNamedRefThatIsNotAReference.PropertyNamedRefThatIsNotAReference1::class.java
        ),
    ), NullSchemaValidator<RefInAllof1BoxedVoid>, BooleanSchemaValidator<RefInAllof1BoxedBoolean>, NumberSchemaValidator<RefInAllof1BoxedNumber>, StringSchemaValidator<RefInAllof1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RefInAllof1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, RefInAllof1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RefInAllof1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RefInAllof1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RefInAllof1BoxedVoid {
            return RefInAllof1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RefInAllof1BoxedBoolean {
            return RefInAllof1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RefInAllof1BoxedNumber {
            return RefInAllof1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RefInAllof1BoxedString {
            return RefInAllof1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RefInAllof1BoxedList {
            return RefInAllof1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RefInAllof1BoxedMap {
            return RefInAllof1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RefInAllof1Boxed {
            if (arg == null) {
