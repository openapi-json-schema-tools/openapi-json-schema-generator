...
class AdditionalpropertiesAllowsASchemaWhichShouldValidate {
    ...
    class AdditionalpropertiesAllowsASchemaWhichShouldValidateMap(m: FrozenMap<Any?>) : FrozenMap<Any?>(m) {
        companion object {
            ...
            fun of(arg: Map<String, Any?>, configuration: SchemaConfiguration): AdditionalpropertiesAllowsASchemaWhichShouldValidateMap {
    ...
    class AdditionalpropertiesAllowsASchemaWhichShouldValidateMapBuilder: GenericBuilder<Map<String, Any?>>, SetterForFoo<AdditionalpropertiesAllowsASchemaWhichShouldValidateMapBuilder>, SetterForBar<AdditionalpropertiesAllowsASchemaWhichShouldValidateMapBuilder>, SetterForAdditionalProperties<AdditionalpropertiesAllowsASchemaWhichShouldValidateMapBuilder> {
        ...
        override fun getBuilderAfterFoo(instance: MutableMap<String, Any?>): AdditionalpropertiesAllowsASchemaWhichShouldValidateMapBuilder {
            return this
        }
        override fun getBuilderAfterBar(instance: MutableMap<String, Any?>): AdditionalpropertiesAllowsASchemaWhichShouldValidateMapBuilder {
            return this
        }
        override fun getBuilderAfterAdditionalProperty(instance: MutableMap<String, Any?>): AdditionalpropertiesAllowsASchemaWhichShouldValidateMapBuilder  {
            return this
        }
    }
    ...
    data class AdditionalpropertiesAllowsASchemaWhichShouldValidate1BoxedMap(val data: AdditionalpropertiesAllowsASchemaWhichShouldValidateMap) : AdditionalpropertiesAllowsASchemaWhichShouldValidate1Boxed {
    ...
    class AdditionalpropertiesAllowsASchemaWhichShouldValidate1 private constructor(): JsonSchema<AdditionalpropertiesAllowsASchemaWhichShouldValidate1Boxed>(
    ...
    ), MapSchemaValidator<AdditionalpropertiesAllowsASchemaWhichShouldValidateMap, AdditionalpropertiesAllowsASchemaWhichShouldValidate1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: AdditionalpropertiesAllowsASchemaWhichShouldValidate1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: AdditionalpropertiesAllowsASchemaWhichShouldValidate1().also { instance = it }
                }
        }
        
        override fun getNewInstance(arg: Map<*, *>, pathToItem: List<Any>, pathToSchemas: PathToSchemasMap): AdditionalpropertiesAllowsASchemaWhichShouldValidateMap {
            ...
            return AdditionalpropertiesAllowsASchemaWhichShouldValidateMap(castProperties)
        }
        
        @Throws(ValidationException::class)
        override fun validate(arg: Map<*, *>, configuration: SchemaConfiguration?): AdditionalpropertiesAllowsASchemaWhichShouldValidateMap {
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): AdditionalpropertiesAllowsASchemaWhichShouldValidate1BoxedMap {
            return AdditionalpropertiesAllowsASchemaWhichShouldValidate1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): AdditionalpropertiesAllowsASchemaWhichShouldValidate1Boxed {
            if (arg is Map<*, *>) {
