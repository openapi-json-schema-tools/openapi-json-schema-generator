...
class RefInAnyof {
    ...
    data class RefInAnyof1BoxedVoid(val data: Nothing?) : RefInAnyof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAnyof1BoxedBoolean(val data: Boolean): RefInAnyof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAnyof1BoxedNumber(val data: Number) : RefInAnyof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAnyof1BoxedString(val data: String) : RefInAnyof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAnyof1BoxedList(val data: FrozenList<Any?>) : RefInAnyof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInAnyof1BoxedMap(val data: FrozenMap<Any?>) : RefInAnyof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RefInAnyof1 private constructor(): JsonSchema<RefInAnyof1Boxed>(
        JsonSchemaInfo()
            .anyOf(listOf(
                PropertyNamedRefThatIsNotAReference.PropertyNamedRefThatIsNotAReference1::class.java
            ))
    ), NullSchemaValidator<RefInAnyof1BoxedVoid>, BooleanSchemaValidator<RefInAnyof1BoxedBoolean>, NumberSchemaValidator<RefInAnyof1BoxedNumber>, StringSchemaValidator<RefInAnyof1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RefInAnyof1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, RefInAnyof1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RefInAnyof1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RefInAnyof1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RefInAnyof1BoxedVoid {
            return RefInAnyof1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RefInAnyof1BoxedBoolean {
            return RefInAnyof1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RefInAnyof1BoxedNumber {
            return RefInAnyof1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RefInAnyof1BoxedString {
            return RefInAnyof1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RefInAnyof1BoxedList {
            return RefInAnyof1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RefInAnyof1BoxedMap {
            return RefInAnyof1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RefInAnyof1Boxed {
            if (arg == null) {
