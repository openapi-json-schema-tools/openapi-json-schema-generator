...
class RefInOneof {
    ...
    data class RefInOneof1BoxedVoid(val data: Nothing?) : RefInOneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInOneof1BoxedBoolean(val data: Boolean): RefInOneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInOneof1BoxedNumber(val data: Number) : RefInOneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInOneof1BoxedString(val data: String) : RefInOneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInOneof1BoxedList(val data: FrozenList<Any?>) : RefInOneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class RefInOneof1BoxedMap(val data: FrozenMap<Any?>) : RefInOneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class RefInOneof1 private constructor(): JsonSchema<RefInOneof1Boxed>(
        JsonSchemaInfo()
            .oneOf(listOf(
                PropertyNamedRefThatIsNotAReference.PropertyNamedRefThatIsNotAReference1::class.java
            ))
    ), NullSchemaValidator<RefInOneof1BoxedVoid>, BooleanSchemaValidator<RefInOneof1BoxedBoolean>, NumberSchemaValidator<RefInOneof1BoxedNumber>, StringSchemaValidator<RefInOneof1BoxedString>, ListSchemaValidator<FrozenList<Any?>, RefInOneof1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, RefInOneof1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: RefInOneof1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: RefInOneof1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): RefInOneof1BoxedVoid {
            return RefInOneof1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): RefInOneof1BoxedBoolean {
            return RefInOneof1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): RefInOneof1BoxedNumber {
            return RefInOneof1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): RefInOneof1BoxedString {
            return RefInOneof1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): RefInOneof1BoxedList {
            return RefInOneof1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): RefInOneof1BoxedMap {
            return RefInOneof1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): RefInOneof1Boxed {
            if (arg == null) {
