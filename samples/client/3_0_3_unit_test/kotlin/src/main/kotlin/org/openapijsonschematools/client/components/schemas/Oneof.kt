...
class Oneof {
    ...
    data class Oneof1BoxedVoid(val data: Nothing?) : Oneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Oneof1BoxedBoolean(val data: Boolean): Oneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Oneof1BoxedNumber(val data: Number) : Oneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Oneof1BoxedString(val data: String) : Oneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Oneof1BoxedList(val data: FrozenList<Any?>) : Oneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class Oneof1BoxedMap(val data: FrozenMap<Any?>) : Oneof1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class Oneof1 private constructor(): JsonSchema<Oneof1Boxed>(
        JsonSchemaInfo()
            .oneOf(listOf(
                Schema0::class.java,
                Schema1::class.java
            ))
    ), NullSchemaValidator<Oneof1BoxedVoid>, BooleanSchemaValidator<Oneof1BoxedBoolean>, NumberSchemaValidator<Oneof1BoxedNumber>, StringSchemaValidator<Oneof1BoxedString>, ListSchemaValidator<FrozenList<Any?>, Oneof1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, Oneof1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: Oneof1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: Oneof1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): Oneof1BoxedVoid {
            return Oneof1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): Oneof1BoxedBoolean {
            return Oneof1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): Oneof1BoxedNumber {
            return Oneof1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): Oneof1BoxedString {
            return Oneof1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): Oneof1BoxedList {
            return Oneof1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): Oneof1BoxedMap {
            return Oneof1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): Oneof1Boxed {
            if (arg == null) {
                return validateAndBox(null, configuration)
            } else if (arg is Boolean) {
                return validateAndBox(arg, configuration)
