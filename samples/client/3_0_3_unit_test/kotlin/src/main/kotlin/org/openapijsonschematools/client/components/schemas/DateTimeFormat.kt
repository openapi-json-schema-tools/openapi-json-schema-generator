...
class DateTimeFormat {
    ...
    data class DateTimeFormat1BoxedVoid(val data: Nothing?) : DateTimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateTimeFormat1BoxedBoolean(val data: Boolean): DateTimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateTimeFormat1BoxedNumber(val data: Number) : DateTimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateTimeFormat1BoxedString(val data: String) : DateTimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateTimeFormat1BoxedList(val data: FrozenList<Any?>) : DateTimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class DateTimeFormat1BoxedMap(val data: FrozenMap<Any?>) : DateTimeFormat1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class DateTimeFormat1 private constructor(): JsonSchema<DateTimeFormat1Boxed>(
        JsonSchemaInfo()
            .format("date-time")
    ), NullSchemaValidator<DateTimeFormat1BoxedVoid>, BooleanSchemaValidator<DateTimeFormat1BoxedBoolean>, NumberSchemaValidator<DateTimeFormat1BoxedNumber>, StringSchemaValidator<DateTimeFormat1BoxedString>, ListSchemaValidator<FrozenList<Any?>, DateTimeFormat1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, DateTimeFormat1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: DateTimeFormat1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: DateTimeFormat1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): DateTimeFormat1BoxedVoid {
            return DateTimeFormat1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): DateTimeFormat1BoxedBoolean {
            return DateTimeFormat1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): DateTimeFormat1BoxedNumber {
            return DateTimeFormat1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): DateTimeFormat1BoxedString {
            return DateTimeFormat1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): DateTimeFormat1BoxedList {
            return DateTimeFormat1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): DateTimeFormat1BoxedMap {
            return DateTimeFormat1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): DateTimeFormat1Boxed {
            if (arg == null) {
