...
class OneofWithBaseSchema {
    ...
    data class OneofWithBaseSchema1BoxedString(val data: String) : OneofWithBaseSchema1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class OneofWithBaseSchema1 private constructor(): JsonSchema<OneofWithBaseSchema1Boxed>(
        JsonSchemaInfo()
            .type(setOf(
                String::class.java
            ))
    ...
    ), StringSchemaValidator<OneofWithBaseSchema1BoxedString> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: OneofWithBaseSchema1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: OneofWithBaseSchema1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): OneofWithBaseSchema1BoxedString {
            return OneofWithBaseSchema1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): OneofWithBaseSchema1Boxed {
            if (arg is String) {
                return validateAndBox(arg, configuration)
            }
            throw ValidationException("Invalid input type="+getClass(arg)+". It can't be validated by this schema")
