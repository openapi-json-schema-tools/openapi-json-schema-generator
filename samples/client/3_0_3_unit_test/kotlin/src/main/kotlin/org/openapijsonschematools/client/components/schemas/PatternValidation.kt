...
class PatternValidation {
    ...
    data class PatternValidation1BoxedVoid(val data: Nothing?) : PatternValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternValidation1BoxedBoolean(val data: Boolean): PatternValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternValidation1BoxedNumber(val data: Number) : PatternValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternValidation1BoxedString(val data: String) : PatternValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternValidation1BoxedList(val data: FrozenList<Any?>) : PatternValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class PatternValidation1BoxedMap(val data: FrozenMap<Any?>) : PatternValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class PatternValidation1 private constructor(): JsonSchema<PatternValidation1Boxed>(
        pattern = Pattern.compile(
            "^a*\$"
        ),
    ), NullSchemaValidator<PatternValidation1BoxedVoid>, BooleanSchemaValidator<PatternValidation1BoxedBoolean>, NumberSchemaValidator<PatternValidation1BoxedNumber>, StringSchemaValidator<PatternValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, PatternValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, PatternValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: PatternValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: PatternValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): PatternValidation1BoxedVoid {
            return PatternValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): PatternValidation1BoxedBoolean {
            return PatternValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): PatternValidation1BoxedNumber {
            return PatternValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): PatternValidation1BoxedString {
            return PatternValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): PatternValidation1BoxedList {
            return PatternValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): PatternValidation1BoxedMap {
            return PatternValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): PatternValidation1Boxed {
            if (arg == null) {
