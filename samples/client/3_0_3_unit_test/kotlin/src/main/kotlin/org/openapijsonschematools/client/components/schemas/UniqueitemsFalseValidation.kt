...
class UniqueitemsFalseValidation {
    ...
    data class UniqueitemsFalseValidation1BoxedVoid(val data: Nothing?) : UniqueitemsFalseValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsFalseValidation1BoxedBoolean(val data: Boolean): UniqueitemsFalseValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsFalseValidation1BoxedNumber(val data: Number) : UniqueitemsFalseValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsFalseValidation1BoxedString(val data: String) : UniqueitemsFalseValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsFalseValidation1BoxedList(val data: FrozenList<Any?>) : UniqueitemsFalseValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    
    data class UniqueitemsFalseValidation1BoxedMap(val data: FrozenMap<Any?>) : UniqueitemsFalseValidation1Boxed {
        override fun getData(): Any? {
            return data
        }
    }
    ...
    class UniqueitemsFalseValidation1 private constructor(): JsonSchema<UniqueitemsFalseValidation1Boxed>(
        JsonSchemaInfo()
            .uniqueItems(false)
    ), NullSchemaValidator<UniqueitemsFalseValidation1BoxedVoid>, BooleanSchemaValidator<UniqueitemsFalseValidation1BoxedBoolean>, NumberSchemaValidator<UniqueitemsFalseValidation1BoxedNumber>, StringSchemaValidator<UniqueitemsFalseValidation1BoxedString>, ListSchemaValidator<FrozenList<Any?>, UniqueitemsFalseValidation1BoxedList>, MapSchemaValidator<FrozenMap<Any?>, UniqueitemsFalseValidation1BoxedMap> {
        /*
        ...
        */
        ...
        companion object {
            @Volatile
            private var instance: UniqueitemsFalseValidation1? = null
    
            fun getInstance() =
                instance ?: synchronized(this) {
                    instance ?: UniqueitemsFalseValidation1().also { instance = it }
                }
        }
        ...
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Nothing?, configuration: SchemaConfiguration?): UniqueitemsFalseValidation1BoxedVoid {
            return UniqueitemsFalseValidation1BoxedVoid(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Boolean, configuration: SchemaConfiguration?): UniqueitemsFalseValidation1BoxedBoolean {
            return UniqueitemsFalseValidation1BoxedBoolean(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Number, configuration: SchemaConfiguration?): UniqueitemsFalseValidation1BoxedNumber {
            return UniqueitemsFalseValidation1BoxedNumber(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: String, configuration: SchemaConfiguration?): UniqueitemsFalseValidation1BoxedString {
            return UniqueitemsFalseValidation1BoxedString(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: List<*>, configuration: SchemaConfiguration?): UniqueitemsFalseValidation1BoxedList {
            return UniqueitemsFalseValidation1BoxedList(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Map<*, *>, configuration: SchemaConfiguration?): UniqueitemsFalseValidation1BoxedMap {
            return UniqueitemsFalseValidation1BoxedMap(validate(arg, configuration))
        }
        @Throws(ValidationException::class)
        override fun validateAndBox(arg: Any?, configuration: SchemaConfiguration?): UniqueitemsFalseValidation1Boxed {
            if (arg == null) {
