...
from issue259_sample1.paths..get import operation
...
If the OpenAPI document is large, imports in issue259_sample1.apis.tags.tag_to_api and issue259_sample1.components.schemas may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- tagged api: `from issue259_sample1.apis.tags.default_api import DefaultApi`
- api for one path: `from issue259_sample1.apis.paths.some_path import SomePath`
- api for one operation (path + verb): `from issue259_sample1.paths.some_path.get import ApiForget`
- single model import: `from issue259_sample1.components.schema.pet import Pet`
...
import issue259_sample1
from issue259_sample1.apis.tags.tag_to_api import *
from issue259_sample1.components.schemas import *
```
