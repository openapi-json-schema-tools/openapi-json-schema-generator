...
@dataclasses.dataclass(frozen=True)
class StrSchema(schema.Schema[validation.immutabledict, tuple]):
    """
...
@dataclasses.dataclass(frozen=True)
class BytesSchema(schema.Schema[validation.immutabledict, tuple]):
    """
...
@dataclasses.dataclass(frozen=True)
class BinarySchema(schema.Schema[validation.immutabledict, tuple]):
