...
class ObjectIfThenElseDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def from_dict_(
        ...
        return ObjectIfThenElse.validate(arg, configuration=configuration)
    ...
    def get_additional_property_(self, name: str) -> typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset]:
        schemas.raise_if_key_known(name, self.__required_keys__, self.__optional_keys__)
        return self.get(name, schemas.unset)
ObjectIfThenElseDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]
...
@dataclasses.dataclass(frozen=True)
class ObjectIfThenElse(
    schemas.Schema[ObjectIfThenElseDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: ObjectIfThenElseDict
        }
    )
