...
For mac/linux:
```
java -cp /path/to/openapi-generator-cli.jar:/path/to/your.jar OpenAPIGenerator generate -g myClientCodegen -i /path/to/openapi.yaml -o ./test
```
...
java -DdebugOperations -cp /path/to/openapi-generator-cli.jar:/path/to/your.jar OpenAPIGenerator generate -g myClientCodegen -i /path/to/openapi.yaml -o ./test
```
