...
from unit_test_api.paths.request_body_post_simple_enum_validation_request_body.post import operation as post  # noqa: E501
    ...
    def test_one_of_the_enum_is_valid_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.configuration_.host + "/requestBody/postSimpleEnumValidationRequestBody",
                method='post'.upper(),
