...
from unit_test_api.paths.response_body_post_ref_in_not_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_property_named_ref_valid_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers/', None) + "/responseBody/postRefInNotResponseBodyForContentTypes",
                method='post'.upper(),
