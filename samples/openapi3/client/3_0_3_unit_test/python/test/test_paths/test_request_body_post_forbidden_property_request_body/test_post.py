...
from unit_test_api.paths.request_body_post_forbidden_property_request_body.post import operation as post  # noqa: E501
    ...
    def test_property_absent_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers/', None) + "/requestBody/postForbiddenPropertyRequestBody",
                method='post'.upper(),
