...
from unit_test_api.paths.request_body_post_anyof_complex_types_request_body.post import operation as post  # noqa: E501
    ...
    def test_second_anyof_valid_complex_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postAnyofComplexTypesRequestBody",
                method='post'.upper(),
