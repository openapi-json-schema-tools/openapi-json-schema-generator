...
from unit_test_api.paths.request_body_post_invalid_string_value_for_default_request_body.post import operation as post  # noqa: E501
    ...
    def test_valid_when_property_is_specified_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers/', None) + "/requestBody/postInvalidStringValueForDefaultRequestBody",
                method='post'.upper(),
