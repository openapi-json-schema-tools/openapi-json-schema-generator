...
from unit_test_api.paths.request_body_post_boolean_type_matches_booleans_request_body.post import operation as post  # noqa: E501
    ...
    def test_false_is_a_boolean_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers/', None) + "/requestBody/postBooleanTypeMatchesBooleansRequestBody",
                method='post'.upper(),
