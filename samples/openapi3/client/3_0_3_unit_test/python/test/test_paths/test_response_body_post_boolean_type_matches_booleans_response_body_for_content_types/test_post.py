...
from unit_test_api.paths.response_body_post_boolean_type_matches_booleans_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_an_empty_string_is_not_a_boolean_fails(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postBooleanTypeMatchesBooleansResponseBodyForContentTypes",
                method='post'.upper(),
                content_type=None,
