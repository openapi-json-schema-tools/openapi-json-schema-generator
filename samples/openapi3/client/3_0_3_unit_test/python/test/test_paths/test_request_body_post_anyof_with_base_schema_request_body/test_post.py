...
class TestRequestBodyPostAnyofWithBaseSchemaRequestBody(ApiTestMixin, unittest.TestCase):
    ...
    def test_one_anyof_valid_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            body = post.request_body.anyof_with_base_schema.AnyofWithBaseSchema.from_openapi_data_(
                payload,
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.configuration_.host + '/requestBody/postAnyofWithBaseSchemaRequestBody',
                method='post'.upper(),
