...
from unit_test_api.paths.response_body_post_string_type_matches_strings_response_body_for_content_types.post import operation as post  # noqa: E501
    ...
    def test_1_is_not_a_string_fails(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/responseBody/postStringTypeMatchesStringsResponseBodyForContentTypes",
                method='post'.upper(),
                content_type=None,
