...
from unit_test_api.paths.request_body_post_string_type_matches_strings_request_body.post import operation as post  # noqa: E501
    ...
    def test_a_string_is_still_a_string_even_if_it_looks_like_a_number_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postStringTypeMatchesStringsRequestBody",
                method='post'.upper(),
