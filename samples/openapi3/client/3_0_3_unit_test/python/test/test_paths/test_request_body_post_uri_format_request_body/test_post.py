...
from unit_test_api.paths.request_body_post_uri_format_request_body import post  # noqa: E501
from unit_test_api import configuration, schemas, api_client

from .. import ApiTestMixin


class TestRequestBodyPostUriFormatRequestBody(ApiTestMixin, unittest.TestCase):
    """
    RequestBodyPostUriFormatRequestBody unit test stubs
    """
    ...
    def test_all_string_formats_ignore_objects_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            body = post.request_body.uri_format.UriFormat.from_openapi_data_(
                payload,
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.configuration_.host + '/requestBody/postUriFormatRequestBody',
                method='post'.upper(),
