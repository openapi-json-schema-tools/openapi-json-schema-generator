...
from unit_test_api.paths.request_body_post_object_type_matches_objects_request_body.post import operation as post  # noqa: E501
    ...
    def test_an_object_is_an_object_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postObjectTypeMatchesObjectsRequestBody",
                method='post'.upper(),
