...
from unit_test_api.paths.request_body_post_additionalproperties_are_allowed_by_default_request_body.post import operation as post  # noqa: E501
    ...
    def test_additional_properties_are_allowed_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postAdditionalpropertiesAreAllowedByDefaultRequestBody",
                method='post'.upper(),
