...
from unit_test_api.paths.request_body_post_ref_in_anyof_request_body.post import operation as post  # noqa: E501
    ...
    def test_property_named_ref_valid_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.api_config.get_server_url('servers', None) + "/requestBody/postRefInAnyofRequestBody",
                method='post'.upper(),
