    ...
    def test_object_with_some_properties_missing_is_invalid_fails(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            with self.assertRaises((unit_test_api.ApiValueError, unit_test_api.ApiTypeError)):
                body = post.request_body.required_with_escaped_characters.RequiredWithEscapedCharacters.from_openapi_data_(
                    payload,
    ...
    def test_object_with_all_properties_present_is_valid_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self.configuration_.host + '/requestBody/postRequiredWithEscapedCharactersRequestBody',
                method='post'.upper(),
