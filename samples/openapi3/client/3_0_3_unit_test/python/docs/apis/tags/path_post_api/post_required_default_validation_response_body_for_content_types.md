...
--------- | ---------- | ------------- | ------------
[RequiredDefaultValidation](../../components/schemas/required_default_validation.RequiredDefaultValidation.md#required_default_validation) | dict, frozendict.frozendict, str, datetime.date, datetime.datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader,  | frozendict.frozendict, str, decimal.Decimal, BoolClass, NoneClass, tuple, bytes, io.FileIO,  |
