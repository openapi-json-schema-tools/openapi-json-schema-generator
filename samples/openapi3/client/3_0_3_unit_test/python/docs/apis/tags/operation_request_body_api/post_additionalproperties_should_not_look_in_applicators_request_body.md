<a name="postadditionalpropertiesshouldnotlookinapplicatorsrequestbody"></a>
...
--------- | ---------- | ------------- | ------------
[AdditionalpropertiesShouldNotLookInApplicators](../../../components/schema/additionalproperties_should_not_look_in_applicators.md) | dict, frozendict.frozendict, str, datetime.date, datetime.datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, decimal.Decimal, BoolClass, NoneClass, tuple, bytes, io.FileIO |
