...
,
    ...
    try:
        ...
        print("Exception when calling PathPostApi->post_root_pointer_ref_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PathPostApi->post_root_pointer_ref_response_body_for_content_types: %s\n" % e)
```
### Parameters
This endpoint does not need any parameter.
