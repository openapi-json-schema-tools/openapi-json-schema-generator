<a id="NestedAnyofToCheckValidationSemantics"></a>
# unit_test_api.components.schema.nested_anyof_to_check_validation_semantics.NestedAnyofToCheckValidationSemantics
