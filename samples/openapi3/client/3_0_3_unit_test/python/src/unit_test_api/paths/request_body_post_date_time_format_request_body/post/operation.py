...
from unit_test_api.components.schema import date_time_format as request_body_application_json_schema
...
class PostDateTimeFormatRequestBody(BaseApi):
    ...
    post_date_time_format_request_body = BaseApi._post_date_time_format_request_body


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_date_time_format_request_body
