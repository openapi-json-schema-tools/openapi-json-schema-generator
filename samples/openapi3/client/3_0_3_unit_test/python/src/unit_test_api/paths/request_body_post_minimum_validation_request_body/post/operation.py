...
from unit_test_api.components.schema import minimum_validation as request_body_application_json_schema
...
class PostMinimumValidationRequestBody(BaseApi):
    ...
    post_minimum_validation_request_body = BaseApi._post_minimum_validation_request_body


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_minimum_validation_request_body
