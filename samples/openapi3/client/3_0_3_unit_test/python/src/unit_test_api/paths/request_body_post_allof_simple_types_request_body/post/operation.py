...
from unit_test_api.components.schema import allof_simple_types as request_body_application_json_schema
...
class PostAllofSimpleTypesRequestBody(BaseApi):
    ...
    post_allof_simple_types_request_body = BaseApi._post_allof_simple_types_request_body


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_allof_simple_types_request_body
