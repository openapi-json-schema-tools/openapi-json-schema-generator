...
from unit_test_api.components.schema import ipv6_format as request_body_application_json_schema
...
class PostIpv6FormatRequestBody(BaseApi):
    ...
    post_ipv6_format_request_body = BaseApi._post_ipv6_format_request_body


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_ipv6_format_request_body
