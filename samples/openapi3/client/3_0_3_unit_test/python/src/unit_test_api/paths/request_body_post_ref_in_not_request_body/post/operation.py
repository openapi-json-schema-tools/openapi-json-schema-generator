...
from unit_test_api.components.schema import ref_in_not as request_body_application_json_schema
...
class PostRefInNotRequestBody(BaseApi):
    ...
    post_ref_in_not_request_body = BaseApi._post_ref_in_not_request_body


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_ref_in_not_request_body
