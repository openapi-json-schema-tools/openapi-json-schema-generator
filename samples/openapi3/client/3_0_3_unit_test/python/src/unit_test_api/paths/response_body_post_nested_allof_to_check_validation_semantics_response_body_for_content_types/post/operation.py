...
class PostNestedAllofToCheckValidationSemanticsResponseBodyForContentTypes(BaseApi):
    ...
    post_nested_allof_to_check_validation_semantics_response_body_for_content_types = BaseApi._post_nested_allof_to_check_validation_semantics_response_body_for_content_types


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._post_nested_allof_to_check_validation_semantics_response_body_for_content_types
