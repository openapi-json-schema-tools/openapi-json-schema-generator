...
class UniqueitemsValidation(
    ...
    ) -> UniqueitemsValidation[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UniqueitemsValidation[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UniqueitemsValidation[decimal.Decimal]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput,
            UniqueitemsValidation[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UniqueitemsValidation[frozendict.frozendict]: ...
    ...
    def __new__(
        ...
        arg: io.FileIO,
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UniqueitemsValidation[schemas.FileIO]: ...
