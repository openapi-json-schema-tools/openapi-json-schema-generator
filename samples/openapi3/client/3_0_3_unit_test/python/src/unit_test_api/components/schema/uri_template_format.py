...
class UriTemplateFormat(
    ...
    ) -> UriTemplateFormat[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UriTemplateFormat[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UriTemplateFormat[decimal.Decimal]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput,
            UriTemplateFormat[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UriTemplateFormat[frozendict.frozendict]: ...
    ...
    def __new__(
        ...
        arg: io.FileIO,
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> UriTemplateFormat[schemas.FileIO]: ...
