...
class MinlengthValidation(
    ...
    ) -> MinlengthValidation[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinlengthValidation[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinlengthValidation[decimal.Decimal]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput,
            MinlengthValidation[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinlengthValidation[frozendict.frozendict]: ...
    ...
    def __new__(
        ...
        arg: io.FileIO,
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinlengthValidation[schemas.FileIO]: ...
