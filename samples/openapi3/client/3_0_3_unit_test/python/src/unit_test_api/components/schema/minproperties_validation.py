...
class MinpropertiesValidation(
    ...
    ) -> MinpropertiesValidation[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinpropertiesValidation[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinpropertiesValidation[decimal.Decimal]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput,
            MinpropertiesValidation[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinpropertiesValidation[frozendict.frozendict]: ...
    ...
    def __new__(
        ...
        arg: io.FileIO,
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> MinpropertiesValidation[schemas.FileIO]: ...
