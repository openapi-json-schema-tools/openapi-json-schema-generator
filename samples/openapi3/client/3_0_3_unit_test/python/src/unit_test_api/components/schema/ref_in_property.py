...
class RefInProperty(
    ...
    ) -> RefInProperty[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> RefInProperty[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput,
            RefInProperty[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> RefInProperty[frozendict.frozendict]: ...
