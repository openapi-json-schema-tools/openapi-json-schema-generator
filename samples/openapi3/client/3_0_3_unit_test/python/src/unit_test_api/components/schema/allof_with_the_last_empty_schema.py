...
class AllofWithTheLastEmptySchema(
    ...
    ) -> AllofWithTheLastEmptySchema[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AllofWithTheLastEmptySchema[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AllofWithTheLastEmptySchema[decimal.Decimal]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AllofWithTheLastEmptySchema[str]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AllofWithTheLastEmptySchema[tuple]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput2,
            AllofWithTheLastEmptySchema[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AllofWithTheLastEmptySchema[frozendict.frozendict]: ...
    ...
    def __new__(
        ...
        arg: bytes,
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AllofWithTheLastEmptySchema[bytes]: ...
    ...
    def __new__(
        ...
        arg: io.FileIO,
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AllofWithTheLastEmptySchema[schemas.FileIO]: ...
