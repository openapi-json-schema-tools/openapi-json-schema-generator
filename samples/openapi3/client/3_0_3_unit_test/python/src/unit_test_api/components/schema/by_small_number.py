...
class BySmallNumber(
    ...
    class Schema_(metaclass=schemas.SingletonMeta):
        # any type
        multiple_of: typing.Union[int, float] = 0.00010
    ...
    ) -> BySmallNumber[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> BySmallNumber[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput,
            BySmallNumber[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> BySmallNumber[frozendict.frozendict]: ...
