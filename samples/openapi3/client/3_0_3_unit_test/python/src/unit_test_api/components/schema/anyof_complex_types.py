...
class AnyofComplexTypes(
    ...
    def __new__(
        ...
        arg: typing.Union[None, schemas.NoneClass],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AnyofComplexTypes[schemas.NoneClass]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[bool, schemas.BoolClass],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AnyofComplexTypes[schemas.BoolClass]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[decimal.Decimal, float, int],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AnyofComplexTypes[decimal.Decimal]: ...
    ...
    def __new__(
        ...
        arg: typing.Union[
            DictInput3,
            AnyofComplexTypes[frozendict.frozendict],
        ],
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AnyofComplexTypes[frozendict.frozendict]: ...
    ...
    def __new__(
        ...
        arg: io.FileIO,
        configuration: typing.Optional[schemas.schema_configuration.SchemaConfiguration] = None
    ) -> AnyofComplexTypes[schemas.FileIO]: ...
