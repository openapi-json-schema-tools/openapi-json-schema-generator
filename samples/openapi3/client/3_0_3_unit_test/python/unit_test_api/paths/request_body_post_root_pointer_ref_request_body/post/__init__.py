...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_root_pointer_ref_request_body_oapg(
        self,
...
class PostRootPointerRefRequestBody(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_root_pointer_ref_request_body(
        self,
        body: typing.Union[RequestBody.Schemas.application_json,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        stream: bool = False,
    ...
    def post_root_pointer_ref_request_body(
        ...
        return self._post_root_pointer_ref_request_body_oapg(
            body=body,
