...
class MultipartFormData(
    ...
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal["additionalMetadata"]) -> typing.Union[MetaOapg.Properties.AdditionalMetadata, schemas.Unset]: ...
    
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal["file"]) -> typing.Union[MetaOapg.Properties.File, schemas.Unset]: ...
