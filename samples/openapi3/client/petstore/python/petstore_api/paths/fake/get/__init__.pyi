...
class RequestQueryParameters:
    ...
    OptionalParams = typing_extensions.TypedDict(
        'OptionalParams',
        {
            'enum_query_string_array': typing.Union[parameter_2.enum_query_string_array, list, tuple, ],
            'enum_query_string': typing.Union[parameter_3.enum_query_string, str, ],
            'enum_query_integer': typing.Union[parameter_4.enum_query_integer, decimal.Decimal, int, ],
            'enum_query_double': typing.Union[parameter_5.enum_query_double, decimal.Decimal, int, float, ],
        },
        total=False
    )
...
class RequestHeaderParameters:
    ...
    OptionalParams = typing_extensions.TypedDict(
        'OptionalParams',
        {
            'enum_header_string_array': typing.Union[parameter_0.enum_header_string_array, list, tuple, ],
            'enum_header_string': typing.Union[parameter_1.enum_header_string, str, ],
        },
        total=False
    )
