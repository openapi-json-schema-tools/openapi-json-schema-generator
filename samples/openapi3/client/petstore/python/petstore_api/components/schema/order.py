...
class Order(
    ...
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal["quantity"]) -> typing.Union[MetaOapg.Properties.Quantity, schemas.Unset]: ...
    
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal["shipDate"]) -> typing.Union[MetaOapg.Properties.ShipDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal["status"]) -> typing.Union[MetaOapg.Properties.Status, schemas.Unset]: ...
    
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal["complete"]) -> typing.Union[MetaOapg.Properties.Complete, schemas.Unset]: ...
