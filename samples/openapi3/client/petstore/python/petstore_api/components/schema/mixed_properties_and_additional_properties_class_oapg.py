        ...
        class properties:
            ...
            class map(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def additional_properties() -> typing.Type['animal_oapg.Animal']:
                        return animal_oapg.Animal
                
                def __getitem__(self, name: typing.Union[str, ]) -> 'animal_oapg.Animal':
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                def get_item_oapg(self, name: typing.Union[str, ]) -> 'animal_oapg.Animal':
...
from petstore_api.components.schema import animal_oapg
