...
class MapTest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def indirect_map() -> typing.Type['string_boolean_map_oapg.StringBooleanMap']:
                return string_boolean_map_oapg.StringBooleanMap
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["indirect_map"]) -> 'string_boolean_map_oapg.StringBooleanMap': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["indirect_map"]) -> typing.Union['string_boolean_map_oapg.StringBooleanMap', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        indirect_map: typing.Union['string_boolean_map_oapg.StringBooleanMap', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
...
from petstore_api.components.schema import string_boolean_map_oapg
