...
class ArrayOfNumberOnly(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ArrayNumber"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ArrayNumber"], ]):
