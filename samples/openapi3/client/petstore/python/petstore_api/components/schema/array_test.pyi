            ...
            class array_array_of_model(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['read_only_first.ReadOnlyFirst'], typing.List['read_only_first.ReadOnlyFirst']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'items':
                            return super().__new__(
                                cls,
...
from petstore_api.components.schema.read_only_first_read_only_first import ReadOnlyFirstReadOnlyFirst
