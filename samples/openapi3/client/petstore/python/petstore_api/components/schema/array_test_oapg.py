                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['read_only_first_oapg.ReadOnlyFirst']:
                                return read_only_first_oapg.ReadOnlyFirst
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['read_only_first_oapg.ReadOnlyFirst'], typing.List['read_only_first_oapg.ReadOnlyFirst']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'items':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'read_only_first_oapg.ReadOnlyFirst':
                            return super().__getitem__(i)
...
from petstore_api.components.schema import read_only_first_oapg
