...
class Drawing(
    ...
    class MetaOapg:
        ...
        class Properties:
            ...
            @staticmethod
            def drawing() -> typing.Type['shape.Shape']:
                return shape.Shape
        
            @staticmethod
            def drawing() -> typing.Type['shape_or_null.ShapeOrNull']:
                return shape_or_null.ShapeOrNull
        
            @staticmethod
            def drawing() -> typing.Type['nullable_shape.NullableShape']:
            ...
            __annotations__ = {
                "mainShape": drawing,
                "shapeOrNull": drawing,
                "nullableShape": drawing,
                "shapes": Drawing,
            }
        
        @staticmethod
        def drawing() -> typing.Type['fruit.Fruit']:
            return fruit.Fruit
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shapes"]) -> MetaOapg.Properties.Drawing: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shapes"]) -> typing.Union[MetaOapg.Properties.Drawing, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        shapes: typing.Union[MetaOapg.Properties.Drawing, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: 'Fruit',
    ) -> 'Drawing':
        return super().__new__(
