...
class TypedDictInputVerifier:
    @staticmethod
    def _verify_typed_dict_inputs(tdict_cls: typing.Type[typing_extensions.TypedDict], data: typing.Dict[str, typing.Any]):
        """
        Ensures that:
...
class OpenApiResponse(JSONDetector, TypedDictInputVerifier, typing.Generic[T]):
    ...
    def deserialize(cls, response: urllib3.HTTPResponse, configuration: schema_configuration_.SchemaConfiguration) -> T:
        ...
        if cls.headers is not None and cls.response_cls.headers is not None:
