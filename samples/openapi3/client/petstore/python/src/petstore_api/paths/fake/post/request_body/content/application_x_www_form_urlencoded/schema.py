...
class Schema(
    ...
    byte: Schema_.Properties.Byte[str]
    double: Schema_.Properties.Double[decimal.Decimal]
    number: Schema_.Properties.Number[decimal.Decimal]
    pattern_without_delimiter: Schema_.Properties.PatternWithoutDelimiter[str]
