...
from petstore_api.paths.fake_inline_additional_properties.post.request_body.content.application_json import schema as request_body_application_json_schema
