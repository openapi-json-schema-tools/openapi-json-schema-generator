...
from petstore_api.components.schema import string_enum as request_body_application_json_schema
...
class StringEnum(BaseApi):
    ...
    string_enum = BaseApi._string_enum


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._string_enum
