...
class BaseApi(api_client.Api):
    ...
    def _additional_properties_with_array_of_enums(
        self,
        body: typing.Union[
            request_body_application_json_schema.AdditionalPropertiesWithArrayOfEnumsDictInput,
            request_body_application_json_schema.AdditionalPropertiesWithArrayOfEnumsDict,
            schemas.Unset
        ] = schemas.unset,
...
class AdditionalPropertiesWithArrayOfEnums(BaseApi):
    ...
    additional_properties_with_array_of_enums = BaseApi._additional_properties_with_array_of_enums


class ApiForGet(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    get = BaseApi._additional_properties_with_array_of_enums
