...
from Crypto.IO import PEM, PKCS8  # type: ignore[import]
from Crypto.Hash import SHA256, SHA512  # type: ignore[import]
from Crypto.PublicKey import RSA, ECC  # type: ignore[import]
from Crypto.Signature import PKCS1_v1_5, pss, DSS  # type: ignore[import]
...
class HttpSigningConfiguration(object):
    ...
    def get_http_signature_headers(self, resource_path, method, headers, body, query_params: typing.Optional[str]):
    ...
    def _get_signed_header_info(self, resource_path, method, headers, body, query_params: typing.Optional[str]):
