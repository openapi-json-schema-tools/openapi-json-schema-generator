...
class (
    ...
    class Schema_:
        ...
        class Properties:
            ...
            class (
                ...
                def __new__(
                    cls,
                    arg_: typing.Union[typing.Tuple['file.File'], typing.List['file.File']],
    ...
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal[""]) -> typing.Union['file.File', schemas.Unset]: ...
