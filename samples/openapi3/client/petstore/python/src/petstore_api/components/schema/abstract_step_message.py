...
class AbstractStepMessage(
    ...
    description: schemas.UnsetAnyTypeSchema[typing.Union[
        frozendict.frozendict,
        str,
        decimal.Decimal,
        schemas.BoolClass,
    ...
    discriminator: Schema_.Properties.Discriminator[str]
    sequenceNumber: schemas.UnsetAnyTypeSchema[typing.Union[
        frozendict.frozendict,
        str,
        decimal.Decimal,
        schemas.BoolClass,
