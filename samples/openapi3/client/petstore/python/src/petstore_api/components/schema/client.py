...
class ClientDict(immutabledict.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __init__(self, arg: ClientDictInput, **kwargs: typing.Optional[schema_configuration.SchemaConfiguration]):
...
class Client(
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            immutabledict.immutabledict: ClientDict
        }
    )
