...
class (
    ...
    class Schema_:
        ...
        class Properties:
            ...
            @staticmethod
            def () -> typing.Type['category.Category']:
    ...
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal[""]) -> typing.Union['category.Category', schemas.Unset]: ...
