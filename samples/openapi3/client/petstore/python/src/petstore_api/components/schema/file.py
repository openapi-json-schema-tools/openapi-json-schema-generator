...
class FileDict(immutabledict.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __init__(self, arg: FileDictInput, **kwargs: typing.Optional[schema_configuration.SchemaConfiguration]):
...
class File(
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            immutabledict.immutabledict: FileDict
        }
    )
