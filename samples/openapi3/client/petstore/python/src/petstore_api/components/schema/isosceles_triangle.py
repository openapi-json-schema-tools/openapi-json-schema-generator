...
class IsoscelesTriangle(
    ...
    class Schema_:
        # any type
        all_of: IsoscelesTriangleAllOf = dataclasses.field(default_factory=lambda: schemas.tuple_to_instance(IsoscelesTriangleAllOf)) # type: ignore
...
IsoscelesTriangleAllOf = typing.Tuple[
