...
class TriangleType(
    ...
    def validate(
        cls,
        arg: typing_extensions.Literal["IsoscelesTriangle"],
...
class _1Dict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["triangleType"]) -> typing_extensions.Literal["IsoscelesTriangle"]:
        ...
