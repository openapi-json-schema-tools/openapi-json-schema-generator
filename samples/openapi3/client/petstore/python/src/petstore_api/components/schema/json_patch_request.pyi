        ...
        class (
            ...
            class Schema_:
                ...
                class OneOf:
                    ...
                    @staticmethod
                    def () -> typing.Type['json_patch_request_add_replace_test.JSONPatchRequestAddReplaceTest']:
                        return json_patch_request_add_replace_test.JSONPatchRequestAddReplaceTest
                
                    @staticmethod
                    def () -> typing.Type['json_patch_request_remove.JSONPatchRequestRemove']:
                        return json_patch_request_remove.JSONPatchRequestRemove
                
                    @staticmethod
                    def () -> typing.Type['json_patch_request_move_copy.JSONPatchRequestMoveCopy']:
