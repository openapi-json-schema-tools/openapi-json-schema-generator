...
class (
        ...
        class Properties:
            ...
            class (
                ...
                def __new__(
                    ...
                    *args_: typing.Union[dict, frozendict.frozendict, ],
                    configuration_: typing.Optional[schemas.configuration_module.Configuration] = None,
                    **kwargs: typing.Union[Schema_., bool, ],
                ) -> '':
                    return super().__new__(
                        cls,
                        *args_,
            ...
            @staticmethod
            def () -> typing.Type['string_boolean_map.StringBooleanMap']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal[""]) -> 'string_boolean_map.StringBooleanMap': ...
    ...
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal[""]) -> typing.Union['string_boolean_map.StringBooleanMap', schemas.Unset]: ...
