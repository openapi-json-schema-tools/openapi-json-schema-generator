...
class EquilateralTriangle(
    ...
    class Schema_:
        # any type
        all_of: EquilateralTriangleAllOf = dataclasses.field(default_factory=lambda: schemas.tuple_to_instance(EquilateralTriangleAllOf)) # type: ignore
...
EquilateralTriangleAllOf = typing.Tuple[
