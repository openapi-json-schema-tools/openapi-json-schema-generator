...
class MapProperty(
    schemas.Schema[MapPropertyDict, typing.Tuple]
):
...
class MapOfMapProperty(
    schemas.Schema[MapOfMapPropertyDict, typing.Tuple]
):
    types: typing.FrozenSet[typing.Type] = frozenset({schemas.immutabledict})
...
class MapWithUndeclaredPropertiesAnytype3(
    schemas.Schema[MapWithUndeclaredPropertiesAnytype3Dict, typing.Tuple]
):
    types: typing.FrozenSet[typing.Type] = frozenset({schemas.immutabledict})
...
@dataclasses.dataclass(frozen=True)
class EmptyMap(
    schemas.Schema[EmptyMapDict, typing.Tuple]
):
    types: typing.FrozenSet[typing.Type] = frozenset({schemas.immutabledict})
...
class MapWithUndeclaredPropertiesString(
    schemas.Schema[MapWithUndeclaredPropertiesStringDict, typing.Tuple]
):
    types: typing.FrozenSet[typing.Type] = frozenset({schemas.immutabledict})
...
class AdditionalPropertiesClass(
    schemas.Schema[AdditionalPropertiesClassDict, typing.Tuple]
):
