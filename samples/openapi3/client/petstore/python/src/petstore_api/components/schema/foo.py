...
class FooDict(immutabledict.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __init__(self, arg: FooDictInput, **kwargs: typing.Optional[schema_configuration.SchemaConfiguration]):
...
class Foo(
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            immutabledict.immutabledict: FooDict
        }
    )
