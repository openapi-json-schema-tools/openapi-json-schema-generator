...
class (
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal[""]) -> 'Player': ...
    ...
    @typing.overload
    def get_item_(self, name: typing_extensions.Literal[""]) -> typing.Union['Player', schemas.Unset]: ...
