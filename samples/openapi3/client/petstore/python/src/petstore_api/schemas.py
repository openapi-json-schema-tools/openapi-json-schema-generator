...
def _get_class(item_cls: typing.Union[types.FunctionType, staticmethod, typing.Type['Schema']]) -> typing.Type['Schema']:
    if isinstance(item_cls, typing._GenericAlias):
        # petstore_api.schemas.StrSchema[~U] -> petstore_api.schemas.StrSchema
        return item_cls.__origin__
...
class ListSchema(
    ...
    def __new__(cls, arg_: typing.Union[typing.List[typing.Any], typing.Tuple[typing.Any]], **kwargs: typing.Optional[schema_configuration.SchemaConfiguration]) -> typing_extensions.Self:
