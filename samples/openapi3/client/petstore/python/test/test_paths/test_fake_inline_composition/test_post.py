...
import petstore_api
from petstore_api.paths.fake_inline_composition.post import operation as post  # noqa: E501
...
class TestPost(ApiTestMixin, unittest.TestCase):
    ...
    response_body_schema = typing_extensions.get_origin(post.response_200.ResponseFor200.content["multipart/form-data"].schema)
    assert response_body_schema is not None
