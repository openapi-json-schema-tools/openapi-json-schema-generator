...
import petstore_api
from petstore_api.paths.pet_find_by_status.get import operation as get  # noqa: E501
...
class TestGet(ApiTestMixin, unittest.TestCase):
    ...
    response_status = 200
    response_body_schema = typing_extensions.get_origin(get.response_200.ResponseFor200.content["application/xml"].schema)
