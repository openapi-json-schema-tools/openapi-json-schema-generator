# petstore_api.components.schema.composed_one_of_different_types_oapg.ComposedOneOfDifferentTypes
...
------------- | ------------- | ------------- | ------------- | -------------
[number_with_validations_oapg.NumberWithValidations](number_with_validations_oapg.NumberWithValidations.md) | [**number_with_validations_oapg.NumberWithValidations**](number_with_validations_oapg.NumberWithValidations.md) | [**number_with_validations_oapg.NumberWithValidations**](number_with_validations_oapg.NumberWithValidations.md) |  | 
