...
**objectWithNoDeclaredProps** | [dict, frozendict.frozendict, ](#propertiesobjectWithNoDeclaredProps) | [frozendict.frozendict, ](#propertiesobject_with_no_declared_props) | test code generation for objects Value must be a map of strings to values. It cannot be the &#x27;null&#x27; value. | [optional]
**objectWithNoDeclaredPropsNullable** | [None, dict, frozendict.frozendict, ](#propertiesobjectWithNoDeclaredPropsNullable) | [NoneClass, frozendict.frozendict, ](#propertiesobject_with_no_declared_props_nullable) | test code generation for nullable objects. Value must be a map of strings to values or the &#x27;null&#x27; value. | [optional]
