...
[**objectWithNoDeclaredProps**](#properties-objectwithnodeclaredprops) | dict, frozendict.frozendict,  | frozendict.frozendict,  | test code generation for objects Value must be a map of strings to values. It cannot be the &#x27;null&#x27; value. | [optional]
[**objectWithNoDeclaredPropsNullable**](#properties-objectwithnodeclaredpropsnullable) | None, dict, frozendict.frozendict,  | NoneClass, frozendict.frozendict,  | test code generation for nullable objects. Value must be a map of strings to values or the &#x27;null&#x27; value. | [optional]
