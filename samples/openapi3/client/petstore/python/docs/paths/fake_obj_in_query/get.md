...
| ----------- | --------- | ----- |
| object_in_query | [FakeApi](../../apis/tags/fake_api.md) | This api is only for tag=fake |
| get | ApiForGet | This api is only for this endpoint |
| get | FakeObjInQuery | This api is only for path=/fake/objInQuery |
...
------------- | ------------- | ------------- | -------------
mapBean | [Parameter0.schema](#parameter0-schema), dict, immutabledict.immutabledict | | optional
