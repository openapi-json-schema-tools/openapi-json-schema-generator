...
--------- | ---------- | ------------- | ------------
[AdditionalPropertiesWithArrayOfEnums](../../components/schema/additional_properties_with_array_of_enums.md) | dict, immutabledict.immutabledict | immutabledict.immutabledict |
