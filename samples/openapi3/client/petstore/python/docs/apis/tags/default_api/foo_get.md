...
body | typing.Union[[response_for_default.schema](#response_for_default.schema), ] |  |
headers | Unset | headers were not defined |

# <a id="response_for_default.schema" >response_for_default.schema</a>
...
------------ | ------------- | ------------- | ------------- | -------------
**string** | [**foo.Foo**](../../../components/schema/foo.Foo.md) | [**foo.Foo**](../../../components/schema/foo.Foo.md) |  | [optional] 
