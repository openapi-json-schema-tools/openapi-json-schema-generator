...
------------ | ------------- | ------------- | ------------- | -------------
**enum_form_string_array** | [list, tuple, ](#-properties-enumformstringarray) | [tuple, ](#-properties-enumformstringarray) | Form parameter enum test (string array) | [optional]
...
<a id="properties-enumformstringarray"></a>
