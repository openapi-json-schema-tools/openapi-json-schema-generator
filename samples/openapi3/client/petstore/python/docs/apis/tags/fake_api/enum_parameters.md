...
------------ | ------------- | ------------- | ------------- | -------------
**enum_form_string_array** | [list, tuple, ](#propertiesenum_form_string_array) | [tuple, ](#propertiesenum_form_string_array) | Form parameter enum test (string array) | [optional]
...
#### <a id="propertiesenum_form_string_array">EnumFormStringArray</a>
