...
**enum_form_string** | str,  | str,  | Form parameter enum test (string) | [optional] must be one of ["-efg", "(xyz)", "_abc", ] if omitted the server will use the default value of "-efg"
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
str,  | str,  |  | must be one of ["-efg", "(xyz)", "_abc", ] if omitted the server will use the default value of "-efg"
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int, float,  | decimal.Decimal,  |  | must be one of [-1.2, 1.1, ] value must be a 64 bit float
