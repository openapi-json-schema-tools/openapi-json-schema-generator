...
class ConfigurationTests(ApiTestMixin, unittest.TestCase):
    ...
    def test_spec_root_servers(self):
        ...
        arg: api_configuration.server_1.VariablesDict = {
            'version': 'v2'
        }
        server_info: api_configuration.ServerInfo = {
            'servers/1': api_configuration.server_1.Server1(
                variables=api_configuration.server_1.Variables.validate(arg)
            )
        }
    ...
    def test_path_servers(self):
        ...
        arg: api_configuration.pet_find_by_status_server_1.VariablesDict = {
            'version': 'v2'
        }
        server_info: api_configuration.ServerInfo = {
            "paths//pet/findByStatus/servers/1": api_configuration.pet_find_by_status_server_1.Server1(
                variables=api_configuration.pet_find_by_status_server_1.Variables.validate(arg)
            )
        }
    ...
    def test_operation_servers(self):
        arg: api_configuration.foo_get_server_1.VariablesDict = {
            'version': 'v2'
        }
        server_info: api_configuration.ServerInfo = {
            "paths//foo/get/servers/1": api_configuration.foo_get_server_1.Server1(
                variables=api_configuration.foo_get_server_1.Variables.validate(arg)
            )
        }
