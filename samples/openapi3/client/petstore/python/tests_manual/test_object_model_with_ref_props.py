...
class TestObjectModelWithRefProps(unittest.TestCase):
    ...
    def testObjectModelWithRefProps(self):
        ...
        assert isinstance(inst["myString"], ObjectModelWithRefProps.MetaOapg.Properties.my_string())
        assert bool(inst["myBoolean"]) is True
        assert isinstance(inst["myBoolean"], ObjectModelWithRefProps.MetaOapg.Properties.my_boolean())
