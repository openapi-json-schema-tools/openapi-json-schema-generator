...
import this_package
from this_package.paths.path_with_one_explicit_security.get import operation as get  # noqa: E501
...
class TestGet(ApiTestMixin, unittest.TestCase):
    """
    Get unit test stubs
        path with one explicit security  # noqa: E501
    """
    ...
    def test_endpoint_call_contains_security(self, mock_request):
        ...
        self.assert_pool_manager_request_called_with(
            mock_request,
            f'http://localhost:3000/pathWithOneExplicitSecurity',
            method='GET',
