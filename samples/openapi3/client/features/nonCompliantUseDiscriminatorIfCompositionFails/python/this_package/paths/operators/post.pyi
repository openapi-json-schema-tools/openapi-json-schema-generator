...
# body param
SchemaForRequestBodyApplicationJson = Operator


request_body_operator = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_operators_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_operator.serialize(body, content_type)
