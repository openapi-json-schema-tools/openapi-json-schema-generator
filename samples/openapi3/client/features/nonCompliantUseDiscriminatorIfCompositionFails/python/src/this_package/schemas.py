...
class Singleton:
    ...
    def __new__(cls, arg: typing.Any, **kwargs):
        ...
        if key not in cls._instances:
            if isinstance(arg, (none_type_, bool, BoolClass, NoneClass)):
                inst = super().__new__(cls)
                cls._instances[key] = inst
            else:
                super_inst: typing.Type = super()
                cls._instances[key] = super_inst.__new__(cls, arg)
...
def validate_additional_properties(
    arg: typing.Any,
    additional_properties_cls: typing.Type[Schema],
    cls: typing.Type,
    validation_metadata: ValidationMetadata,
    **kwargs
) -> typing.Optional[PathToSchemasType]:
...
def validate_one_of(
    arg: typing.Any,
    classes: typing.Tuple[typing.Type[Schema], ...],
    cls: 'Schema',
    validation_metadata: ValidationMetadata,
...
def _get_discriminated_class_and_exception(
    ...
    if not isinstance(arg, frozendict.frozendict):
        return None, None
    discriminator = cls_schema().discriminator()
...
class Schema(typing.Generic[T]):
    ...
    def _validate(
        ...
        print(f'json_schema_data {json_schema_data}')
        kwargs = {}
