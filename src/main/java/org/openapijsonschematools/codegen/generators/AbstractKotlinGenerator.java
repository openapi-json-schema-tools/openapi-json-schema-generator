...
public abstract class AbstractKotlinGenerator extends DefaultGenerator implements Generator {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(AbstractKotlinGenerator.class);
    ...
    public AbstractKotlinGenerator() {
        super();
     ...
     *                                 {@link AbstractKotlinGenerator.SERIALIZATION_LIBRARY_TYPE}
     */
    ...
    public String toModelImport(String name) {
        // toModelImport is called while processing operations, but DefaultGenerator doesn't
    ...
    /**
     * Sanitize against Kotlin specific naming conventions, which may differ from those required by {@link DefaultGenerator#sanitizeName}.
     *
