...
def check_npmjs
  ...
  url = "https://www.npmjs.com/package/@openapi-json-schema-tools/openapi-json-schema-generator-cli?activeTab=versions"
  open(url) do |f|
    content = f.read
    if !content.nil? && content.include?($version)
      puts "[OK]"
...
def check_homebrew
  ...
  new_maven_url = "https://search.maven.org/remotecontent?filepath=org/openapi-json-schema-tools/openapi-json-schema-generator-cli/#{$version}/openapi-generator-cli-#{$version}.jar"
  open(url) do |f|
    content = f.read
...
def check_openapi_generator_online_docker
  ...
  url = "https://hub.docker.com/v2/repositories/openapi-json-schema-tools/openapi-json-schema-generator-online/tags/?page_size=25&page=1"
...
def check_readme
  ...
  matches = ["[#{$version}](https://github.com/OpenAPITools/openapi-generator/releases/tag/v#{$version})",
           "JAR location: `https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-cli/#{$version}/openapi-generator-cli-#{$version}.jar`",
           "wget https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-cli/#{$version}/openapi-generator-cli-#{$version}.jar -O openapi-generator-cli.jar",
           "Invoke-WebRequest -OutFile openapi-generator-cli.jar https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-cli/#{$version}/openapi-generator-cli-#{$version}.jar"]
  open(url) do |f|
    content = f.read
    has_outdated = false
    not_matched = []
...
def check_openapi_generator_jar
  ...
  url = "https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator/#{$version}/openapi-generator-#{$version}.jar"
...
def check_openapi_generator_cli_jar
  ...
  url = "https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-cli/#{$version}/openapi-generator-cli-#{$version}.jar"
...
def check_openapi_generator_maven_plugin_jar
  ...
  url = "https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-maven-plugin/#{$version}/openapi-generator-maven-plugin-#{$version}.jar"
...
def check_openapi_generator_gradle_plugin_jar
  ...
  url = "https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-gradle-plugin/#{$version}/openapi-generator-gradle-plugin-#{$version}.jar"
...
def check_openapi_generator_online_jar
  ...
  url = "https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-online/#{$version}/openapi-generator-online-#{$version}.jar"
...
def check_openapi_generator_project_pom
  ...
  url = "https://repo1.maven.org/maven2/org/openapi-json-schema-tools/openapi-json-schema-generator-project/#{$version}/openapi-generator-project-#{$version}.pom"
