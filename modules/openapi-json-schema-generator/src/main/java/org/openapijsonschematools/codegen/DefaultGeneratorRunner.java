...
public class DefaultGeneratorRunner implements GeneratorRunner {
    ...
    public GeneratorRunner opts(ClientOptInput opts) {
        ...
        String ignoreFileLocation = this.generator.getIgnoreFilePathOverride();
        ...
        if (this.ignoreProcessor == null) {
            this.ignoreProcessor = new CodegenIgnoreProcessor(this.generator.getOutputDir());
        }
    ...
    private void configureOpenAPIInfo() {
        ...
        if (StringUtils.isEmpty(info.getDescription())) {
            ...
            generator.additionalProperties().put("appDescription",
            ...
            generator.additionalProperties().put("appDescriptionWithNewLines", generator.additionalProperties().get("appDescription"));
            generator.additionalProperties().put("unescapedAppDescription", "No description provided (generated by Openapi JSON Schema Generator https://github.com/openapi-json-schema-tools/openapi-json-schema-generator)");
        } else {
            generator.additionalProperties().put("appDescription", generator.escapeText(info.getDescription()));
            generator.additionalProperties().put("appDescriptionWithNewLines", generator.escapeTextWhileAllowingNewLines(info.getDescription()));
            generator.additionalProperties().put("unescapedAppDescription", info.getDescription());
        }
