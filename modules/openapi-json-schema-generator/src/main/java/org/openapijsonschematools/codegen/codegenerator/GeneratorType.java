...
public enum GeneratorType {
    ...
    private static Map<String, GeneratorType> names = new HashMap<String, GeneratorType>();

    @JsonCreator
    public static GeneratorType forValue(String value) {
        return names.get(value.toLowerCase(Locale.ROOT));
    }

    @JsonValue
    public String toValue() {
        for (Map.Entry<String, GeneratorType> entry : names.entrySet()) {
