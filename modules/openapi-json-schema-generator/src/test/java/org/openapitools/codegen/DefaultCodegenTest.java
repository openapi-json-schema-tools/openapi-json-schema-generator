...
public class DefaultCodegenTest {
    ...
    public void testDateTimeFormParameterHasDefaultValue() {
        ...
        CodegenProperty model = codegen.fromSchema("updatePetWithForm_request", specModel);
    ...
    public void testAdditionalPropertiesV3SpecDisallowAdditionalPropertiesIfNotPresentFalse() {
        ...
        CodegenProperty cm = codegen.fromSchema("AdditionalPropertiesClass", componentSchema);
        ...
        cm = codegen.fromSchema(schemaName, schema);
        Assert.assertNull(cm.getAdditionalProperties());
    }
    ...
    public void postProcessModelsEnumWithPrefixRemoved() {
        ...
        CodegenProperty cm = objs.getModels().get(0).getModel();
    ...
    public void testDiscriminator() {
        ...
        codegen.setOpenAPI(openAPI);
        CodegenProperty animalModel = codegen.fromSchema("Animal", animal);
    ...
    public void testDiscriminatorWithCustomMapping() {
        ...
        codegen.setOpenAPI(openAPI);
        CodegenProperty personModel = codegen.fromSchema("Person", person);
    ...
    public void testParentName() {
        ...
        codegen.setOpenAPI(openAPI);
        CodegenProperty childModel = codegen.fromSchema("Child", child);
    ...
    public void testAllOfRequired() {
        ...
        codegen.setOpenAPI(openAPI);
        CodegenProperty childModel = codegen.fromSchema("clubForCreation", child);
    ...
    public void testAllOfSingleAndDoubleRefWithOwnPropsNoDiscriminator() {
        ...
        CodegenProperty supermanModel = codegen.fromSchema("SuperMan", supermanSchema);
        ...
        CodegenProperty superboyModel = codegen.fromSchema("SuperBoy", superboySchema);
        ...
        CodegenProperty superbabyModel = codegen.fromSchema("SuperBaby", superbabySchema);
    ...
    public void testAllParents() {
        ...
        CodegenProperty adultModel = codegen.fromSchema("Adult", adultSchema);
    ...
    public void testComposedSchemaAllOfDiscriminatorMap() {
        ...
        for (String leafModelName : leafModelNames) {
            ...
            CodegenProperty leafCm = codegen.fromSchema(leafModelName, leafSc);
        ...
        CodegenProperty pet = codegen.fromSchema(modelName, sc);
        ...
        modelName = "Reptile";
        sc = openAPI.getComponents().getSchemas().get(modelName);
        CodegenProperty reptile = codegen.fromSchema(modelName, sc);
        ...
        modelName = "MyPets";
        sc = openAPI.getComponents().getSchemas().get(modelName);
        CodegenProperty myPets = codegen.fromSchema(modelName, sc);
        ...
        sc = openAPI.getComponents().getSchemas().get(modelName);
        CodegenProperty myPetsNoDisc = codegen.fromSchema(modelName, sc);
        ...
        modelName = "A";
        sc = openAPI.getComponents().getSchemas().get(modelName);
        cm = codegen.fromSchema(modelName, sc);
        hs.clear();
    ...
    public void testComposedSchemaMyPetsOneOfDiscriminatorMap() {
        ...
        CodegenProperty petModel = codegen.fromSchema("MyPets", pet);
    ...
    public CodegenProperty getModel(List<ModelMap> allModels, String modelName) {
        for (ModelMap obj : allModels) {
            CodegenProperty cm = obj.getModel();
    ...
    public void verifyXDiscriminatorValue() {
        ...
        for (CodegenProperty child : cm.children) {
    ...
    public void testAllOfSingleRefNoOwnProps() {
        ...
        codegen.setOpenAPI(openAPI);
        CodegenProperty model = codegen.fromSchema("NewMessageEventCoreNoOwnProps", schema);
        Assert.assertEquals(
                model.getProperties().keySet().stream().map(ck -> ck.getName()).collect(Collectors.toList()),
                Arrays.asList("id", "message")
        );
    ...
    public void testAllOfParent() {
        ...
        Schema person = openAPI.getComponents().getSchemas().get("person");
        CodegenProperty personModel = codegen.fromSchema("person", person);
        Assert.assertEquals(personModel.getRequiredProperties(), null);

        Schema personForCreation = openAPI.getComponents().getSchemas().get("personForCreation");
        CodegenProperty personForCreationModel = codegen.fromSchema("personForCreation", personForCreation);
        Assert.assertEquals(personForCreationModel.getRequiredProperties(), null);

        Schema personForUpdate = openAPI.getComponents().getSchemas().get("personForUpdate");
        CodegenProperty personForUpdateModel = codegen.fromSchema("personForUpdate", personForUpdate);
        Assert.assertEquals(personForUpdateModel.getRequiredProperties(), null);
    }

    private List<String> getRequiredVars(CodegenProperty model) {
        return model.getRequiredProperties().keySet().stream().map(ck -> ck.getName()).collect(Collectors.toList());
    }
        ...
        urlA.requests.forEach(req -> {
            ...
            switch (req.httpMethod.toLowerCase(Locale.getDefault())) {
                case "post":
                    ...
                    Assert.assertEquals(req.requestBody.getContent().get("application/json").getSchema().refClass, "NewNotificationData");
                    break;
                case "delete":
                    Assert.assertEquals(req.operationId, "onDataDataDelete");
                    Assert.assertEquals(req.requestBody.getContent().get("application/json").getSchema().refClass, "DeleteNotificationData");
                    break;
                default:
    ...
    public void testNullableProperty() {
        ...
        CodegenProperty property = codegen.fromSchema(
    ...
    public void testDeprecatedModel() {
        ...
        CodegenProperty codegenPetModel = codegen.fromSchema("Pet", openAPI.getComponents().getSchemas().get("Pet"));
        Assert.assertTrue(codegenPetModel.isDeprecated);

        CodegenProperty codegenFoodModel = codegen.fromSchema("Food", openAPI.getComponents().getSchemas().get("Food"));
    ...
    public void integerSchemaPropertyAndModelTest() {
        ...
        //Property:
        final CodegenProperty cp = codegen.fromSchema(schema, "#/components/schemas/A/properties/someProperty");
        ...
        //Model:
        final CodegenProperty cm = codegen.fromSchema("someModel", schema);
    ...
    public void testAlias() {
        ...
        CodegenProperty typeAliasModel = codegen.fromSchema(
        ...
        CodegenProperty composedModel = codegen.fromSchema(
                "ComposedModel",
    ...
    private ModelsMap codegenModel(List<String> values) {
        final CodegenProperty cm = new CodegenProperty();
        cm.isEnum = true;
        final HashMap<String, Object> allowableValues = new HashMap<>();
        allowableValues.put("values", values);
    ...
    public void modelDoNotContainInheritedVars() {
        ...
        CodegenProperty codegenModel = codegen.fromSchema("Dog", openAPI.getComponents().getSchemas().get("Dog"));
    ...
    public void importMapping() {
        ...
        CodegenProperty codegenModel = codegen.fromSchema("ParentType", openAPI.getComponents().getSchemas().get("ParentType"));
    ...
    public void inlineAllOfSchemaDoesNotThrowException() {
        ...
        Schema sc = openAPI.getComponents().getSchemas().get(modelName);
        CodegenProperty cm = codegen.fromSchema(modelName, sc);
    ...
    public void testAdditionalPropertiesPresentInModels() {
        ...
        Schema sc;
        CodegenProperty cm;
        CodegenProperty anyTypeSchema = codegen.fromSchema(
                new Schema(),
        ...
        sc = openAPI.getComponents().getSchemas().get(modelName);
        cm = codegen.fromSchema(modelName, sc);
        CodegenProperty stringCp = codegen.fromSchema(new Schema().type("string"), "#/components/schemas/AdditionalPropertiesSchema/additionalProperties");
    ...
    public void testAdditionalPropertiesPresentInModelProperties() {
        ...
        CodegenProperty stringCp = codegen.fromSchema(
    ...
    public void testAdditionalPropertiesPresentInParameters() {
        ...
        CodegenProperty anyTypeSchema = codegen.fromSchema(new Schema(), "#/components/schemas/A/additionalProperties");
        CodegenProperty stringCp = codegen.fromSchema( new Schema().type("string"), "#/components/schemas/A/additionalProperties");
    ...
    public void testAdditionalPropertiesAnyType() {
        ...
        CodegenProperty anyTypeSchema = codegen.fromSchema(new Schema(), "#/components/schemas/AdditionalPropertiesTrue/properties/child/additionalProperties");

        Schema sc;
        CodegenProperty cm;

        sc = openAPI.getComponents().getSchemas().get("AdditionalPropertiesTrue");
        cm = codegen.fromSchema("AdditionalPropertiesTrue", sc);
        ...
        cm = codegen.fromSchema("AdditionalPropertiesAnyType", sc);
        assertEquals(cm.getProperties().get(ck).getAdditionalProperties(), anyTypeSchema);
    }
    ...
    public void testQueryParametersGetHasValidation() {
        ...
        for (CodegenParameter param : params) {
            assertTrue(param.getSchema().getHasValidation());
        }
    }
    ...
    public void testHasRequiredInModel() {
        ...
        for (String modelName : modelNamesWithoutRequired) {
            sc = openAPI.getComponents().getSchemas().get(modelName);
            cm = codegen.fromSchema(modelName, sc);
            LinkedHashMap<CodegenKey, CodegenProperty> requiredProps = cm.getRequiredProperties();
    ...
    public void testHasRequiredInProperties() {
        ...
        for (String modelNameWithoutRequired: modelNamesWithoutRequired) {
            ...
            CodegenProperty model = codegen.fromSchema(modelNameWithoutRequired, schema);
    ...
    public void testHasRequiredInResponses() {
        ...
        for (CodegenResponse cr : co.responses.values()) {
            LinkedHashMap<CodegenKey, CodegenProperty> reqProps = cr.getContent().get("application/json").getSchema().getRequiredProperties();
    ...
    public void testBooleansSetForIntSchemas() {
        ...
        assertTrue(cpa.getSchema().isUnboundedInteger);
        assertTrue(cpa.getSchema().isInteger);
        assertFalse(cpa.getSchema().isShort);
        assertFalse(cpa.getSchema().isLong);
        cpa = co.requestBody;
        assertTrue(cpa.getContent().get("application/json").getSchema().isUnboundedInteger);
        assertTrue(cpa.getContent().get("application/json").getSchema().isInteger);
        assertFalse(cpa.getContent().get("application/json").getSchema().isShort);
        assertFalse(cpa.getContent().get("application/json").getSchema().isLong);
        ...
        co = codegen.fromOperation(path, "POST", operation, null);
        cpa = co.pathParams.get(0);
        assertFalse(cpa.getSchema().isUnboundedInteger);
        assertTrue(cpa.getSchema().isInteger);
        assertTrue(cpa.getSchema().isShort);
        assertFalse(cpa.getSchema().isLong);
        cpa = co.requestBody;
        assertFalse(cpa.getContent().get("application/json").getSchema().isUnboundedInteger);
        assertTrue(cpa.getContent().get("application/json").getSchema().isInteger);
        assertTrue(cpa.getContent().get("application/json").getSchema().isShort);
        assertFalse(cpa.getContent().get("application/json").getSchema().isLong);
        cr = co.responses.get("200");
        ...
        cpa = co.pathParams.get(0);
        assertFalse(cpa.getSchema().isUnboundedInteger);
        assertFalse(cpa.getSchema().isInteger);
        assertFalse(cpa.getSchema().isShort);
        assertTrue(cpa.getSchema().isLong);
        cpa = co.requestBody;
        assertFalse(cpa.getContent().get("application/json").getSchema().isUnboundedInteger);
        assertFalse(cpa.getContent().get("application/json").getSchema().isInteger);
        assertFalse(cpa.getContent().get("application/json").getSchema().isShort);
        assertTrue(cpa.getContent().get("application/json").getSchema().isLong);
        cr = co.responses.get("200");
        assertFalse(cr.getContent().get("application/json").getSchema().isUnboundedInteger);
    ...
    public void testComposedPropertyTypes() {
        ...
        CodegenProperty m = codegen.fromSchema(modelName, openAPI.getComponents().getSchemas().get(modelName));
    ...
    public void testComposedModelTypes() {
        ...
        m = codegen.fromSchema(modelName, openAPI.getComponents().getSchemas().get(modelName));
    ...
    public void testComposedResponseTypes() {
        ...
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsMap());

        path = "/ComposedNumber";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsNumber());

        path = "/ComposedInteger";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsUnboundedInteger());

        path = "/ComposedString";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsString());

        path = "/ComposedBool";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsBoolean());

        path = "/ComposedArray";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsArray());

        path = "/ComposedNone";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsNull());

        path = "/ComposedAnyType";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cr = co.responses.get("200");
        assertTrue(cr.getContent().get("application/json").getSchema().getIsAnyType());
    }
    ...
    public void testComposedRequestBodyTypes() {
        ...
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsMap());

        path = "/ComposedNumber";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsNumber());

        path = "/ComposedInteger";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsUnboundedInteger());

        path = "/ComposedString";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsString());

        path = "/ComposedBool";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsBoolean());

        path = "/ComposedArray";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsArray());

        path = "/ComposedNone";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsNull());

        path = "/ComposedAnyType";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().getIsAnyType());
    }
    ...
    public void testComposedRequestQueryParamTypes() {
        ...
        assertTrue(cp.getSchema().getIsMap());

        path = "/ComposedNumber";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.queryParams.get(0);
        assertTrue(cp.getSchema().getIsNumber());

        path = "/ComposedInteger";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.queryParams.get(0);
        assertTrue(cp.getSchema().getIsUnboundedInteger());

        path = "/ComposedString";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.queryParams.get(0);
        assertTrue(cp.getSchema().getIsString());

        path = "/ComposedBool";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.queryParams.get(0);
        assertTrue(cp.getSchema().getIsBoolean());

        path = "/ComposedArray";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.queryParams.get(0);
        assertTrue(cp.getSchema().getIsArray());

        path = "/ComposedNone";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.queryParams.get(0);
        assertTrue(cp.getSchema().getIsNull());

        path = "/ComposedAnyType";
        co = codegen.fromOperation(path, "GET", openAPI.getPaths().get(path).getGet(), null);
        cp = co.queryParams.get(0);
        assertTrue(cp.getSchema().getIsAnyType());
    }
    ...
    public void testByteArrayTypeInSchemas() {
        ...
        cp = co.requestBody;
        assertTrue(cp.getContent().get("application/json").getSchema().isByteArray);
        assertFalse(cp.getContent().get("application/json").getSchema().getIsString());
        ...
        CodegenProperty pr = m.getProperties().get(ck);
    ...
    public void testRequestBodyContent() {
        ...
        co = codegen.fromOperation(path, "POST", openAPI.getPaths().get(path).getPost(), null);
        CodegenParameter bodyParameter = co.requestBody;
        ...
        CodegenProperty cm = codegen.fromSchema("_requestBodyWithEncodingTypes_post_request", openAPI.getComponents().getSchemas().get("_requestBodyWithEncodingTypes_post_request"));
    ...
    public void testResponseContentAndHeader() {
        ...
        CodegenResponse cr = co.responses.get("200");
        Map<String, CodegenHeader> responseHeaders = cr.getHeaders();
    ...
    public void testFromPropertyRequiredAndOptional() {
        ...
        Schema sc = openAPI.getComponents().getSchemas().get(modelName);
        CodegenProperty fooRequired = codegen.fromSchema(modelName, sc);
        modelName = "FooOptional";
        sc = openAPI.getComponents().getSchemas().get(modelName);
        CodegenProperty fooOptional = codegen.fromSchema(modelName, sc);
