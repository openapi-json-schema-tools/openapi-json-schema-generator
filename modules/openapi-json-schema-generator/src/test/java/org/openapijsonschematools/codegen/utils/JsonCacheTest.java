...
//    }
    ...
    public void testMerge() throws Exception {
        ...
        root.mergePolicy(JsonCache.Root.MergePolicy.NO_MERGE).load(in);
        ...
        in.reset();
        root.mergePolicy(JsonCache.Root.MergePolicy.KEEP_EXISTING).load(in);
        ...
        reload();
        in.reset();
        root.mergePolicy(JsonCache.Root.MergePolicy.MERGE_RECURSIVE).load(in);
        ...
        reload();
        in.reset();
        root.mergePolicy(JsonCache.Root.MergePolicy.OVERWRITE_EXISTING).load(in);
    ...
    private void testSetDate0(String dateStr, Object date) throws JsonCache.CacheException {
